...
(function(f) {
    ...
    f.fn[m] = function(a, b) {
        ...
        return c.each(function() {
            ...
            var attrOnclick = (a.attr('onclick'))?"onclick='"+a.attr('onclick')+"'":"";
            var attrOnchange = (a.attr('onchange'))?"onchange='"+a.attr('onchange')+"'":"";
            
            d = f('<ins class="' + C + '" '+attrOnclick+' '+attrOnchange+' />').css(d).appendTo(h);
            a.data(m, {
                o: e,
                s: a.attr("style")
            }).css(g);
