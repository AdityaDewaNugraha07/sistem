...
/**
 * This is the model class for table "t_pemotongan_log".
 *
 ...
 */
class TPemotonganLog extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    public $tgl_awal, $tgl_akhir, $kayu_id, $alokasi, $grading_rule, $panjang, $no_lap, $potong;
    public static function tableName()
    {
        return 't_pemotongan_log';
    }
    ...
    {
        return [
            [['kode', 'peruntukan', 'nomor', 'tanggal', 'petugas', 'created_at', 'created_by', 'updated_at', 'updated_by'], 'required'],
