...
/**
 * This is the model class for table "h_kas_makangrader".
 *
 * @property integer $kas_makangrader_id
 ...
 */
class HKasMakangrader extends \app\models\DeltaBaseActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['tanggal', 'graderlog_id', 'graderlog_nm'], 'required'],
    ...
    {
        return [
                'kas_makangrader_id' => Yii::t('app', 'Kas Makangrader'),
	...
	public function updateSaldoKas($modParams){
	 ...
	 public static function getSaldoKas($graderlog_id){
        $sql = "SELECT sum(nominal_in)-sum(nominal_out) AS saldo FROM h_kas_makangrader WHERE graderlog_id = ".$graderlog_id." GROUP BY graderlog_id";
