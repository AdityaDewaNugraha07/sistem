			...
			<div class="portlet-body">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-5">
							<?php
                            $list = \app\models\MDepartement::find()->all();
                            $data = \yii\helpers\ArrayHelper::map($list, 'departement_nama', 'departement_nama'); 
                            echo $form->field($model, 'nama_departement')->dropDownList($data,['prompt'=>'All'])->label('Departemen'); 
                            ?>
