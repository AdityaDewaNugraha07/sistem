...
$this->title = 'Laporan Budget Penerimaan Bahan Pembantu';
		...
		<div class="portlet light bordered">
			...
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject hijau bold"><?= Yii::t('app', 'Laporan Budget Penerimaan Bahan Pembantu '); ?><span id="periode-label" class="font-blue-soft"></span></span>
				</div>
				<div class="tools">
...
function dtLaporanA(){
    var dt_table =  $('#table-laporan').dataTable({
		pageLength: 20,
        ajax: { 
			url: '<?= \yii\helpers\Url::toRoute('/logistik/laporan/budgetPenerimaanBhp') ?>',
			data:{
				dt: 'table-laporan',
        ...
        columnDefs: [
            ...
            },
			{
				targets: 7,
				render: function ( data, type, full, meta ){
					return '<div style="text-align: right">'+formatNumberForUser(Math.round(full[10]))+'</div>';
				}
			},
            {   
                targets: 8,
		...
		footerCallback: function(row, data, start, end, display) {
            ...
            $.ajax({
                url: "<?= yii\helpers\Url::toRoute('/logistik/laporan/budgetPenerimaanBhpTotal') ?>?"+$('#form-search-laporan').serialize(),
                success: res => {
...
function printout(caraPrint){
	window.open("<?= yii\helpers\Url::toRoute('/logistik/laporan/budgetPenerimaanBhpPrint') ?>?"+$('#form-search-laporan').serialize()+"&caraprint="+caraPrint,"",'location=_new, width=1200px, scrollbars=yes');
}
