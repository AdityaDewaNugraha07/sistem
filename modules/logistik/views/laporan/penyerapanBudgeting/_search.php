		...
		<div class="portlet light bordered form-search">
			...
			<div class="portlet-body">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<?php echo $this->render('@views/apps/form/periodeTanggalBln', ['label'=>'Periode','model' => $model,'form'=>$form]) ?>
							<?php
								...
								echo $form->field($model, 'departement_id')->dropDownList($data,['id'=>'departement', 'prompt'=>'All','onchange'=>'getPeruntukan(this)'])->label('Departement'); //
								}else{
									$res = \app\models\MDepartement::find()->where(['departement_id'=>Yii::$app->user->identity->pegawai->departement_id])->all();
									$data = \yii\helpers\ArrayHelper::map($res, 'departement_id', 'departement_nama');
								echo $form->field($model, 'departement_id')->dropDownList($data,['id'=>'departement','onchange'=>'getPeruntukan(this)'])->label('Departement'); //'prompt'=>'All',
								}
							?>
						</div>
						<div class="col-md-5">
