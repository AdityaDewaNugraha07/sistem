        ...
        <table class="table table-striped table-bordered table-hover" id="table-list" style="width: 820px;">
            <thead style="background-color: #B2C4D3">
                <tr>
                    ...
                    <th style="text-align: center; width: 120px; line-height: 1;"><?= Yii::t('app', 'TBP'); ?></th>
            ...
            <tbody>
                ...
                <?php
                //t_terima_bhp
                $sql_t_terima_bhp = "select tglterima, terima_bhp_id, terimabhp_kode, spo_id, spl_id, terimabhp_keterangan, created_at, tanggal_jam_checker ".
                                        "	from t_terima_bhp ".
                                        "	where 1=1 ".
                                        "	and status_approval != 'ALLOWED' ".
                ...
                foreach ($query_t_terima_bhp as $key_t_terima_bhp) {
                    ...
                    foreach ($query_t_terima_bhp_detail as $key_t_terima_bhp_detail) {
                        ...
                        if (isset($spo_id)) {
                            ...
                            $sql_spo_tanggal = "select created_at from t_spo where spo_id = '".$spo_id."' ";
                            $spo_tanggal = Yii::$app->db->createCommand($sql_spo_tanggal)->queryScalar();

                                                                                    //approval
                                                                                    $sql_approval_by = "select approved_by_nama from view_approval where reff_no = '".$spo_kode."' ";
                                                                                    $spo_approval_by = Yii::$app->db->createCommand($sql_approval_by)->queryScalar();

                                                                                    $sql_approval_status = "select status from view_approval where reff_no = '".$spo_kode."' ";
                                                                                    $spo_approval_status =  Yii::$app->db->createCommand($sql_approval_status)->queryScalar();

                                                                                    $sql_approval_updated = "select updated_at from view_approval where reff_no = '".$spo_kode."' ";
                                                                                    $spo_approval_updated = Yii::$app->db->createCommand($sql_approval_updated)->queryScalar();
                        ...
                        foreach ($msdsd as $key_msdsd) {
                            ...
                            if ($spo_id > 0 || !empty($spo_id) || $spo_id != null) {
                            ...
                            $spb_kodex = "<p style='padding-bottom: -10px; margin-bottom: -5px;'><a onclick='infoSPB(".$spb_id.", ".$spo_id.", 0, ".$bhp_id.")'>".$spb_kode."</a></p>
                                            ...
                                            /*"<p style='line-height:1em; margin-top: -15px;'>
                                                <font style='font-size: 8px; color: #ccc;'>".$spb_id.", ".$spo_id.", 0, ".$bhp_id."</font>
                                            </p>
                                            ";*/
                            //$spb_kodex = "<p style='padding-bottom: -10px; margin-bottom: -5px;'><a onclick='infoSPB(".$spb_id.", ".$spo_id.", ".$spl_id.", ".$bhp_id.")'>".$spb_kode."</a></p><p style='line-height:1em; margin-top: 0px; margin-bottom: 10px;'><font style='font-size: 10px; color: #999;'>".\app\components\DeltaFormatter::formatDateTimeForUser2($spb_tanggal)."</font></p>";
                            } else {
                            $spb_kodex = "<p style='padding-bottom: -10px; margin-bottom: -5px;'><a onclick='infoSPB(".$spb_id.", 0, ".$spl_id.", ".$bhp_id.")'>".$spb_kode."</a></p>
                                            <p style='line-height:1em; margin-top: 0px; margin-bottom: 10px;'>
                                                <font style='font-size: 10px; color: #999;'>".\app\components\DeltaFormatter::formatDateTimeForUser2($spb_tanggal)."</font>
                                            </p>";
                                            /*"<p style='line-height:1em; margin-top: -15px;'>
                                                <font style='font-size: 8px; color: #ccc;'>".$spb_id.", 0, ".$spl_id.", ".$bhp_id."</font>
                                            </p>
                                            ";*/
                            }
                        }
                ...
                ?>
                <tr>
                    <td class="text-center" style="width: 50px; vertical-align: top;"><?php echo $i;?></td>
                    <td style="width: 100px; text-align: left;">
                        <?php
                        /*$created_at = $key_t_terima_bhp['created_at'];
                        $tanggal_jam_checker = $key_t_terima_bhp['tanggal_jam_checker'];
                        $start_date = new DateTime($tanggal_jam_checker);
                        $since_start = $start_date->diff(new DateTime($created_at));
                        //echo $since_start->days.' days total<br>';
                        //echo $since_start->y.' years<br>';
                        //echo $since_start->m.' months<br>';
                        $hari = $since_start->d;
                        $jam = $since_start->h;
                        $menit =  $since_start->i." menit";
                        //echo $since_start->s.' detik ';
                        $hari < 1 ? $hari = '' : $hari = $hari." hari ";
                        $jam < 1 ? $jam = '' : $jam = $jam." jam ";
                        */
                        $created_at = $key_t_terima_bhp['created_at'];
                        $hari_ini = explode(' ', $created_at);
                        $tanggal = $hari_ini[0];
                        $jam = $hari_ini[1];

                        // hari terima barang
                        $tanggal_jam_checker = $key_t_terima_bhp['tanggal_jam_checker'];
                        $tanggal_jam_checkers = explode(' ',$tanggal_jam_checker);
                        ...
                        $beda_waktux = $tanggal_akhir - $tanggal_awal;
                        ...
                        ?>
                        <span style='padding-bottom: -10px; margin-bottom: -5px;'><a onclick="infoTBP(<?php echo $key_t_terima_bhp['terima_bhp_id'];?>, <?php echo $bhp_id;?>)"><?php echo $key_t_terima_bhp['terimabhp_kode'];?></a></span>
                        <br><span style='line-height:1em; margin-top: 0px; margin-bottom: 10px;'><font style="font-size: 10px; color: #999;"><?php echo \app\components\DeltaFormatter::formatDateTimeForUser2($created_at);?></font></span>
                        <br><span style='line-height:1em; margin-top: -10px;'><font style="font-size: 10px; color: #999;"><?php echo $hitung_hari;?> hari <?php echo $jam." ".$menit;?></font></span>
                        <br><span style='line-height:1em; margin-top: -20px;'><font style="font-size: 10px; color: #999;">dari Checker </font></span>
                        <br><span style='line-height:1em; margin-top: -20px;'><font style="font-size: 10px; color: #999;"><?php echo \app\components\DeltaFormatter::formatDateTimeForUser2($tanggal_jam_checker);?></font></span>
                    </td>
                    <td style="width: 100px;">
                        ...
                        if (($spo_kode != '' && $spl_kode == '' ) || ($spl_kode != '' && $spo_kode == '') ) {
                            ...
                            <p style='padding-bottom: -10px; margin-bottom: -5px;'><a onclick="infoSPO(<?php echo $spo_id;?>, <?php echo $bhp_id;?>)"><?php echo $spo_kode."</a></p><p style='line-height:1em; margin-top: 0px; margin-bottom: 10px;'><font style='font-size: 10px; color: #999;'>".\app\components\DeltaFormatter::formatDateTimeForUser2($spo_tanggal);?></font></p>
                                                                                    ...
                                                                                    <?php
                                                                                        if($spo_approval_status == 'Not Confirmed'){
                                                                                            $textstyle="style='font-color: darkgray;font-size:10px;'";
                                                                                            }elseif($spo_approval_status == 'APPROVED'){
                                                                                                $textstyle="style='font-color: green;font-size:10px;' class='text-success'";
                                                                                            }elseif($spo_approval_status == 'REJECTED'){
                                                                                                $textstyle="style='font-color: red;font-size:10px;' class='text-danger'";
                                                                                            }

                                                                                      echo"<h $textstyle >$spo_approval_status</h><br><h style='font-size: 10px; color: #999;'>$spo_approval_by ".\app\components\DeltaFormatter::formatDateTimeForUser2($spo_approval_updated)." </h>";
                                                                                    ?>
                                                                                    <?php
                            }
                            ?>
                    ...
                    <td style="width: 100px;"><?php echo $spp_kode;?></td>
                    <td style="width: 100px;"><?php echo $spb_kodex;?></td>
                    <td class="text-center" style="width: 180px; text-align: left;">
                        <?php
                        // lazy script
                        ...
                        $updated_at_1 = \app\components\DeltaFormatter::formatDateTimeForUser2($approval_1->updated_at);
                        $approval_1->status == "Not Confirmed" ? $updated_at_1 = '' : $updated_at_1 = $updated_at_1;
                        if ($approval_1->status == "APPROVED") {
                            echo "<span style='font-size: 12px;' class='text-success'>".$pegawai_nama."</span><br><span style='font-size: 10px; color: #999;'>".$updated_at_1."</span>";
                        } else if ($approval_1->status == "REJECTED") {
                            echo "<span style='font-size: 12px;' class='text-danger'>".$pegawai_nama."</span><br><span style='font-size: 10px; color: #999;'>".$updated_at_1."</span>";
                        } else {
                            echo "<span style='font-size: 12px;' class='text-default'>".$pegawai_nama."</span><br><span style='font-size: 10px; color: #999;'>".$updated_at_1."</span>";
                        }
                        ...
                        $updated_at_2 = \app\components\DeltaFormatter::formatDateTimeForUser2($approval_2->updated_at);
                        $approval_2->status == "Not Confirmed" ? $updated_at_2 = '' : $updated_at_2 = $updated_at_2;
                        if ($approval_2->status == "APPROVED") {
                            echo "<br><span style='font-size: 12px;' class='text-success'>".$pegawai_nama."</span><br><span style='font-size: 10px; color: #999;'>".$updated_at_2."</span>";
                        } else if ($approval_2->status == "REJECTED") {
                            echo "<br><span style='font-size: 12px;' class='text-danger'>".$pegawai_nama."</span><br><span style='font-size: 10px; color: #999;'>".$updated_at_2."</span>";
                        } else {
                            echo "<br><span style='font-size: 12px;' class='text-default'>".$pegawai_nama."</span><br><span style='font-size: 10px; color: #999;'>".$updated_at_2."</span>";
                        }*/
                        ?>
                        ...
                        // super lazy script
                        $sukri = array(58,124);
                        foreach ($sukri as &$sukro) {
                            //select created_at from t_terima_bhp where terimabhp_kode = 'TBP100720007'
                            //select updated_at from t_approval where reff_no = 'TBP100720007' and level = 1 and assigned_to = 58
                            $created_at_ = $key_t_terima_bhp['created_at'];
                            $approval = \app\models\TApproval::find()->where(['reff_no'=>$terimabhp_kode, 'assigned_to'=>$sukro])->one();
                            $pegawai_nama = \app\models\MPegawai::findOne($sukro)->pegawai_nama;
                            $updated_at_ = $approval->updated_at;
                            $updated_at = \app\components\DeltaFormatter::formatDateTimeForUser2($updated_at_);
                            $approval->status == "Not Confirmed" ? $updated_at = '- - -' : $updated_at = $updated_at;
                            $sukro == 124 ? $br = "<br>" : $br = "";

                            $start_date = new DateTime($updated_at_);
                            $since_start = $start_date->diff(new DateTime($created_at_));
                            //echo $since_start->days.' days total<br>';
                            //echo $since_start->y.' years<br>';
                            //echo $since_start->m.' months<br>';
                            $hari = $since_start->d;
                            ...
                            if ($approval->status == "APPROVED") {
                                echo $br."<span style='font-size: 12px;' class='text-success'>".$pegawai_nama.
                                "<br><font style='font-size: 10px; color: #999;'>".$updated_at.
                                "<br>".$hari." ".$jam." ".$menit."</font></span>";
                            } else if ($approval->status == "REJECTED") {
                                echo $br."<span style='font-size: 12px;' class='text-danger'>".$pegawai_nama.
                                "<br><font style='font-size: 10px; color: #999;'>".$updated_at."</font></span>";
                            } else {
                                echo $br."<span style='font-size: 12px;' class='text-default'>".$pegawai_nama.
                                "<br><font style='font-size: 10px; color: #999;'>".$updated_at."</font></span>";
                            }
                        }
                        ?>
                    </td>
                    <td style="vertical-align: top; font-size: 12px; width: 170px;"><?php echo $key_t_terima_bhp['terimabhp_keterangan'];?></td>
                </tr>
                <?php
                    $i++;
                }
