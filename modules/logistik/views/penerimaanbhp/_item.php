...
<tr style="">
	...
	<td style="vertical-align: middle; text-align: center; padding: 3px;">
        ...
        <?= \yii\helpers\Html::activeTextInput($modelDetail, '[ii]pph_peritem', ['class'=>'form-control','style'=>'padding: 3px; font-size:1.1rem; width:70%; height: 25px;display:'.$hide,'disabled'=>'disabled','onblur'=>'setPphPerItem(this,this.value)']); ?>
