...
?>
    <div class="modal fade draggable-modal" id="modal-supplier-edit" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <?= /** @var MSuplier $model */
                            $form->field($model, 'type')->dropDownList(MDefaultValue::getOptionList('tipe-suplier')) ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <?= $form->field($model, 'suplier_nik')->textInput() ?>
