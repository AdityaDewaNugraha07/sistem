                ...
                <div class="row">
                    <div class="col-md-12">
						<div class="table-scrollable">
							<table style="width: 90%; margin: 10px; height: auto;" border="1">
								<tr style="height: 2cm;">
									<td colspan="3">
								...
								<tr style="border-bottom: solid 1px transparent; border-top: solid 1px transparent;">
									...
									<td colspan="2" style="padding-left: 5px; background-color: #F1F4F7; font-size: 1.3rem;"><b><i>
										...
										echo $ret;
										?>
										<?php //echo \app\components\DeltaFormatter::formatNumberTerbilang($total); ?>
									</i></b></td>
								</tr>
								<tr>
									<td colspan="3">
									...
									$lvl1 = ''; $lvl2 = ''; $lvl3 = ''; 
									$tgl_1 = ''; $tgl_2 = ''; $tgl_3 = '';
									$kadepdiv = ''; $direktur = ''; $tgl_kadep = ''; $tgl_dir = '';
									// $modDrp = \app\models\TPengajuanDrp::findOne(['kode'=>$kode]);
									// $modDrp = Yii::$app->db->createCommand("select t_pengajuan_drp.kode, t_pengajuan_drp.status_approve from t_pengajuan_drp 
									...
									if(!empty($modDrp)){
										...
										if($modDrp->status_approve == 'APPROVED'){
											$approvals = TApproval::find()->where(['reff_no'=>$modDrp->kode])->all();
									...
									?>
										<table style="width: 100%; font-size: 1.1rem; text-align: center; border: solid 1px #000; border-bottom: solid 1px #000;" border="1">
											...
											<tr>
												...
												<td style="height: 25px; vertical-align: bottom; padding-left: 5px; text-align: center; border-bottom: solid 1px transparent;"><?= ($model->tanggal_bayar >= '2024-11-25')?$kadepdiv:'' ?></td>
												<td style="height: 25px; vertical-align: bottom; padding-left: 5px; text-align: center; border-bottom: solid 1px transparent;"><?= ($model->tanggal_bayar >= '2024-11-25')?$direktur:'' ?></td>
											...
											<tr>
												...
												<td style="height: 25px; vertical-align: bottom; padding-left: 5px; text-align: left;">Tgl : <?= ($model->tanggal_bayar >= '2024-11-25')?app\components\DeltaFormatter::formatDateTimeForUser2($tgl_kadep):'' ?></td>
												<td style="height: 25px; vertical-align: bottom; padding-left: 5px; text-align: left;">Tgl : <?= ($model->tanggal_bayar >= '2024-11-25')?app\components\DeltaFormatter::formatDateTimeForUser2($tgl_dir):'' ?></td>
											...
											<tr>
												...
												<td style="height: 20px; vertical-align: middle; ">Direktur / Direktur Utama</td>
