    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Retur Penjualan Produk Lokal'); ?></h4>
            </div>
...
function getPiutangTerbayar(callback=null){
	...
	$.ajax({
		url    : '<?php echo \yii\helpers\Url::toRoute(['/finance/piutangpenjualan/SetHighlightListRetur']); ?>',
		type   : 'POST',
		data   : {  },
...
function dtInfo(){
    var dt_table =  $('#table-info').dataTable({
        ajax: { url: '<?= \yii\helpers\Url::toRoute('/finance/piutangpenjualan/openRetur') ?>',data:{dt: 'table-info'} },
        order: [
            [0, 'desc']
        ],
        columnDefs: [
