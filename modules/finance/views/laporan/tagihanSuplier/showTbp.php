            ...
            <div class="modal-header">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <th style="text-align: left; width: 150px;">Alamat</th><td><?= Yii::t('app', ' : '.$modSuplier->suplier_almt); ?></td>                        
                    </tr>
                    <tr>
                        ...
                        <th style="text-align: left; width: 150px; line-height: 1">Keterangan Lain</th><td><?= Yii::t('app', ' : '.$modSuplier->suplier_ket); ?></td>                        
                    </tr>
                    <tr>
    ...
    var dt_table =  $('#table-show').dataTable({
        ...
        columnDefs: [
			...
			{	targets: 7, class: "text-align-center td-kecil",
				...
				render: function ( data, type, full, meta ) {
					if(full[11]>0){
                                            return formatNumberForUser(full[11]);
                                        }else{
                                            return 0;
                                        }
