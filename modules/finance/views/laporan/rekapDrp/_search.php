			...
			<div class="portlet-body">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-5">
							<?php //echo $form->field($model, 'kategori')->dropDownList(['DRP Operational'=>'DRP Operational', 'DRP Log Sengon'=>'DRP Log Sengon', 'DRP Log Alam'=>'DRP Log Alam'],['prompt'=>'All'])->label(Yii::t('app', 'Kategori')); ?>
							<?= $form->field($model, 'status_approve')->dropDownList([""=>"All", "APPROVED"=>"APPROVED","Not Confirmed"=>"NOT CONFIRMED"])->label(Yii::t('app', 'Status ')); ?>
						</div>
					</div>
