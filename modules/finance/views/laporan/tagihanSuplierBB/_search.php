			...
			<div class="portlet-body">
				...
				<div class="modal-body">
					<div class="row">
								...
								<div class="col-md-8">
									<span class="input-group-btn" style="width: 50%">
										<?= $form->field($model, 'per_tanggal',[
													'template'=>'<div class="col-md-6"><div class="input-group input-small date date-picker bs-datetime" data-date-start-date="-0d" data-date-end-date="+0d">{input} <span class="input-group-addon">
						...
						<div class="col-md-6">
							<?= $form->field($model, 'penerima_reff_id')->dropDownList(\app\models\MSuplier::getOptionListBB(),['prompt'=>'All'])->label(Yii::t('app', 'Supplier')); ?>
						</div>
					</div>
