...
<div class="modal fade" id="modal-bbm" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn btn-icon-only btn-default fa fa-close" data-dismiss="modal" aria-hidden="true" style="float: right; padding-top: 2px; padding-bottom: 2px;"></button>
                <h4 class="modal-title"><center><?= Yii::t('app', 'Voucher Penerimaan / BBM'); ?></center></h4>
            </div>
...
//						echo "<center>BBM ini akan terbit setelah dilakukan pemotongan tagihan oleh penerimaan ini (<b>".$model[0]->kode."</b>)</center>"; exit;
                    ...
                    <div class="col-md-12">
						<table style="width: 19cm; margin: 10px; height: auto;" border="1">
							...
							<tr style="border-bottom: solid 1px transparent; border-top: solid 1px transparent;">
								<td style="width: 2cm; padding: 5px 5px; text-align: right; font-size: 1.2rem;">Uang Sejumlah &nbsp; </td>
             ...
             <div class="modal-footer text-align-center" style="padding-top: 10px; display: <?= isset($display_print)?$display_print:""; ?>">
                <?= yii\helpers\Html::button(Yii::t('app', 'Print'),['class'=>'btn blue-steel ciptana-spin-btn btn-outline','onclick'=>'printBbm("'.$model[0]->kode.'")']); ?>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
