		...
		<td colspan="3" style="padding: 0px;">
			<table style="width: 100%" id="table-detail">
				<tr style="border-bottom: solid 1px #000; border-top: solid 1px #000;">
					...
					<th style="padding: 10px; border: solid 1px #000;"><?= Yii::t('app', 'Keterangan'); ?></th>
				...
				foreach ($model as $key) {
					...
					$penerima_alamat = $key['penerima_alamat'];
					$phone = $key['phone'];
				...
				<tr>
					...
					<td style="padding: 3px; border: solid 1px #000;"><?= $nama_penerima; ?></td>
					<td style="padding: 3px; border: solid 1px #000;"><?= $penerima_alamat; ?></td>
					<td style="padding: 3px; border: solid 1px #000;"><?= $phone; ?></td>
					<td style="padding: 3px; border: solid 1px #000;"><?= $keterangan; ?></td>
					<td style="padding: 3px; border: solid 1px #000;"><?= $active; ?></td>
				</tr>
				<?php } ?>
			</table>
		</td>
