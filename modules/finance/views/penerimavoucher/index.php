...
function printout(caraPrint){
	...
	window.open("<?= yii\helpers\Url::toRoute('/finance/penerimavoucher/CustomerPrint') ?>?"+$('#form-search-laporan').serialize()+"&caraprint="+caraPrint+"&search="+search,"",'location=_new, width=1200px, scrollbars=yes');
}
</script>