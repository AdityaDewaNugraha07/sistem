                        ...
                        <table style="width: 100%" id="table-detail">
                            <thead>
                                <tr style="height: 0.5cm; border-bottom: solid 1px #000; border-top: solid 1px #000;">
                                    ...
                                    <th rowspan="2" style="border-right: solid 1px #000; text-align: center">No. Bandsaw</th>
                                    <th rowspan="2" style="border-right: solid 1px #000; text-align: center">Kategori Losstime</th>
                                    <th colspan="2" style="border-right: solid 1px #000; text-align: center">Losstime</th>
                                    <th rowspan="2" style="border-right: solid 1px #000; text-align: center">Keterangan</th>
                                </tr>
								<tr style="height: 0.5cm; border-bottom: solid 1px #000; border-top: solid 1px #000;">
									<th style="border-right: solid 1px #000; text-align: center">Start</th>
									<th style="border-right: solid 1px #000; text-align: center">End</th>
								</tr>
                            </thead>
                            <tbody>
                                <?php
									$modDetails = \app\models\TLosstimeSwmDetail::find()->where(['losstime_swm_id' => $model->losstime_swm_id])->all();
									if(count($modDetails)>0){
										foreach($modDetails as $i => $detail){ ?>
                                            <tr>
                                                ...
                                                <td class="text-align-center" style="border-right: solid 1px #000; border-bottom: solid 1px #000;"><?= $detail->nomor_bandsaw; ?></td>
                                                <td class="text-align-center" style="border-right: solid 1px #000; border-bottom: solid 1px #000;"><?= $detail->kategori_losstime; ?></td>
                                                <td class="text-align-center" style="border-right: solid 1px #000; border-bottom: solid 1px #000;"><?= $detail->losstime_start; ?></td>
												<td class="text-align-center" style="border-right: solid 1px #000; border-bottom: solid 1px #000;"><?= $detail->losstime_end; ?></td>
