									...
									<tbody>
										...
										if(count($contents)>0){ 
											...
											<tr>
                                                ...
                                                <td style='text-align: center;'><?= \app\components\DeltaFormatter::formatNumberForAllUser($data['losstime']); ?></td>
											</tr>
										<?php }
										}else{
											echo"<tr><td colspan='4' style='text-align: center;'>".Yii::t('app', 'Data tidak ditemukan')."<td></tr>";
										}
										?>
									</tbody>
                                </table>
