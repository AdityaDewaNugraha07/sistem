...
//                                                                        echo"<pre>";
//                                                                        $TanggalPengeluaran = substr($models[0]['tanggal'], 0,10);
//                                                                        print_r($TanggalPengeluaran);
//                                                                        echo"</pre>";
//                                                                        exit;
                                                                        
                                                                        $TanggalPengeluaran = substr($models[0]['tanggal'], 0,10);
                                                                        $dateTambah40juta = '2021-07-07';
                                                                        $dateMinus40juta = '2021-07-19';
									...
									<tr style="background-color: #e2e3e5;">
										...
										<td class="td-kecil" > &nbsp; </td>
										<td class="td-kecil" > &nbsp; </td>
										<td class="td-kecil text-align-right" style="font-weight: bold; "><?= app\components\DeltaFormatter::formatNumberForUserFloat( (\app\components\Params::DANA_TETAP_KAS_KECIL) + $DANA_TETAP_KAS_KECIL_TAMBAH_40JUTA ); ?></td>
									</tr>
									<tr style="background-color: #e2e3e5;">
										<td class="td-kecil" colspan="3" style="font-size: 1.2rem; font-weight: bold; text-align: right;">TOTAL TOP-UP</td>
										<td class="td-kecil" > &nbsp; </td>
										<td class="td-kecil" > &nbsp; </td>
										<td class="td-kecil text-align-right" style="font-weight: bold; "><?= app\components\DeltaFormatter::formatNumberForUserFloat( ((\app\components\Params::DANA_TETAP_KAS_KECIL) + $DANA_TETAP_KAS_KECIL_TAMBAH_40JUTA )-(\app\models\HSaldoKaskecil::getSaldoAkhir($models[0]['tanggal'])) ); ?></td>
									</tr>
								</tbody>
							</table>
						</div>
