    ...
    var dt_table =  $('#table-ppk').dataTable({
        ...
        columnDefs: [
			...
			{	targets: 6,
				...
				render: function ( data, type, full, meta ) {
                    if (full[8] > 0) {
                        return '<span class="label label-sm label-danger">ABORTED</span>';
					}else{
						if(data){                           
                            if(data=='UNPAID'){
                                return '<span class="label label-sm label-warning">UNPAID</span>';
			...
			{	targets: 7,
				...
				render: function ( data, type, full, meta ) {
                    if (full[8] > 0) {
                        return "<div style='font-size: 10px; line-height: 1'>by : "+full[9]+"<br>reason : <span class='text-danger'>"+full[10]+"</span><br>at : "+full[11]+"</div>";
                    } else {
                        if(data==true){
                            return '<span class="label label-sm label-success">Telah Diterima</span>';
                        }else{
