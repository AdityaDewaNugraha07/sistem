...
if($_GET['caraprint'] == "EXCEL"){
	...
	header('Content-Disposition: attachment;filename="KUITANSI - '.date("d/m/Y").'.xls"');
					...
					<td style="width: 60%; vertical-align: top; padding-left: 10px;">	
						<table>
							...
							<tr>
								...
								<td style="vertical-align: top; padding-top: 10px;"><b><?php echo $model->untuk_pembayaran; ?></b></td>
							</tr>
							<tr>
