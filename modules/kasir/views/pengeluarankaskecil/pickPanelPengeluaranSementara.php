    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Tambahkan Bon Sementara'); ?></h4>
            </div>
            ...
            <div class="modal-footer text-align-center" style="padding-top: 10px;">
                ...
                <?= yii\helpers\Html::button(Yii::t('app', '<i class="fa fa-plus"></i> Pick'),['class'=>'btn blue ciptana-spin-btn','id'=>'pick-btn','onclick'=>'picking()']); ?>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
function dtTable(){
    var dt_table =  $('#table-dt').dataTable({
        ajax: { url: '<?= \yii\helpers\Url::toRoute('/kasir/pengeluarankaskecil/pickPanelPengeluaranSementara') ?>',data:{dt: 'table-dt'} },
		"pageLength": 500,
		'columnDefs': [
			{
				'targets': 0,
