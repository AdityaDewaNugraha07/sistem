    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Rekap Bon Sementara yang telah direalisasi'); ?></h4>
            </div>
...
function dtTable(){
    var dt_table =  $('#table-dt').dataTable({
        ajax: { url: '<?= \yii\helpers\Url::toRoute('/kasir/pengeluarankaskecil/historyPengeluaranSementara') ?>',data:{dt: 'table-dt'} },
        order: [
            [0, 'desc']
        ],
        columnDefs: [
