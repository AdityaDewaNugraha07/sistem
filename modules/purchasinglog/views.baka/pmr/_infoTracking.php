...
<div class="modal fade" id="modal-infoTracking" tabindex="-1" role="basic" aria-hidden="true">
                    ...
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered table-hover" id="table-daftarSpmLogTracking">
							<thead>
								<tr>
									<th></th>
									<?php /*<th style="width: 100px;"><?= Yii::t('app', 'Kode'); ?></th>
...
function daftarSpmLogTracking(){
    var dt_table =  $('#table-daftarSpmLogTracking').dataTable({
        ajax: { url: '<?= \yii\helpers\Url::toRoute('/purchasinglog/pmr/infoTracking') ?>', data:{jenis_log: '<?php echo $jenis_log;?>', dt: 'modal-daftarSpmLogTracking'} },
        order: [
            [0, 'desc']
        ],
        columnDefs: [
            ...
            {	targets: 6, class:"text-center", visible: false,
                render : function ( data, type, full, meta ) {
