...
<tr>
	...
	<td style="text-align: center; padding: 2px; font-size: 10px;">
		<center><?= yii\helpers\Html::activeTextInput($modDetail, '[ii]diameter_ujung',['class'=>'form-control float','style'=>'padding: 2px; text-align:center; font-size:13px; height:25px;','onblur'=>'hitungRata(this); hitungVolume(this)','disabled'=>$disabled]); ?></center>
	</td>
	<td style="text-align: center; padding: 2px; font-size: 10px;">
		<center><?= yii\helpers\Html::activeTextInput($modDetail, '[ii]diameter_pangkal',['class'=>'form-control float','style'=>'padding: 2px; text-align:center; font-size:13px; height:25px;','onblur'=>'hitungRata(this); hitungVolume(this)','disabled'=>$disabled]); ?></center>
	</td>
	<td style="text-align: center; padding: 2px; font-size: 10px;">
	...
	<td style="text-align: center; padding: 2px; font-size: 10px;">
		<?php //= \yii\bootstrap\Html::activeDropDownList($modDetail, '[ii]volume_range', \app\models\MDefaultValue::getOptionList('volume-range-log'),['class'=>'form-control bs-select','style'=>'padding: 2px; font-size:13px; height:25px;','disabled'=>$disabled]); ?>
		<center><?= yii\helpers\Html::activeTextInput($modDetail, '[ii]volume_range',['class'=>'form-control','style'=>'padding: 2px; text-align:center; font-size:13px; height:25px;','readonly'=>true]); ?></center>
	</td>
	<td style="text-align: center; padding: 2px; font-size: 10px;">
