...
<table style="width: 20cm; margin: 10px;" border="1">
                            ...
                            <tr style="border-bottom: solid 1px #000;">
                                <?php foreach($diameterharga as $i => $diaharga){ ?>
                                    ...
                                    <td style="padding: 1px; width: <?= (100/Count($diameterharga))/2 ?>%; <?= ( count($diameterharga)!=($i+1)?"border-right: solid 1px #000;":"" ) ?>" class="text-align-right">
                                        <?php echo isset($diaharga[($jj)])? "Rp. &nbsp;".number_format($diaharga[($jj)]['harga']):""; ?>
                                    &nbsp; </td>
                                <?php } ?>
                            </tr>
                        </table>
    ...
    <tr style="border-bottom: solid 1px transparent;">
        <td colspan="3" style="padding: 1px;"><i>
            ** Pengiriman tidak boleh melebihi jumlah kuota yang sudah ditetapkan (Toleransi kelebihan maksimal 5% dari banyaknya kuota) <br>
            ** Jika ada rencana pengiriman yang lebih dari kebijakan yang diberikan, harap konfirmasi terlebih dahulu ke pihak <?= $modCompany->name ?>
        </i></td>
    </tr>
    <tr style="border-bottom: solid 1px transparent;">
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="width: 6cm;text-align: center; padding:3px;">
                        <?php echo '<img src="'.\Yii::$app->view->theme->baseUrl.'/cis/img/sertifikatplusFSC.jpg" alt="" class="logo-default" style="width: 6cm;">'; ?>
                    </td>
...
<table style="width: 20cm; margin: 10px;" border:0;>   
    <tr>
        <td style="font-size: 0.9rem; border: solid 1px transparent; vertical-align: top;text-align:right;">
                <span class="pull-right nomor-dokumen-qms" style="font-size: 0.8rem;">CWM-FK-PCH-04-0</span>
        </td>
    </tr>
</table>