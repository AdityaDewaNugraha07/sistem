                            ...
                            <div class="portlet-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <?= $form->field($model, 'etd')->textInput(['id'=>'tspkshipping-etd','class'=>'form-control','readonly'=>true])->label("ETD"); ?>
                                        <?= $form->field($model, 'eta_logpond')->textInput(['id'=>'tspkshipping-eta_logpond','class'=>'form-control','readonly'=>true])->label("ETA Logpond"); ?>
                                        <?= $form->field($model, 'eta')->textInput(['id'=>'tspkshipping-eta','class'=>'form-control','readonly'=>true])->label("ETA"); ?>
                                        <?php
                                        }
                                        ?>
