	...
	<td class="td-kecil" style="vertical-align: middle; padding-top: 20px; ">
		<span class="input-group-btn" style="width: 100%">
            ...
            if(!empty($edit) || !empty($model->hasil_orientasi_id)){
                ...
                echo yii\helpers\Html::activeDropDownList($model, '[ii]gt_dkg_id', app\models\TDkg::getOptionListDkgOrientasi(),['class'=>'form-control select2','prompt'=>'','style'=>'width:80%; padding: 2px; ','onchange'=>'setGrader(this)','disabled'=>$disabled]);
