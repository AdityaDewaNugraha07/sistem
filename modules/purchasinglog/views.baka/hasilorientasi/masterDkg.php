    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Dinas Keluar Grader'); ?></h4>
            </div>
                    ...
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered table-hover table-laporan" id="table-master">
							<thead>
								<tr>
									<th></th>
									<th style="width: 250px;"><?= Yii::t('app', 'Kode Dinas') ?></th>
									<th style="width: 120px;"><?= Yii::t('app', 'Tipe') ?></th>
									<th style="width: 120px;"><?= Yii::t('app', 'Tanggal') ?></th>
									<th style="width: 350px;"><?= Yii::t('app', 'Grader') ?></th>
									<th style="width: 350px;"><?= Yii::t('app', 'Wilayah Dinas') ?></th>
								</tr>
							</thead>
						</table>
						</div>
...
function dtMaster(){
    var dt_table =  $('#table-master').dataTable({
        ajax: { url: '<?= \yii\helpers\Url::toRoute('/purchasinglog/hasilorientasi/masterDkg') ?>',data:{dt: 'table-master'} },
        order: [
            [0, 'desc']
        ],
        columnDefs: [
