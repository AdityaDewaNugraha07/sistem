...
<?php $modelTspShipping = \app\models\TSpkShipping::find()->where(['spk_shipping_id'=>$id])->one();?>
<div class="modal fade" id="modal-spkShippingTracking" tabindex="-1" role="basic" aria-hidden="true">
