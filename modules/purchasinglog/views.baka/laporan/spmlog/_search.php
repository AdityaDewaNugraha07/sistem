			...
			<div class="portlet-body">
				...
				<div class="modal-body">
					<div class="row">
                        ...
                        <?= $form->field($model, 'pic_shipping')->dropDownList(\app\models\MPegawai::getOptionListByDept(114),['prompt'=>'All','class'=>'form-control select2'] )->label(Yii::t('app', 'PIC Shipping')); ?>
                        <?= $form->field($model, 'status')->dropDownList(\app\models\MDefaultValue::getOptionList('shipping_tracking'),['prompt'=>'All','class'=>'form-control select2'] )->label(Yii::t('app', 'Status')); ?>
						</div>
					</div>
