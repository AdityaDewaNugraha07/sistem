...
$this->title = 'Laporan Biaya Grader'; 
		...
		<div class="portlet light bordered">
			...
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject hijau bold"><?= Yii::t('app', 'Daftar Biaya Grader '); ?><span id="periode-label" class="font-blue-soft"></span></span>
				</div>
				<div class="tools">
				...
				<table class="table table-striped table-bordered table-hover" id="table-laporan">
					<thead>
						<tr>
							...
							<th><?= Yii::t('app', 'Tipe Dinas') ?></th>
							<th><?= Yii::t('app', 'Wilayah Dinas') ?></th>
							<th><?= Yii::t('app', 'Periode Dinas') ?></th>
							<th></th>
...
<?php $this->registerJs("
	...
	setMenuActive('".json_encode(app\models\MMenu::getMenuByCurrentURL('Biaya Grader'))."')
...
function dtLaporan(){
    var dt_table =  $('#table-laporan').dataTable({
		pageLength: 20,
        ajax: { 
			url: '<?= \yii\helpers\Url::toRoute('/purchasinglog/laporan/biayaGrader') ?>',
			data:{
				dt: 'table-laporan',
        ...
        columnDefs: [
			...
			{	
				targets: 7, 
				render: function ( data, type, full, meta ) {
					return '<center>'+ formatInteger(data) +'</center>';
                }
			},  
			{	
				targets: 8, 
