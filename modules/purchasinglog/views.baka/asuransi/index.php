                        ...
                        <div class="portlet light bordered">
                            ...
                            <div class="portlet-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group field-tasuransi-rate">
                                            ...
                                            <div class="col-md-8">
                                                <input <?php echo $disabledY; ?> value="<?php echo \app\components\DeltaFormatter::formatNumberForAllUser($model->rate, 2); ?>" type="text" id="tasuransi-rate" name="TAsuransi[rate]" class="form-control float" style="min-height: 30px; width:100%; padding: 2px; height:25px; font-size:1.2rem;">
                                        ...
                                        <div class="form-group field-tasuransi-freight">
                                            ...
                                            <div class="col-md-8">
                                                <input <?php echo $disabledY; ?> value="<?php echo \app\components\DeltaFormatter::formatNumberForAllUser($model->freight); ?>" type="text" id="tasuransi-freight" name="TAsuransi[freight]" class="form-control float" style="min-height: 30px; width:100%; padding: 2px; height:25px; font-size:1.2rem;" onblur="hitungTotal();">
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                        <div class="form-group field-tasuransi-freight">
                                            ...
                                            <div class="col-md-8">
                                                <input type="checkbox" name="lumpsump" id="lumpsump" style="margin-top: 10px;" onchange="hitungTotal()" <?= $model->lumpsump ? 'checked' : '' ?>>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group field-tasuransi-rate">
                                            <label class="col-md-4 control-label" for="tasuransi-rate">Nominal DR</label>
                                            <div class="col-md-8">
                                                <?php
                                                if ((isset($_GET['edit']) && $_GET['edit'] > 0) && (isset($_GET['asuransi_id']) && $_GET['asuransi_id'] > 0)) {
                                                    $sql_dr = "select tipe, harga from t_asuransi_detail where tipe = 'DR' and asuransi_id = " . $_GET['asuransi_id'] . "";
                                                    $sql_psdh = "select tipe, harga from t_asuransi_detail where tipe = 'PSDH' and asuransi_id = " . $_GET['asuransi_id'] . "";
                                                    $dr = \app\models\TAsuransiDetail::find()->where(["tipe" => 'DR', "asuransi_id" => $_GET['asuransi_id']])->one();
                                                    $psdh = \app\models\TAsuransiDetail::find()->where(["tipe" => 'PSDH', "asuransi_id" => $_GET['asuransi_id']])->one();
                                                    $dr_harga = \app\components\DeltaFormatter::formatNumberForAllUser($dr->harga);
                                                    $psdh_harga = \app\components\DeltaFormatter::formatNumberForAllUser($psdh->harga);
                                                } else {
                                                    $dr_harga = "";
                                                    $psdh_harga = "";
                                                }
                                                ?>
                                                <input value="<?php echo $dr_harga; ?>" type="text" id="dr" name="dr" class="form-control float" style="min-height: 30px; width:100%; padding: 2px; height:25px; font-size:1.2rem;" onblur="hitungTotal();" <?php echo $disabledY; ?>>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group field-tasuransi-rate">
                                            <label class="col-md-4 control-label" for="tasuransi-rate">Nominal PSDH</label>
                                            <div class="col-md-8">
                                                <input value="<?php echo $psdh_harga; ?>" type="text" id="psdh" name="psdh" class="form-control float" style="min-height: 30px; width:100%; padding: 2px; height:25px; font-size:1.2rem;" onblur="hitungTotal();" <?php echo $disabledY; ?>>
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-scrollable">
                                            <table class="table table-striped table-bordered table-advance table-hover" id="table-asuransi-detail">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 39%; text-align: left;"><?= Yii::t('app', 'Jenis Kayu'); ?></th>
                                                        <th style="width: 20%;"><?= Yii::t('app', 'Harga'); ?></th>
                                                        <th style="width: 20%;"><?= Yii::t('app', 'Kubikasi'); ?></th>
                                                ...
                                                <tbody>
                                                    ...
                                                    if ((isset($_GET['edit']) && $_GET['edit'] > 0) && (isset($_GET['asuransi_id']) && $_GET['asuransi_id'] > 0)) {
                                                        ...
                                                        $sql = "select * from (select distinct on (jenis) * from t_asuransi_detail where asuransi_id = " . $asuransi_id . " order by jenis, asuransi_detail_id asc) stupidYetCocky order by asuransi_detail_id asc";
                                                        $j = Yii::$app->db->createCommand($sql)->queryAll();
                                                        $i = 0;
                                                        foreach ($j as $u) {
                                                            $x = \app\models\TAsuransiDetail::findOne(['asuransi_id' => $_GET['asuransi_id'], 'jenis' => $u['jenis']]);
                                                            $harga = $x->harga;
                                                            $kubikasi = $x->kubikasi;
                                                            $total = $x->total;
                                                    ...
                                                    ?>
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <?php
                                                                    //echo yii\helpers\Html::activeDropDownList($x, '['.$i.']jenis', app\models\MKayu::getOptionListN(), ['value'=>$u['jenis'], 'class'=>'form-control select2', 'multiple'=>'multiple', 'style'=>'width:100%;']);
                                                                    ?>
                                                                    <select id="tasuransidetail-3-jenis" class="form-control select2 select2-hidden-accessible" name="TAsuransiDetail[<?php echo $i; ?>][jenis][]" value="Bintangur, Bipa" multiple="" size="4" style="width:100%;" tabindex="-1" aria-hidden="true" <?php echo $disabledY; ?>>
                                                                        ...
                                                                        foreach ($options as $abc => $cba) {
                                                                            ...
                                                                            if (count($jenisA) > 1) {
                                                                                ...
                                                                                if (strpos($susu, $cba->kayu_nama) !== false) {
                                                                                    $selected = "selected";
                                                                                } else {
                                                                                    $selected = "";
                                                                                }
                                                                ...
                                                                <td><input value="<?php echo \app\components\DeltaFormatter::formatNumberForAllUser($harga); ?>" type="text" id="tasuransidetail-<?php echo $i; ?>-harga" class="form-control float text-right" name="TAsuransiDetail[<?php echo $i; ?>][harga]" style="width:100%; padding: 2px;" onblur="hitungTotal();" <?php echo $disabledY; ?>></td>
                                                                <td><input value="<?php echo \app\components\DeltaFormatter::formatNumberForAllUser($kubikasi); ?>" type="text" id="TAsuransiDetail_<?php echo $i; ?>_kubikasi" class="form-control float text-right" name="TAsuransiDetail[<?php echo $i; ?>][kubikasi]" style="width:100%; padding: 2px;" onblur="hitungTotal();" <?php echo $disabledY; ?>></td>
                                                                <td><input value="<?php echo \app\components\DeltaFormatter::formatNumberForAllUser($total); ?>" type="text" id="TAsuransiDetail_<?php echo $i; ?>_total" class="form-control float text-right" name="TAsuransiDetail[<?php echo $i; ?>][total]" style="width:100%; padding: 2px;" onblur="hitungTotal();" readonly></td>
                                                                <?= $cancelItem ?>
                                                            </tr>
                                                        <?php
                                                            $i++;
                                                        ...
                                                        ?>
                                                            <tr class="xxx" id="xxx-<?php echo $k; ?>">
                                                                ...
                                                                <td><input type="text" id="tasuransidetail-<?php echo $k; ?>-harga" class="form-control float text-right" name="TAsuransiDetail[<?php echo $k; ?>][harga]" style="width:100%; padding: 2px;" onblur="hitungTotal();"></td>
                                                                <td><input type="text" id="TAsuransiDetail_<?php echo $k; ?>_kubikasi" class="form-control float text-right" name="TAsuransiDetail[<?php echo $k; ?>][kubikasi]" style="width:100%; padding: 2px;" onblur="hitungTotal();"></td>
                                                                <td><input type="text" id="TAsuransiDetail_<?php echo $k; ?>_total" class="form-control float text-right" name="TAsuransiDetail[<?php echo $k; ?>][total]" style="width:100%; padding: 2px;" onblur="hitungTotal();" readonly></td>
                                                        ...
                                                        $cancelItem = "<td><a class='btn btn-xs red' onclick='cancelItemThis(this);'><i class='fa fa-remove'></i></a></td>";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" id="tasuransidetail-ii-harga" class="form-control float text-right" name="TAsuransiDetail[0][harga]" style="width:100%; padding: 2px;" onblur="hitungTotal();"></td>
                                                            <td><input type="text" id="TAsuransiDetail_0_kubikasi" class="form-control float text-right" name="TAsuransiDetail[0][kubikasi]" style="width:100%; padding: 2px;" onblur="hitungTotal();"></td>
                                                            <td><input type="text" id="TAsuransiDetail_0_total" class="form-control float text-right" name="TAsuransiDetail[0][total]" style="width:100%; padding: 2px;" onblur="hitungTotal();" readonly></td>
                                                            <?= $cancelItem ?>
                                                        </tr>
                                                        <?php
                                                        $i = 1;
                                                        ...
                                                        ?>
                                                            <tr class="xxx" id="xxx-<?php echo $i; ?>">
                                                                ...
                                                                <td><input type="text" id="tasuransidetail-<?php echo $i; ?>_harga" class="form-control float text-right" name="TAsuransiDetail[<?php echo $i; ?>][harga]" style="width:100%; padding: 2px; onblur=" hitungTotal();"></td>
                                                                <td><input type="text" id="TAsuransiDetail_<?php echo $i; ?>_kubikasi" class="form-control float text-right" name="TAsuransiDetail[<?php echo $i; ?>][kubikasi]" style="width:100%; padding: 2px;" onblur="hitungTotal();"></td>
                                                                <td><input type="text" id="TAsuransiDetail_<?php echo $i; ?>_total" class="form-control float text-right" name="TAsuransiDetail[<?php echo $i; ?>][total]" style="width:100%; padding: 2px;" onblur="hitungTotal();" readonly></td>
                                                                <?= $cancelItem ?>
                                                            </tr>
                                                    <?php
                                                        }
                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr class="tr_hidex">
                                                        <td colspan="1" class="text-right">Freight Kubikasi</td>
                                                        ...
                                                        <td><input <?php echo $disabledY; ?> readonly='readonly' type="text" id="tasuransi-kubikasiY" class="form-control float" style="width:100%; padding: 2px; font-size:1.2rem;" onblur="hitungTotal();"></td>
...
<script>
    ...
    function editPpn() {
        ...
        $('#tasuransi-grandtotal').val(total);
    }
</script>