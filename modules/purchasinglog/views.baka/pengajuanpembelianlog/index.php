                            ...
                            <div class="portlet-body">
                                    ...
                                    <div class="col-md-6">
										...
										<?php if(!isset($_GET['pengajuan_pembelianlog_id'])){ ?>
                                            ...
                                            <label class="col-md-4 control-label"><?= Yii::t('app', 'Kode'); ?></label>
												...
												<label class="col-md-4 control-label"><?= Yii::t('app', 'No. Cardpad'); ?></label>
												<div class="col-md-8" style="padding-bottom: 5px;">
													<table style="width: 100%">
														<tr>
															<td><?= \yii\bootstrap\Html::activeTextInput($model, 'kode_cardpad', ['class'=>'form-control','style'=>'width:100%; font-weight:bold','disabled'=>'disabled']) ?></td>
														</tr>
													</table>
												</div>
											</div>
										<?php }else{ ?>
											...
											<div class="form-group">
												<label class="col-md-4 control-label"><?= Yii::t('app', 'Kode Cardpad'); ?></label>
												<div class="col-md-8" style="padding-bottom: 5px;">
													<table style="width: 100%">
														<tr>
															<td style="width: 50%"><?= \yii\bootstrap\Html::activeTextInput($model, 'kode_cardpad', ['class'=>'form-control','style'=>'width:100%']) ?></td>
															<td style="width: 10%"><a class="btn btn-icon-only btn-default tooltips" data-original-title="Copy to Clipboard" onclick="copyToClipboard('<?= $model->kode ?>');">
																	<i class="icon-paper-clip"></i>
																</a>
															</td>
                                ...
                                <div class="row" style="margin-left: -20px; margin-right: -20px;">
                                    <div class="col-md-12" style="padding-left: 0px; padding-right: 0px;">
                                        ...
                                        <?php
                                        // tambah permintaan manual disable, automatis muncul saat pemilihan kode PO
	...
	$.ajax({
		...
		success: function (data) {
			if(data){
                ...
                // tambahkan baris Permintaan Pembelian Log Alam 
                // ambil dari funsi pick()
                var allowadd = true;
                $('#table-detail-permintaan > tbody > tr#empty-tr').remove();
                $('#table-detail-permintaan > tbody > tr').each(function(){
                    if($(this).find("input[name*='[pmr_id]']").val() != data.pmr_id){
