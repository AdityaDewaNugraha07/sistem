                                ...
                                foreach ($tipess as $tipes => $tipe) {
                                    ...
                                    if ($details['jenis'] != "" && !empty($details['jenis']) ) {
                                        ...
                                        if ($tipe == $Details)  {
                                            ...
                                            $modAsuransiDetail->harga = $_POST['dr'];
                                            $modAsuransiDetail->total = $_POST['dr'] * $details['kubikasi'];
                                        } else if ($tipe == "PSDH") {
                                            $modAsuransiDetail->harga = $_POST['psdh'];
                                            $modAsuransiDetail->total = $_POST['psdh'] * $details['kubikasi'];
                                        } 
...
//                        $ppn = $jumlah * Params::DEFAULT_PPN;
                        $ppn = $_POST['TAsuransi']['ppn'];
