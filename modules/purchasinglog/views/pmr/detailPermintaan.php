                ...
                <div class="row" style="margin-bottom: 10px;">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group col-md-12" style="line-height:1">
                            <label class="col-md-5 control-label"><?= $model->attributeLabels()['approver_1'] ?><br><span style="font-size: 1.1rem; font-weight: 600"><?= ($model->tujuan == "INDUSTRI")?"Kadiv Operasional":"Kadiv Marketing" ?></span></label>
                            <div class="col-md-7">
                        ...
                        <div class="form-group col-md-12" style="line-height:1">
                            <label class="col-md-5 control-label"><?= $model->attributeLabels()['approver_2'] ?><br><span style="font-size: 1.1rem; font-weight: 600"><?= ($model->tujuan == "INDUSTRI")?"GM Operasional":"GM Operasional" ?></span></label>
                            <div class="col-md-7">
                        ...
                        <div class="form-group col-md-12" style="line-height:1">
                            <label class="col-md-5 control-label"><?= $model->attributeLabels()['approver_3'] ?><br><span style="font-size: 1.1rem; font-weight: 600"><?= Yii::t('app', 'Direktur Utama'); ?></span></label>
                            <div class="col-md-7">
                        ...
                        <div class="form-group col-md-12" style="line-height:1">
                            <label class="col-md-5 control-label"><?= $model->attributeLabels()['approver_4'] ?><br><span style="font-size: 1.1rem; font-weight: 600"><?= Yii::t('app', 'Owner'); ?></span></label>
                            <div class="col-md-7">
                                <strong><?= \app\models\MPegawai::findOne($model->approver_4)->pegawai_nama; ?></strong>
                                <span style="font-weight: 500; font-size: 1rem;">
                                    <?php if($approver_4['status']==\app\models\TApproval::STATUS_APPROVED){
                                        ...
                                        echo " <br>&nbsp; <span class='font-red-flamingo'> ".\app\models\TApproval::STATUS_REJECTED." at ".
                                                \app\components\DeltaFormatter::formatDateTimeForUser2($approver_4['updated_at'])."</span>";
                                        $modApproval = app\models\TApproval::findOne(['reff_no'=>$model->kode,'assigned_to'=>$model->approver_4]);
                                        $reasons = \yii\helpers\Json::decode($modApproval->keterangan);
                                        if(count($reasons)>0){
                                            foreach($reasons as $i => $reason){
                                        ...
                                        echo	"<td>".$detail->kayu->group_kayu." - ".$detail->kayu->kayu_nama."</td>";
                                            ...
                                            foreach($ukuranganrange as $i => $range){
                                                $sql = "SELECT SUM(qty_m3) AS qty_m3 FROM t_pmr_detail 
                                                        WHERE pmr_id = {$model->pmr_id} AND kayu_id = {$detail->kayu_id} AND keterangan='{$detail['keterangan']}' AND diameter_range = '{$range}'";
