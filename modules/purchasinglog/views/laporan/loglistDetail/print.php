                                ...
                                <table class="table table-striped table-bordered table-hover" id="table-laporan">
                                    <thead>
										...
										<tr>
											...
											<th style="width: 75px;"><?= Yii::t('app', 'Btg'); ?></th>
									...
									<tbody>
										...
										if(!empty($contents)){ 
											...
											<tr>
												<td class="text-align-center td-kecil"><?= $data->nomor_grd ?></td>
												<td class="text-align-center td-kecil"><?= $data->nomor_produksi ?></td>
												<td class="text-align-center td-kecil"><?= $data->nomor_batang ?></td>
												<td class="td-kecil"><?= $data->kayu_nama ?></td>
												<td class="text-align-right td-kecil"><?= $data->panjang ?></td>
												<td class="text-align-right td-kecil"><?= $data->diameter_ujung ?></td>
												<td class="text-align-right td-kecil"><?= $data->diameter_pangkal ?></td>
												<td class="text-align-right td-kecil"><?= $data->diameter_rata ?></td>
												<td class="text-align-right td-kecil"><?= $data->cacat_panjang ?></td>
												<td class="text-align-right td-kecil"><?= $data->cacat_gb ?></td>
												<td class="text-align-right td-kecil"><?= $data->cacat_gr ?></td>
												<td class="text-align-center td-kecil"><?= $data->volume_range ?></td>
												<td class="text-align-right td-kecil"><?= $data->volume_value ?></td>
												<td class="text-align-center td-kecil"><?= ($data->is_freshcut)?"Ya":"Tidak"; ?></td>
											</tr>
										<?php }
										}else{ ?>
											<tr>
												<td colspan='14' class="text-align-center td-kecil">Data tidak ditemukan</td>
											</tr>
										<?php }
										?>
									</tbody>
