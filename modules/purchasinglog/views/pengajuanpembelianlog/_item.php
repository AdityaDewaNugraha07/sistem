...
<tr style="">
	...
	?>
		...
		<td class="td-kecil" style="vertical-align: middle; text-align: center;">
			<?= \yii\bootstrap\Html::activeTextInput($model, '[ii]['.$range.']qty_m3',['class'=>'form-control float col-m3','style'=>'width:100%; padding: 1px; height:25px; font-size:1rem;','value'=>number_format($modQty['qty_m3'], 2),'onblur'=>"total('".strtolower($tipe)."');","disabled"=>$disabled]); ?>
		</td>
		<td class="td-kecil" style="vertical-align: middle; text-align: center;">
