...
<script>
    ...
    function hitungTotal() {
        ...
        $('#table-asuransi-detail').find('tr').each(function() {
            ...
            $(this).find("input[name*='[total]']").val(formatNumberForUser2Digit(total));
            $(this).find("input[name*='[total_dr]']").val(formatNumberForUser2Digit(totaldr));
            $(this).find("input[name*='[total_psdh]']").val(formatNumberForUser2Digit(totalpsdh));
        ...
        $('#tasuransi-freightY').val(formatNumberForUser2Digit(freight));
        if($('#lumpsump').is(':checked')) {
        ...
        $('#tasuransi-freight-kubikasi').val(formatNumberForUser2Digit(freightxkubikasiX));
        var jumlah = (totalX + drX + psdhX) + freightxkubikasiX;
        var ppn = jumlah * <?= \app\components\Params::DEFAULT_PPN?>;
        var grandtotal = jumlah + ppn;
        $('#tasuransi-jumlah').val(formatNumberForUser2Digit(jumlah));
        $('#tasuransi-ppn').val(formatNumberForUser2Digit(ppn));
        $('#tasuransi-grandtotal').val(formatNumberForUser2Digit(grandtotal));
        $('#tasuransi-pembulatan').val(formatNumberForUser2Digit(grandtotal));
    }
    function hitungTotalEdit() {
        ...
        $('#table-asuransi-detail').find('tr').each(function() {
            ...
            totalX += harga * kubikasi;
            $('#tasuransi-totalX').val(formatNumberForUser2Digit(totalX)); 
        });
        $('#tasuransi-kubikasiX').val(formatNumberForUser(jmlkubikasi * 1));
        var freight = unformatNumber($('#tasuransi-freight').val());
        $('#tasuransi-freightY').val(formatNumberForUser2Digit(freight));
    ...
    function editPpn() {
        ...
        $('#tasuransi-grandtotal').val(formatNumberForUser2Digit(total));
        console.log(total);
    }
</script>