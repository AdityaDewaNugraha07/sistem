                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div><input value="<?php echo \app\components\DeltaFormatter::formatNumberForAllUser($harga); ?>" type="text" id="tasuransidetail-<?php echo $i; ?>-harga" class="form-control float text-right" name="TAsuransiDetail[<?php echo $i; ?>][harga]" style="width:100%; padding: 2px;" onblur="hitungTotalEdit();" <?php echo $disabledY; ?>></div>
                                                                </td>
                                                                <td>
                                                                    <input value="<?php echo \app\components\DeltaFormatter::formatNumberForAllUser($kubikasi); ?>" type="text" id="TAsuransiDetail_<?php echo $i; ?>_kubikasi" class="form-control float text-right" name="TAsuransiDetail[<?php echo $i; ?>][kubikasi]" style="width:100%; padding: 2px;" onblur="hitungTotalEdit();" <?php echo $disabledY; ?>>
                                                                </td>
                                                                <td>
