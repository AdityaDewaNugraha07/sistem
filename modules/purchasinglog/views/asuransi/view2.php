                            ...
                            <div class="portlet-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group field-tasuransi-discount has-success">
                                            <label class="col-md-4 control-label" for="tasuransi-discount">Discount (%)</label>
                                            <div class="col-md-8">
                                                <input <?php echo $disabledX;?> value="<?php echo \app\components\DeltaFormatter::formatNumberForAllUser($model->discount,2);?>" type="text" id="tasuransi-discount" name="TAsuransi[discount]" class="form-control float" style="min-height: 30px; width:100%; padding: 2px; height:25px; font-size:1.2rem;" value="<?php echo \app\components\DeltaFormatter::formatNumberForAllUser(($model->freight * 1));?>">
                                                <span class="help-block"></span>
                                            </div>
                                        </div>
