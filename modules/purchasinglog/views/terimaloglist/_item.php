...
<tr style="">
	...
	<td style="text-align: center; padding: 2px; font-size: 10px;">
		<center>
			<?= yii\helpers\Html::activeTextInput($modDetail, '[ii]diameter_rata',['class'=>'form-control float','disabled'=>TRUE,'style'=>'padding: 2px; text-align:center; font-size:13px; height:25px;']); ?>
