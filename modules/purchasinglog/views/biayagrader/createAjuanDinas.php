...
?>
<div class="modal fade" id="modal-ajuan" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
			<?php $form = \yii\bootstrap\ActiveForm::begin([
				'id' => 'form-transaksi-ajuandinas',
				'fieldConfig' => [
            ...
            <div class="modal-body">
                <div class="row">
					<div class="col-md-6">
						...
						<?= $form->field($model, 'tanggal',[
                            'template'=>'{label}<div class="col-md-6"><div class="input-group input-medium date date-picker bs-datetime" style="width:195px !important">{input} <span class="input-group-addon">
								...
								{error}</div>'])->textInput(['readonly'=>'readonly'])->label('Tanggal Ajuan'); ?>
						...
						<?= $form->field($model, 'kanit_grader')->dropDownList(\app\models\MPegawai::getOptionListAtasan(),['class'=>'form-control select2','prompt'=>'']); ?>
					...
					<div class="col-md-6">
						...
						<?= $form->field($model, 'wilayah_dinas_plafon')->textInput(['readonly'=>true,'class'=>'form-control float'])->label("Plafon"); ?>
						<?= $form->field($model, 'saldo_sebelumnya')->textInput(['readonly'=>true,'class'=>'form-control float'])->label("Sisa Saldo"); ?>
						<?= $form->field($model, 'total_ajuan')->textInput(['style'=>'font-weight:800','class'=>'form-control float'])->label("Total Ajuan"); ?>
            ...
            <div class="modal-footer text-align-center">
				<?php echo \yii\helpers\Html::button( Yii::t('app', 'Ajukan Uang Dinas'),['class'=>'btn hijau btn-outline ciptana-spin-btn',
                    'onclick'=>'submitformajax(this,"$(\'#close-btn-modal2\').removeAttr(\'disabled\'); $(\'#close-btn-modal2\').trigger(\'click\'); getItemsAjuan('.$model->dkg_id.');  getSaldo();")'
                    ]);
				?>
            </div>
