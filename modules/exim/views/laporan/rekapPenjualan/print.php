                            ...
                            <div class="portlet-body">
                                <table class="table table-striped table-bordered table-hover" id="table-laporan">
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="2"
                                            style="line-height: 1;"><?= Yii::t('app', 'Volume<br>M<sup>3</sup>') ?></th>
                                        ...
                                        <th rowspan="2"
                                            style="line-height: 1;"><?= Yii::t('app', 'Packinglist No.') ?></th>
                                        <th colspan="4" style="line-height: 1;"><?= Yii::t('app', 'Container') ?></th>
                                        <th rowspan="2"
                                            style="line-height: 1;"><?= Yii::t('app', 'Tanggal<br>Stuffing') ?></th>
                                        <th rowspan="2"
                                            style="line-height: 1;"><?= Yii::t('app', 'Payment<br>Method') ?></th>
                                        <th rowspan="2"
                                            style="line-height: 1;"><?= Yii::t('app', 'Term Of<br>Price') ?></th>
                                        ...
                                        <th rowspan="2"
                                            style="line-height: 1;"><?= Yii::t('app', 'Final<br>Destination') ?></th>
                                    </tr>
                                    <tr>
                                    ...
                                    if (!empty($contents)) {
                                        ...
                                        foreach ($contents as $i => $data) {
                                            $total_m3 += number_format($data['total_volume_inv'], 4);
                                            $total_container += $data['total_container'];
                                            ?>
                                            <tr>
...
//                                                    $tgl = date('Y-m-d', strtotime(\app\components\DeltaFormatter::formatDateTimeForDb($data->tanggal)));
...
//                                                    }
                                                    // END KEBIJAKAN
//                                                    kebijakan sudah di sesuaikan di query database
                                                    ?>
                                                    <?php
                                                        $subtotal =  $data->total_harga + $data->total_biaya_tambahan - $data->total_potongan;
                                                        $total_usd += $subtotal;
                                                        echo $subtotal;
                                                    ?>
                                                </td>
                                    ...
                                    <tr>
                                        <td colspan="3"></td>
                                        <td style="font-size: 1rem; text-align: right;">
                                            <?php echo \app\components\DeltaFormatter::roundUp($total_usd, 2); ?>
                                        </td>
                                        <td style="font-size: 1rem; text-align: right;">
                                            <?php echo \app\components\DeltaFormatter::formatNumberForAllUser($total_m3, 4); ?>
                                        </td>
                                        <td colspan="7"></td>
                                        <td style="font-size: 1rem; text-align: center;"><?php echo $total_container; ?></td>
                                        <td colspan="11"></td>
                                    </tr>
                                    </tbody>
                                </table>
