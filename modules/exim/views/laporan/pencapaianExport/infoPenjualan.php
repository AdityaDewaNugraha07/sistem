...
}elseif($jenisproduk == 'FingerJointLamineBoard'){
    $Jenis = "'$jenisproduk'";
    $labelJenis = "FingerJointLamineBoard (FJLB)";
}elseif($jenisproduk == 'FingerJointStick'){
    $Jenis = "'$jenisproduk'";
    $labelJenis = "FingerJointStick (FJS)";
}elseif($jenisproduk == 'Flooring'){
    $Jenis = "'$jenisproduk'";
    $labelJenis = "Flooring";
}
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Info Pencapaian Export')." ".$labelJenis; ?></h4>
