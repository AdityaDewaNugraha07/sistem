    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Informasi Penerbit B/L'); ?></h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
						...
						<div class="form-group col-md-12">
                            <label class="col-md-5 control-label">Alamat Perusahaan</label>
                            <div class="col-md-7"><strong><?= $model->alamat ?></strong></div>
                        </div>
						<div class="form-group col-md-12">
            ...
            <div class="modal-footer">
                <?= yii\helpers\Html::button(Yii::t('app', 'Edit'),['class'=>'btn blue btn-outline','onclick'=>"openModal('".\yii\helpers\Url::toRoute(['/exim/penerbitbl/edit','id'=>$model->penerbit_bl_id])."','modal-master-edit')"]); ?>
                <?= yii\helpers\Html::button(Yii::t('app', 'Delete'),['class'=>'btn red btn-outline','onclick'=>"openModal('".\yii\helpers\Url::toRoute(['/exim/penerbitbl/delete','id'=>$model->penerbit_bl_id,'tableid'=>'table-penerbit'])."','modal-delete-record')"]); ?>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
