...
//								if(!empty($modAlias) && $model->jenis_produk == "Moulding"){
								if(!empty($modAlias)){
									if($model->jenis_produk == "Plywood" || $model->jenis_produk == "Lamineboard" || $model->jenis_produk == "Platform" || $model->jenis_produk == "FingerJointLamineBoard"){}
									else{
									echo '<tr style="border: solid 1px #000; border-right: solid 1px transparent; font-weight:600" class="text-align-center">';
...
//                                                                        $total_bundles = $detail->bundles_no;                                                                 
								...
								<tr style="border: solid 1px #000; border-right: solid 1px transparent;">
									...
									<td style="border-right: solid 1px #000; text-align: right; padding: 2px; padding-right: 5px;"><?= $detail->pcs ?></td>
								...
								<?php if((($i+1) == count($modDetails)) && (!empty($modAlias))){ ?>
									<?php if($model->jenis_produk == "Plywood" || $model->jenis_produk == "Lamineboard" || $model->jenis_produk == "Platform"){ }else{?>
					...
					<tr style="border-top: solid 1px #000; background-color: #F1F4F7;">
						...
						<td class="text-align-center" style="padding: 5px; padding-right: 5px; border-right: solid 1px #000; text-align: right;"><b><?= \app\components\DeltaFormatter::formatNumberForUserFloat($total_pcs) ?></b></td>
						<td class="text-align-center" style="padding: 5px; padding-right: 5px; text-align: right;"><b><?= ($_GET['caraprint'] == "EXCEL")? app\components\DeltaFormatter::formatNumberForUserFloat($total_volume) : number_format($total_volume,4); ?></b></td>
					</tr>
				<?php } ?>
			</table>
		</td>
...
<table style="width: 20cm; margin: 10px;" border:0;>
    <tr>
        <td style="font-size: 0.9rem; border: solid 1px transparent; vertical-align: top;text-align:right;">
                <span class="pull-right nomor-dokumen-qms" style="font-size: 0.8rem;">CWM-FK-EXM-05-0</span>
        </td>
    </tr>
</table>
