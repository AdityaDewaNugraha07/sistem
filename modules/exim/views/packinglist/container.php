				...
				<thead>
					...
					<tr style="background-color: #E3E7EA">
						<td colspan="<?= $colspan_header ?>" style="vertical-align: middle;">
							...
							<b>Container No : <?= yii\bootstrap\Html::textInput("TPackinglistContainer[".$model->container_no."][container_kode]",$model->container_kode,['class'=>'form-control','style'=>'width:150px; text-align:right; font-weight:600; display:inline; padding:2px; height: 26px; color:#3E66A6']) ?></b> &nbsp; &nbsp; &nbsp; &nbsp; 
							<b>Seal No : <?= yii\bootstrap\Html::textInput("TPackinglistContainer[".$model->container_no."][seal_no]",$model->seal_no,['class'=>'form-control','style'=>'width:150px; text-align:right; font-weight:600; display:inline; padding:2px; height: 26px; color:#3E66A6']) ?></b> &nbsp; &nbsp; &nbsp; &nbsp; 
