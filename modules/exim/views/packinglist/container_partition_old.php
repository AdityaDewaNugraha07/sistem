				...
				<thead>
					...
					<tr style="background-color: #E3E7EA">
						<td colspan="<?= $colspan_header ?>" style="vertical-align: middle;">
							<b>Container No : <?= yii\bootstrap\Html::textInput("container_no",(!empty($container_no)?$container_no:""),['class'=>'form-control','disabled'=>'disabled','style'=>'width:40px; text-align:center; font-weight:600; display:inline; padding:2px; height: 26px; color:#3E66A6']) ?></b> &nbsp; &nbsp; &nbsp; &nbsp; 
							<b>Container Code : <?= yii\bootstrap\Html::textInput("container_kode",(!empty($container_kode)?$container_kode:""),['class'=>'form-control','onblur'=>'setContainerDetails();','style'=>'width:150px; text-align:right; font-weight:600; display:inline; padding:2px; height: 26px; color:#3E66A6']) ?></b> &nbsp; &nbsp; &nbsp; &nbsp; 
							<b>Seal No : <?= yii\bootstrap\Html::textInput("seal_no",(!empty($seal_no)?$seal_no:""),['class'=>'form-control','onblur'=>'setContainerDetails();','style'=>'width:150px; text-align:right; font-weight:600; display:inline; padding:2px; height: 26px; color:#3E66A6']) ?></b> &nbsp; &nbsp; &nbsp; &nbsp; 
							...
							<tr>
								...
								foreach($params_thick as $ii => $thick){
									if(count($params_thick)>1){
										...
										echo '<td style="padding: 2px;">'. 
												\yii\bootstrap\Html::activeHiddenInput($model, '['.$i.']thick_satuan',['value'=>$params_thick_unit]) .
												\yii\bootstrap\Html::activeTextInput($model, '['.$i.']thick',['class'=>'form-control float font-purple ukuran-thick','disabled'=>'disabled','style'=>'text-align:center; height: 26px; padding:2px; font-size:1.2rem; font-weight: 600;','value'=>$thick]) 
											.'</td>';
									}
								}
								foreach($params_width as $ii => $width){
									if(count($params_width)>1){
										...
										echo '<td style="padding: 2px;">'. 
												\yii\bootstrap\Html::activeHiddenInput($model, '['.$i.']width_satuan',['value'=>$params_width_unit]) .
												\yii\bootstrap\Html::activeTextInput($model, '['.$i.']width',['class'=>'form-control float font-purple ukuran-width','disabled'=>'disabled','style'=>'text-align:center; height: 26px; padding:2px; font-size:1.2rem; font-weight: 600;','value'=>$width]) 
											.'</td>';
									}
								}
								foreach($params_length as $ii => $length){
									if(count($params_length)>1){
										...
										echo '<td style="padding: 2px;">'. 
												\yii\bootstrap\Html::activeHiddenInput($model, '['.$i.']length_satuan',['value'=>$params_length_unit]) .
												\yii\bootstrap\Html::activeTextInput($model, '['.$i.']length',['class'=>'form-control float font-purple ukuran-length','disabled'=>'disabled','style'=>'text-align:center; height: 26px; padding:2px; font-size:1.2rem; font-weight: 600;','value'=>$length]) 
											.'</td>';
									}
								}
								?>
