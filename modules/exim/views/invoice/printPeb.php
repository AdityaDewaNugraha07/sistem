...
<table style="width: 20cm; margin: 10px;" border="1">
    ...
    <tr>
        <td style="width: 50%; border-right: solid 1px #000;">
            <table style="width: 100%; " class="table-level2">
                ...
                <tr style="">
                    <td style="padding-left: 5px;">32. Jenis Valuta Asing</td>
                    <td style="">:</td>
                    <td style=""><?= $peb['peb_transaksiekspor_jenis_valuta'] ?> </td>
                </tr>
                <tr style="">
                    <td style="padding-left: 5px; ">33. FOB</td>
                    <td style="">:</td>
        ...
        <td style="width: 50%; border-right: solid 1px #000;">
            <table style="width: 100%; " class="table-level2">
                <tr style="">
                    ...
                    <td style="width: 0.2cm;">:</td>
                    <td style=""><?= $peb['peb_transaksiekspor_freight'] ?> </td>
                </tr>
                <tr style="">
        ...
        <td style="width: 50%;">
            <table style="width: 100%; " class="table-level2">
                <tr style="">
                    ...
                    <td style="padding-left: 5px;">48. Jumlah Nilai<br> &nbsp; &nbsp; &nbsp; FOB</td>
                    <td style="padding-left: 5px;">49. Jumlah Nilai<br> Freight</td>
                </tr>
                <?php foreach($peb as $i => $detail){ ?>
                <?php if(is_array($detail)){ ?>
                <tr style="border-top: solid 1px #000;">
    ...
    <tr>
        <td style="width: 50%; border-right: solid 1px #000;">
            <table style="width: 100%; " class="table-level2">
                <tr style="">
                    <td style="width: 3.8cm; padding-left: 5px;">50. Nilai tukar mata uang</td>
                    <td style="width: 0.2cm;">:</td>
        ...
        <td style="width: 50%; border-right: solid 1px #000;">
            <table style="width: 100%; " class="table-level2">
                <tr style="">
                    <td style="width: 3.8cm; padding-left: 5px;">51. Nilai Bea Keluar</td>
                    <td style="width: 0.2cm;">:</td>
                    <td style="text-align: right;"><?= $peb['peb_penerimaannegara_bea_keluar'] ?> </td>
                </tr>
                <tr style="">
                    <td style="width: 3.8cm; padding-left: 5px;">52. Penerimaan Pajak Lainnya</td>
                    <td style="width: 0.2cm;">:</td>
