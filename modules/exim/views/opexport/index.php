                                ...
                                <div class="row">
									<div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <?php if(isset($_GET['op_export_id']) && $model->cancel_transaksi_id == NULL): ?>
                                                    <a href="javascript:void(0);" onclick="cancelOpExport(<?= $model->op_export_id ?>);" class="btn red btn-sm"><i class="fa fa-minus-circle"></i> <?= Yii::t('app', 'Batalkan OP Export'); ?></a>
                                                <?php else: ?>
                                                    <?php if($model->cancel_transaksi_id != NULL): ?>
                                                        <p class="text-danger" style="font-style: italic; margin-top: 10px;">Telah dibatalkan dengan alasan: <span style="font-weight: bold; text-decoration: underline;"><?= $model->cancelTransaksi->cancel_reason ?></span></p>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                            </div>
                                        </div>
...
function cancelOpExport(op_export_id){
	openModal('<?php echo \yii\helpers\Url::toRoute(['/exim/opexport/cancelOpExport']) ?>?id='+op_export_id,'modal-transaksi');
}
</script>