		...
		<td colspan="3" style="padding: 0px;">
			<table style="width: 100%" id="table-detail">
				<tr style="border-bottom: solid 1px #000; border-top: solid 1px #000;">
					...
					<th style="padding: 10px; border: solid 1px #000;"><?= Yii::t('app', 'Jenis Sales') ?></th>
					<th style="padding: 10px; border: solid 1px #000;"><?= Yii::t('app', 'Nama') ?></th>
					<th style="padding: 10px; border: solid 1px #000;"><?= Yii::t('app', 'Phone') ?></th>
				...
				foreach ($model as $key) {
					$sales_kode = $key['sales_kode'];
					$sales_jns = $key['sales_jns'];
					$sales_nm = $key['sales_nm'];
					$sales_phone = $key['sales_phone'];
					$sales_tgl_join = $key['sales_tgl_join'];
					$active = $key['active'];
					$active == 1 ? $status='Active' : $status='Non-Active';
				?>
				<tr>
					<td style="padding: 3px; border: solid 1px #000;"><?= $sales_kode; ?></td>
					<td style="padding: 3px; border: solid 1px #000;"><?= $sales_jns; ?></td>
					<td style="padding: 3px; border: solid 1px #000;"><?= $sales_nm; ?></td>
					<td style="padding: 3px; border: solid 1px #000;"><?= $sales_phone; ?></td>
					<td style="padding: 3px; border: solid 1px #000; text-align: center;"><?= $sales_tgl_join; ?></td>
