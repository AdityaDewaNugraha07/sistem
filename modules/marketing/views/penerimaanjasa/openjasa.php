...
<div class="modal fade" id="modal-master-jasa" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn btn-icon-only btn-default fa fa-close" data-dismiss="modal" aria-hidden="true" style="float: right; padding-top: 2px; padding-bottom: 2px;"></button>
                <h4 class="modal-title"><?= Yii::t('app', 'Master Jasa'); ?></h4>
            </div>
                    ...
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered table-hover table-laporan" id="table-produk">
							<thead>
								<tr>
									<th></th>
									<th style="width: 200px;"><?= Yii::t('app', 'Jenis') ?></th>
									<th style="width: 150px;"><?= Yii::t('app', 'Kode') ?></th>
									<th><?= Yii::t('app', 'Nama') ?></th>
                                    <th style="width: 100px; line-height: 1"><?= Yii::t('app', 'Satuan<br>Jual') ?></th>
...
function dtProduk(){
    var dt_table =  $('#table-produk').dataTable({
        ajax: { url: '<?= \yii\helpers\Url::toRoute(['/marketing/penerimaanjasa/openjasa','jenis_produk'=>'']) ?><?= $jenis_produk ?>',data:{dt: 'table-produk'} },
        order: [
            [0, 'desc']
        ],
        columnDefs: [
