...
<tr>
    ...
    <td class="td-kecil" style="vertical-align: middle; width: 30px; height: 20px;">
		<?= \yii\helpers\Html::activeTextInput($modDetail, '[ii]nomor_palet', ['class'=>'form-control','style'=>'width:50px; line-height: 25px; font-size:1.3rem; padding:2px; height:25px; text-align:center','onchange'=>'setMeterKubikTerima(this)', 'title'=>'detail_qty_besar']); ?>
    </td>
    <td style="vertical-align: middle; width: 80px;" class="td-kecil">
    ...
    <td style="vertical-align: middle;" class="td-kecil">
		<?= \yii\helpers\Html::activeTextInput($modDetail, '[ii]qty_kecil', ['class'=>'form-control float detail_qty_kecil','style'=>'width:100%; font-size:1.3rem; padding:2px; height:30px; text-align:right;','onblur'=>'setMeterKubikTerima(this);', 'title'=>'detail_qty_kecil']); ?>
    </td>
    <td style="vertical-align: middle;" class="td-kecil">
    ...
    <td style="vertical-align: middle;" class="td-kecil">
		<?= \yii\helpers\Html::activeTextInput($modDetail, '[ii]qty_kecil_aktual', ['class'=>'form-control float detail_qty_kecil','style'=>'width:100%; font-size:1.3rem; padding:2px; height:30px; text-align:right;','onblur'=>'setMeterKubikTerima(this);', 'title'=>'detail qty aktual']); ?>
    </td>
    <td style="vertical-align: middle;" class="td-kecil">
		<?= \yii\helpers\Html::activeTextInput($modDetail, '[ii]kubikasi_aktual', ['class'=>'form-control float detail_kubikasi','style'=>'width:100%; font-size:1.3rem; padding:2px; height:30px; text-align:right','disabled'=>true, 'title'=>'detail kubikasi aktual']); ?>
    </td>
    <td style="vertical-align: middle;" class="td-kecil">
