<div class="modal fade zzz" id="modal-review" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header text-left"><b>REVIEW SCAN PEMUATAN GUDANG</b></div>
            <div class="modal-body text-center">
                ...
                <table style="margin-left: -5px;">
                    ...
                    <tr>
                        ...
                        <td> : </td>
                        <td style="padding-left: 10px;"><?php echo $modPersediaan->in_qty_palet;?></td>
                    </tr>
                    <tr>
                        <td style="width: 140px;">Qty Kecil</td>
                        <td> : </td>
                        <td style="padding-left: 10px;"><?php echo $modPersediaan->in_qty_kecil;?> <?php echo $modPersediaan->in_qty_kecil_satuan;?></td>
                    </tr>
                    <tr>
                        <td style="width: 140px;">Kubikasi</td>
                        <td> : </td>
                        <td style="padding-left: 10px;"><?php echo \app\components\DeltaFormatter::formatNumberForUser($modPersediaan->in_qty_m3,4);?> m<sup>3</sup></td>
                    </tr>
                    <tr>
                        <td colspan="3"><hr></td>
                    </tr>
...
function saveItem () {
    ...
    $.ajax({
        ...
        success: function (data) {
			if(data.status){
                window.location.href = "/cis3/web/marketing/spm/scanSpm?spm_ko_id="+spm_ko_id;
            }else {
                console.log(data)
            }
        },
