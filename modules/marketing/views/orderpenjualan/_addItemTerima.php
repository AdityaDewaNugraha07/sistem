...
<tr>
    ...
    <td class="td-kecil" style="vertical-align: middle; height: 20px;">
    ...
    <td class="td-kecil" style="vertical-align: middle; width: 50px; height: 20px;">
    ...
    <td style="vertical-align: middle;" class="td-kecil">
		<?= \yii\helpers\Html::activeTextInput($modDetail, '[ii]keterangan', ['class'=>'form-control','style'=>'width:100%; font-size:1.3rem; padding:2px; height:30px; text-align:right']); ?>
    </td>
