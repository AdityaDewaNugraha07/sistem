    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', "Master Limbah Pengajuan Tanggal " . \app\components\DeltaFormatter::formatDateTimeForUser($tanggal_penetapan)); ?></h4>
            </div>
...
function dtProduk(){
    var dt_table =  $('#table-produk').dataTable({
        ajax: { url: '<?= \yii\helpers\Url::toRoute(['/marketing/orderpenjualan/openlimbah','jenis_produk'=>'']) ?><?= $jenis_produk ?>',data:{dt: 'table-produk'} },
        order: [
            [0, 'desc']
        ],
        columnDefs: [
