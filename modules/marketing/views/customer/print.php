		...
		<td colspan="3" style="padding: 0px;">
			<table style="width: 100%" id="table-detail">
				<tr style="border-bottom: solid 1px #000; border-top: solid 1px #000;">
					...
					<th style="padding: 10px; border: solid 1px #000;"><?= Yii::t('app', 'NPWP') ?></th>
					<th style="padding: 10px; border: solid 1px #000;"><?= Yii::t('app', 'Tipe Penjualan') ?></th>
					<th style="padding: 10px; border: solid 1px #000;"><?= Yii::t('app', 'Tanggal Join'); ?></th>
					<th style="padding: 10px; border: solid 1px #000;"><?= Yii::t('app', 'Nama CP'); ?></th>
					<th style="padding: 10px; border: solid 1px #000;"><?= Yii::t('app', 'NIK'); ?></th>
					<th style="padding: 10px; border: solid 1px #000;"><?= Yii::t('app', 'Customer a/n. Alamat'); ?></th>
					<th style="padding: 10px; border: solid 1px #000; line-height: 1;"><?= Yii::t('app', 'Customer<br>Max<br>Plafon'); ?></th>
				</tr>
				
				<?php 
				foreach ($model as $key) {
					$cust_pr_nama = $key['cust_pr_nama'];
					$cust_kode = $key['cust_kode'];
					$cust_no_npwp = $key['cust_no_npwp'];
					$cust_tipe_penjualan = $key['cust_tipe_penjualan'];
					$cust_tanggal_join = $key['cust_tanggal_join'];
					$cust_an_nama = $key['cust_an_nama'];
					$cust_an_nik = $key['cust_an_nik'];
					$cust_an_alamat = $key['cust_an_alamat'];
					$cust_max_plafond = $key['cust_max_plafond'];
				?>
				<tr>
					<td style="padding: 3px; border: solid 1px #000;"><?= $cust_pr_nama; ?></td>
					<td style="padding: 3px; border: solid 1px #000;"><?= $cust_kode; ?></td>
					<td style="padding: 3px; border: solid 1px #000;"><?= $cust_no_npwp; ?></td>
					<td style="padding: 3px; border: solid 1px #000;"><?= $cust_tipe_penjualan; ?></td>
					<td style="padding: 3px; border: solid 1px #000;"><?= $cust_tanggal_join; ?></td>
					<td style="padding: 3px; border: solid 1px #000;"><?= $cust_an_nama; ?></td>
					<td style="padding: 3px; border: solid 1px #000;"><?= $cust_an_nik; ?></td>
					<td style="padding: 3px; border: solid 1px #000;"><?= $cust_an_alamat; ?></td>
					<td style="padding: 3px; border: solid 1px #000;"><?= $cust_max_plafond; ?></td>
				</tr>
				<?php } ?>
			</table>
		</td>
