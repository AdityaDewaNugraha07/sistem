        ...
        columnDefs: [
            ...
            {	targets: 7, 
                ...
                render: function ( data, type, full, meta ) {
                    ...
                    var par = full[2].replace("'", "xyz");
                    if(full[3]){
                        par = full[2].replace("'", "xyz") + ' - ' + full[3].replace("'", "xyz");
                    }
                    return "<center><a onclick='pick(\""+full[0]+"\",\""+par+"\")' class='btn btn-xs btn-icon-only btn-default' data-original-title='Pick' style='width: 25px; height: 25px;'><i class='fa fa-plus-circle'></i></a><center>";
                }
            },
        ],
