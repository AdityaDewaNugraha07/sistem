<div class="modal fade draggable-modal" id="modal-delete-record" tabindex="-1" role="basic" aria-hidden="true">
...
function deleteRecord(){
	$.ajax({
		url    : '<?= \yii\helpers\Url::toRoute([(isset($actionname)?$actionname:'delete'),'jp'=>$jp,'tp'=>$tp,'kode'=>$kode]); ?>',
		type   : 'POST',
