				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							...
							<?= $form->field($model, 'jenis_produk')->dropDownList(\app\models\MDefaultValue::getOptionList("jenis-produk"),['prompt'=>'All','onchange'=>'setFilterByProdukGroup()'])->label(Yii::t('app', 'Jenis Produk')); ?>
							...
							<?= $form->field($model, 'produk_dimensi')->dropDownList(\app\models\MBrgProduk::getOptionListDimensi(),['class'=>'form-control select2','prompt'=>'','multiple'=>'multiple'])?>
						</div>
						<div class="col-md-5">
							<?= $form->field($model, 'cust_id')->dropDownList(\app\models\MCustomer::getOptionList(),['prompt'=>''])->label('Customer'); ?>
                            <?= $form->field($model, 'sales_id')->dropDownList(\app\models\MSales::getOptionListAll(),['prompt'=>'All'])->label("Sales"); ?>
						</div>
					</div>
