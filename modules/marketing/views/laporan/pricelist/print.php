					...
					<td colspan="2">
						<table style="width: 100%; border: solid 1px;" id="table-detail">
							<tr style="border-bottom: solid 1px #000; border-top: solid 1px #000;">
								<th style="width: 200px; text-align: center;  padding: 10px; border-right: solid 1px #000;">Produk Nama</th>
								<th style="width: 150px; text-align: center;  padding: 10px; border-right: solid 1px #000;">Kode</th>
								<th style="width: 150px; text-align: center;  padding: 10px; border-right: solid 1px #000;">Dimensi</th>
								<th style="width: 50px; text-align: center;  padding: 10px; border-right: solid 1px #000;">Harga</th>
							</tr>
							<?php
							...
							<tr>
								...
								<td style="padding: 2px 5px; border-right: solid 1px #000; line-height: 20px; text-align: right;"><?php echo $harga_enduser;?></td>
							</tr>
							<?php
							}
							?>
