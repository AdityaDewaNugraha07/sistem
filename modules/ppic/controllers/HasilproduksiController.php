...
//                        exit;
    ...
    public function actionPengajuancetakulang(){
        if(\Yii::$app->request->isAjax){
            ...
            $model->approver1 = \app\components\Params::DEFAULT_PEGAWAI_ID_NAFIS; //DEFAULT_PEGAWAI_ID_ILHAM; //DEFAULT_PEGAWAI_ID_PRANOTO; //DEFAULT_PEGAWAI_ID_NADLIM;
...
//                    exit;
    ...
    public function actionModalproduk(){
        ...
        return $this->renderPartial('modalProduk');
    }
