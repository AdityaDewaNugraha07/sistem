...
class MonitoringrepairController extends DeltaBaseController
{
    ...
    public function actionInput()
    {
        ...
        $model->kategori_proses = MMtrgSetup::KATEGORI_REPAIR;
            ...
            try {
                ...
                $model->attributes = $request;
                 ...
                 if(isset($request['mtrg_in_out_id'])) {
                    ...
                    $model->kode = DeltaGenerator::kodeMonitoringInOut(MMtrgSetup::KATEGORI_REPAIR);
                }
                ...
                // setup
                $setups = MMtrgSetup::findAll(['kategori_proses' => MMtrgSetup::KATEGORI_REPAIR, 'tanggal' => MMtrgSetup::getActiveDate()]);
                ...
                if($setups < 1) {
                    $last_setup_date = MMtrgSetup::find()->where(['kategori_proses' => MMtrgSetup::KATEGORI_REPAIR])->orderBy(['tanggal' => SORT_DESC])->one();
                    if($last_setup_date !== null) {
                        $last_setup = MMtrgSetup::findAll(['kategori_proses' => MMtrgSetup::KATEGORI_REPAIR, 'tanggal' => $last_setup_date->tanggal]);
                        ...
                        throw new Exception("Belum pernah ada setup up yang dibuat. <br>Mohon buat setup REPAIR untuk pertama kalinya");
                    }
                }
                // end setup
    ...
    public function actionModalhistory($type = null)
    {
        if(Yii::$app->request->isPost) {
            ...
            $param['where'] = "status_in_out = '{$_POST['type']}' AND kategori_proses = 'REPAIR'";
        ...
        if (Yii::$app->request->isPost) {
            ...
            try {
                ...
                if(isset($request['mtrg_in_out_id'])) {
                    ...
                    $model->kode = DeltaGenerator::kodeMonitoringInOut('REPAIR');
                }
                ...
                foreach (Yii::$app->request->post('details') as $detail) {
                    ...
                    $prev_output = MMtrgSetup::findOne([
                        'tanggal' => MMtrgSetup::getActiveDate(),
                        'kategori_proses' => MMtrgSetup::KATEGORI_REPAIR,
                        'jenis_kayu' => $model->jenis_kayu,
                        'grade' => $detail['grade'], //'Output', //
                        'jenis_proses' => MMtrgSetup::OUTPUT
                    ]);
