...
class GlueController extends DeltaBaseController
{
	...
	public function actionIndex(){
        if(\Yii::$app->request->get('dt')=='table-master'){
			$param['table']= \app\models\MGlue::tableName();
			$param['pk']= \app\models\MGlue::primaryKey()[0];
			$param['column'] = ['glue_id','jenis_produk','kode','nama','othername',$param['table'].'.active'];
	...
	public function actionCreate(){
		if(\Yii::$app->request->isAjax){
			$model = new \app\models\MGlue();
			$model->active = true;
			if( Yii::$app->request->post('MGlue')){
    ...
    public function actionInfo($id){
		if(\Yii::$app->request->isAjax){
			$model = \app\models\MGlue::findOne($id);
