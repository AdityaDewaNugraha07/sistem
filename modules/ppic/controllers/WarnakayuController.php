...
class WarnakayuController extends DeltaBaseController
{
	...
	public function actionIndex(){
        if(\Yii::$app->request->get('dt')=='table-master'){
			$param['table']= \app\models\MWarnaKayu::tableName();
			$param['pk']= \app\models\MWarnaKayu::primaryKey()[0];
			$param['column'] = ['warna_kayu_id','jenis_produk','kode','nama','othername',$param['table'].'.active'];
	...
	public function actionCreate(){
		if(\Yii::$app->request->isAjax){
			$model = new \app\models\MWarnaKayu();
			$model->active = true;
			if( Yii::$app->request->post('MWarnaKayu')){
    ...
    public function actionInfo($id){
		if(\Yii::$app->request->isAjax){
			$model = \app\models\MWarnaKayu::findOne($id);
