...
class MonitoringcorebuilderController extends DeltaBaseController
{
    ...
    public function actionModalhistory($type = null)
    {
        if(Yii::$app->request->isPost) {
            ...
            $param['pk']        = "t_mtrg_in_out.mtrg_in_out_id";
            $param['column']    = [
                't_mtrg_in_out.mtrg_in_out_id',
                [
                    'col_name'  => 't_mtrg_in_out.tanggal_kupas',
                    'formatter' => 'formatDateTimeForUser'
                ],
                [
                    'col_name'  => 't_mtrg_in_out.tanggal_produksi',
                    'formatter' => 'formatDateTimeForUser'
                ],
                't_mtrg_in_out.kode',
                't_mtrg_in_out.shift',
            ...
            $param['where'] = "status_in_out = '{$_POST['type']}' AND kategori_proses = '". MMtrgSetup::KATEGORI_CORE_BUILDER ."'";
            // if($_POST['type'] === 'OUTPUT') {
            //     $param['group'] = "GROUP BY t_mtrg_in_out.mtrg_in_out_id, t_mtrg_in_out.kode, substr( t_mtrg_in_out_detail.grade, 1, POSITION ( ' ' IN t_mtrg_in_out_detail.grade ) ) ";
            // }
    ...
    public function actionInput()
    {
        ...
        $model->kategori_proses = MMtrgSetup::KATEGORI_CORE_BUILDER;
            ...
            try {
                ...
                $model->attributes = $request;
                 ...
                 if(isset($request['mtrg_in_out_id'])) {
                    ...
                    $model->kode = DeltaGenerator::kodeMonitoringInOut(MMtrgSetup::KATEGORI_CORE_BUILDER);
                }
                ...
                // ];
                // kebijakan per tanggal 06/04/02024 approval hanya level 1 saja
                $approvers = [
                    ['assigned_to' => $model->diperiksa, 'level' => 1, 'status' => TApproval::STATUS_NOT_CONFIRMATED, 'tanggal_approve' => null, 'reason' => '']
                ];
                ...
                // setup
                $setups = MMtrgSetup::findAll(['kategori_proses' => MMtrgSetup::KATEGORI_CORE_BUILDER, 'tanggal' => MMtrgSetup::getActiveDate()]);
                ...
                if(count($setups) < 1) {
                    $last_setup_date = MMtrgSetup::find()->where(['kategori_proses' => MMtrgSetup::KATEGORI_CORE_BUILDER])->orderBy(['tanggal' => SORT_DESC])->one();
                    if($last_setup_date !== null) {
                        $last_setup = MMtrgSetup::findAll(['kategori_proses' => MMtrgSetup::KATEGORI_CORE_BUILDER, 'tanggal' => $last_setup_date->tanggal]);
                        ...
                        throw new Exception("Belum pernah ada setup up yang dibuat. <br>Mohon buat setup CORE BUILDER untuk pertama kalinya");
                    }
                }
                // end setup
                ...
                foreach (Yii::$app->request->post('details') as $detail) {
                    ...
                    $prev_setup = MMtrgSetup::findOne([
                        ...
                        'kategori_proses' => MMtrgSetup::KATEGORI_CORE_BUILDER,
        ...
        if (Yii::$app->request->isPost) {
            ...
            try {
                ...
                if(isset($request['mtrg_in_out_id'])) {
                    ...
                    $model->kode = DeltaGenerator::kodeMonitoringInOut('CORE BUILDER');
                }
                ...
                if($setups < 1) {
                    ...
                    if($last_setup_date !== null) {
                        ...
                        throw new Exception("Belum pernah ada setup up yang dibuat. <br>Mohon buat setup CORE BUIILDER untuk pertama kalinya");
                    }
                }
                // end setup
