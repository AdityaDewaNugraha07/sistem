    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header text-left">
                <b>INPUT PENERIMAAN LOG KEMBALI</b>
            </div>
...
function kirim() {
    ...
    $('#loader').show();
    $.ajax({
        url: '<?= Url::toRoute(['/ppic/scanterimalogkembali/inputManuals']); ?>',
        type: 'POST',
        data: {
            clause: $('#clause').val(),
            keyword: $('#keyword').val(),
...
function showDetail(datas, no_barcode) {
    ...
    $.ajax({
        url: '<?= Url::toRoute(['/ppic/scanterimalogkembali/showDetail']); ?>',
        type: 'POST',
        data: {
        ...
        success: function(data) {
            if (data) {
                if (data['msg'] == "Data ok") {
                    var url = "<?= yii\helpers\Url::toRoute("/ppic/scanterimalogkembali/review") ?>?no_barcode="+no_barcode+"&id="+data.pengembalian_log_detail_id;
