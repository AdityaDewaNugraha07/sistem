<div class="modal fade draggable-modal" id="modal-kayu-create" tabindex="-1" role="basic" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <?php echo \yii\helpers\Html::button( Yii::t('app', 'Save'),['class'=>'btn hijau btn-outline ciptana-spin-btn',
                    'onclick'=>'submitformajax(this,"$(\'#modal-kayu-create\').modal(\'hide\'); $(\'#table-kayu\').dataTable().fnClearTable();")'
                    ]);
                        ?>
            </div>
