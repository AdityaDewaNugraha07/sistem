...
<?php $this->registerJs(" 
    ...
    if(navigator.mediaDevices) {
        ...
        alert('Protokol tidak didukung untuk scanning, pastikan anda menggunakan protokol https')
    }
...
<script>
    function setKirim() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('select[name*=\"[diserahkan]\"]').prop('disabled', true);
            },
    ...
    function pick(prod_number) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                kirim_gudang_id: kirim_gudang_id,
