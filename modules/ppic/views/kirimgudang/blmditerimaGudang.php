...
function params() {
    return {
        ajax: { 
            url: '<?= \yii\helpers\Url::toRoute('/ppic/kirimgudang/BlmditerimaGudang') ?>',
            data: {
                dt : 'table-informasi',
...
function printout(caraPrint){
	window.open("<?= yii\helpers\Url::toRoute('/ppic/kirimgudang/BlmditerimaGudangPrint') ?>?"+$('#form-search-laporan').serialize()+"&caraprint="+caraPrint,"",'location=_new, width=1200px, scrollbars=yes');
}
</script>