                    ...
                    <tr>
                        ...
                        <td style="padding-left: 10px; vertical-align: top;">
                            ...
                            if ($peruntukan == "Industri") {
                                $pegawai_id = $modPabrik->pic_terima;
                                $pegawai_id = Yii::$app->db->createCommand("select pegawai_id from m_user where pegawai_id = ".$pegawai_id."")->queryScalar();
                            } else {
                                $user_id = $modDetail->created_by;
