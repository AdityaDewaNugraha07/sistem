    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Riwayat Input Drying') ?></h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <table class="table table-bordered table-hover" id="table-history-drying" style="width: 100%">
                            <thead>
                            <tr>
                                <th>No</th>
...
<script>
    $(document).ready(function () {
        $('#table-history-drying').DataTable({
            ajax: {
                url: '<?= Url::toRoute('/ppic/monitoringdrying/modalhistoryoutput')?>',
                type: 'POST',
                data: {type: '<?= $type ?>'}
            },
            columns: [
