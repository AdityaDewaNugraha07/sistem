...
?>
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"> <?php echo Yii::t('app', 'Afkir Log Sengon/Jabon'); ?></h1>
<!-- END PAGE TITLE -->
<!-- END PAGE HEADER -->
...
function dtLaporan(){
    var dt_table =  $('#table-laporan').dataTable({
        ...
        columnDefs: [
            ...
            {	targets: 14, class: "td-kecil text-align-center", searchable:false,
				render: function ( data, type, full, meta ) {
					var display = "";
					var ret =  '<center>\n\
                                    <a style="" class="btn btn-xs blue-hoki btn-outline" data-original-title="Lihat Afkir" onclick="info('+full[0]+')"><i class="fa fa-info-circle"></i></a>\n\
								<center>';
					return ret;
				}
			},
...
function info(id){
	openModal('<?= \yii\helpers\Url::toRoute(['/ppic/terimasengon/info','id'=>'']) ?>'+id,'modal-afkirsengon-info');
}
