    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Tambah Afkir Sengon/Jabon'); ?></h4>
            </div>
                        ...
                        <div class="form-group" style="margin-bottom: 5px;">
                            ...
                            <div class="col-md-8">
                                <span class="input-group-btn" style="width: 90%">
                                    <?= \yii\bootstrap\Html::activeTextInput($model, "terima_kode", ['class'=>'form-control','disabled'=>true,'placeholder'=>'Cari Penerimaan Sengon/Jabon','style'=>'width:100%']); ?>
                                </span>
