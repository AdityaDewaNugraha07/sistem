...
<table class="table table-striped table-bordered table-hover" id="table-laporan">
    <thead>
        ...
        <tr>
            ...
            <th style="line-height: 1; width: 60px; font-size: 1.2rem;">15-24</th>
            <th style="line-height: 1; width: 60px; font-size: 1.2rem;">25-29</th>
            <th style="line-height: 1; width: 60px; font-size: 1.2rem;">30-40</th>
            <th style="line-height: 1; width: 60px; font-size: 1.2rem;">40 UP</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            // 100 cm
            $sql = "SELECT SUM(qty_m3) AS m3, sum(qty_pcs) AS pcs FROM t_terima_sengon_detail WHERE terima_sengon_id = ".$mod['terima_sengon_id']." AND panjang = 100 AND diameter >= 15 and diameter <= 24";
            ...
            $sql = "SELECT SUM(qty_m3) AS m3, sum(qty_pcs) AS pcs FROM t_terima_sengon_detail WHERE terima_sengon_id = ".$mod['terima_sengon_id']." AND panjang = 100 AND diameter > 40";
            $dia_100_30_40UP = Yii::$app->db->createCommand($sql)->queryOne();
            $total_pcs_100 = $dia_100_19_24['pcs'] + $dia_100_25_29['pcs'] + $dia_100_30_40['pcs'] + $dia_100_30_40UP['pcs'];
            $total_m3_100 = $dia_100_19_24['m3'] + $dia_100_25_29['m3'] + $dia_100_30_40['m3']+ $dia_100_30_40UP['m3'];
            ...
            echo '<td style="text-align: right; padding-right: 5px; font-size: 1.1rem;">'.(( $dia_100_30_40UP['m3']!=0 )? number_format($dia_100_30_40UP['m3'],3):"-").'</td>';
            ...
            // 130 cm
            $sql = "SELECT SUM(qty_m3) AS m3, sum(qty_pcs) AS pcs FROM t_terima_sengon_detail WHERE terima_sengon_id = ".$mod['terima_sengon_id']." AND panjang = 130 AND diameter >= 15 and diameter <= 24";
            ...
            $sql = "SELECT SUM(qty_m3) AS m3, sum(qty_pcs) AS pcs FROM t_terima_sengon_detail WHERE terima_sengon_id = ".$mod['terima_sengon_id']." AND panjang = 130 AND diameter > 40";
            $dia_130_30_40UP = Yii::$app->db->createCommand($sql)->queryOne();
            $total_pcs_130 = $dia_130_19_24['pcs'] + $dia_130_25_29['pcs'] + $dia_130_30_40['pcs'] + $dia_130_30_40UP['pcs'];
            $total_m3_130 = $dia_130_19_24['m3'] + $dia_130_25_29['m3'] + $dia_130_30_40['m3'] + $dia_130_30_40UP['m3'];
            ...
            echo '<td style="text-align: right; padding-right: 5px; font-size: 1.1rem;">'.(( $dia_130_30_40UP['m3']!=0 )? number_format($dia_130_30_40UP['m3'],3):"-").'</td>';
            ...
            // 200 cm
            $sql = "SELECT SUM(qty_m3) AS m3, sum(qty_pcs) AS pcs FROM t_terima_sengon_detail WHERE terima_sengon_id = ".$mod['terima_sengon_id']." AND panjang = 200 AND diameter >= 15 and diameter <= 24";
            ...
            $sql = "SELECT SUM(qty_m3) AS m3, sum(qty_pcs) AS pcs FROM t_terima_sengon_detail WHERE terima_sengon_id = ".$mod['terima_sengon_id']." AND panjang = 200 AND diameter > 40";
            $dia_200_30_40UP = Yii::$app->db->createCommand($sql)->queryOne();
            ...
            echo '<td style="text-align: right; padding-right: 5px; font-size: 1.1rem;">'.(( $dia_200_30_40UP['m3']!=0 )? number_format($dia_200_30_40UP['m3'],3):"-").'</td>';
            ...
            // 260 cm
            $sql = "SELECT SUM(qty_m3) AS m3, sum(qty_pcs) AS pcs FROM t_terima_sengon_detail WHERE terima_sengon_id = ".$mod['terima_sengon_id']." AND panjang = 260 AND diameter >= 15 and diameter <= 24";
            ...
            $sql = "SELECT SUM(qty_m3) AS m3, sum(qty_pcs) AS pcs FROM t_terima_sengon_detail WHERE terima_sengon_id = ".$mod['terima_sengon_id']." AND panjang = 260 AND diameter > 40";
            $dia_260_30_40UP = Yii::$app->db->createCommand($sql)->queryOne();
            $total_pcs_260 = $dia_260_19_24['pcs'] + $dia_260_25_29['pcs'] + $dia_260_30_40['pcs'] + $dia_260_30_40UP['pcs'];
            $total_m3_260 = $dia_260_19_24['m3'] + $dia_260_25_29['m3'] + $dia_260_30_40['m3'] + $dia_260_30_40UP['m3'];
            ...
            echo '<td style="text-align: right; padding-right: 5px; font-size: 1.1rem;">'.(( $dia_260_30_40UP['m3']!=0 )? number_format($dia_260_30_40UP['m3'],3):"-").'</td>';
