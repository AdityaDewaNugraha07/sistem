    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Detail Scanned Log Hasil Potong'); ?></h4>
            </div>
            <div class="modal-body">
                <!-- DATA PEMOTONGAN -->
                <table>
                    <tr>
                        <th colspan="3">Pemotongan Log</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width: 170px;">Peruntukan</td>
                        <td style="width: 10px; text-align: left;">:</td>
                        <td><?php echo $model->peruntukan;?></td>
                    </tr>
                    <tr>
                        <td style="width: 170px;">Nomor</td>
                        <td style="width: 10px; text-align: left;">:</td>
                        <td><?php echo $model->nomor;?></td>
                    </tr>
                    <tr>
                        <td style="width: 170px;">Petugas Pemotongan</td>
                        <td style="width: 10px; text-align: left;">:</td>
                        <td>
                            <?php 
                            $modPetugas = app\models\MPegawai::findOne($model->petugas);
                            echo $modPetugas->pegawai_nama;
                            ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 10px; text-align: left;">:</td>
                        <td><?php echo $model->keterangan?$model->keterangan:'-';?></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <?php 
                            $modPegawai = app\models\MPegawai::findOne($modDetailPot->penerima);
                    ...
                    <tr>
                        <?php 
                        $tanggal_jam = explode(" ", $modDetailPot->tanggal_penerimaan);
                    ...
                    <tr>
                        ...
                        <td style="width: 10px; text-align: left;">:</td>
                        <td><?php echo ($modDetailPot->catatan_penerimaan)?$modDetailPot->catatan_penerimaan:'-';?></td>
                    </tr>
                </table>
                <hr>
                <!-- DATA LOG POTONG -->
                ...
                <table>
                    <tr>
                        <th colspan="3">Data Log dari Pemotongan Log</th>
                    </tr>
                    <tr>
