...
<div style="width: 77mm;height: 68mm; border: .5mm solid black;margin: 3mm 1mm; padding: 1mm;">
    <div style="display: flex;justify-content: space-between;">
        ...
        <div style="height: 33mm">
            <div class="place-qrcode" data-text="<?= "ID : $detail->terima_logalam_detail_id\nNo : $detail->no_barcode"?>" style="margin-top: 4mm;margin-right: 1mm"></div>
        </div>
        <div style="height: 33mm;">
            <div class="place-qrcodek" data-text="<?= "ID : $detail->terima_logalam_detail_id\nNo : $detail->no_barcode"?>" style="margin-top: 2mm;margin-left: 1mm"></div>
        </div>
    ...
    <div style="display: flex; width: 100%;border: .5mm solid black;height: 8mm;font-weight: 600; border-bottom: none;">
        <div style="border-right: .5mm solid black; display: flex; align-items: center;padding: 0 1mm;width: 100%;justify-content: center; position: relative">
            ...
            <span style="margin-top: 10px; margin-left: 30px;"><?= $detail->no_produksi;?></span>
        </div>
        <div style="display: flex; align-items: center;padding: 0 1mm;width: 100%;justify-content: center; position: relative;">
            ...
            <span style="margin-top: 10px; margin-left: 30px;"><?= $detail->no_btg;?></span>
        </div>
    </div>
    <div style="display: flex; width: 100%;border: .5mm solid black;height: 8mm;font-weight: 600;">
        <div style="border-right: .5mm solid black; display: flex; align-items: center;padding: 0 1mm;width: 100%;justify-content: center; position: relative;">
            ...
            <span style="margin-top: 10px; margin-left: 30px;"><?= $detail->no_grade;?></span>
        </div>
        <div style="display: flex; align-items: center;padding: 0 1mm;width: 100%;justify-content: center; position: relative;">
            ...
            <span style="margin-top: 10px; margin-left: 30px;"><?= $detail->no_lap;?></span>
        </div>
    </div>
</div>
<?php 
endforeach;
$this->registerJsFile($this->theme->baseUrl."/global/plugins/jquery.qrcode.min.js",['depends' => [YiiAsset::class]]);
$this->registerJs("init()");
?>

<script>
    function init() {
        $('.place-qrcode').each(function(i, e) {
            $(this).qrcode({
                fill: '#666',
                width: 90,
                height: 90,
        ...
        $('.place-qrcodek').each(function(i, e) {
            $(this).qrcode({
                fill: '#666',
                width: 110,
                height: 110,
