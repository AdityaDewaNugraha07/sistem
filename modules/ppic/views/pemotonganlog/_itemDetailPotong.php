<tr style="background: #e9ecef;" data-status="false">
    <td colspan="4" style="font-weight: bold; font-size: 14px; padding: 6px;">
        ...
        <span style="font-size: 1.2rem; width: 50px; padding: 2px; vertical-align: middle;">(dalam satuan cm)</span>
    </td>
</tr>
<tr>
...
<tr>
    <td style="font-size: 1.2rem; width: 50px; padding: 2px; vertical-align: middle;">Panjang</td>
    <td style="vertical-align: middle; padding: 2px;">
        <?php 
...
<tr>
    ...
    <td style="font-size: 1.2rem; width: 50px; padding: 2px; vertical-align: middle;">Volume (m<sup>3</sup>)</td>
    <td style="vertical-align: middle; padding: 2px;">
        <?php 
