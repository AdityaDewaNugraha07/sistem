                    ...
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered table-hover" id="table-aftersave">
							<thead>
								<tr>
									<th></th>
									<th style="line-height: 1;"><?= Yii::t('app', 'Kode<br>Pemotongan'); ?></th>
									<th style="line-height: 1;"><?= Yii::t('app', 'Nomor'); ?></th>
									<th style="line-height: 1;"><?= Yii::t('app', 'Tanggal'); ?></th>
									<th style="line-height: 1;"><?= Yii::t('app', 'Petugas'); ?></th>
...
function dtAfterSave(){
    var dt_table =  $('#table-aftersave').dataTable({
        ...
        columnDefs: [
            ...
            {	targets: 7, 
                render: function ( data, type, full, meta ) {
                    var tgl_dibuat = new Date(full[3]);
                    var now = new Date();

                    var batasEdit = new Date(tgl_dibuat);
                    batasEdit.setDate(batasEdit.getDate() + 2); // h+2 sudah tidak bisa edit
