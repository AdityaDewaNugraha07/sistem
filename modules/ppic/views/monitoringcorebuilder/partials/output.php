...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption">
            ...
            <span class="caption-subject hijau bold"><?= Yii::t('app', 'Output Core Builder') ?></span>
        </div>
        <div class="tools">
            ...
            <a href="javascript:void(0);" 
                class="btn btn-default btn-sm btn-show-history"
                style="font-family: FontAwesome; height: unset"
                onclick="openModal('<?= Url::toRoute('/ppic/monitoringcorebuilder/modalhistory') ?>?type=OUTPUT','modal-history', '80%');"
    ...
    <div class="portlet-body">
        <div class="row">
            <div class="col-md-6 col-lg-6 col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" id="tanggal" class="form-control" name="tanggal" value="<?= date('d/m/Y') ?>"
                            readonly="readonly">
        ...
        <div class="row margin-top-20">
            <div class="col-md-12 col-sm-12 col-lg-12">
                <button type="button" class="btn btn-sm yellow-mint margin-bottom-10" id="btn-add-item" onclick="openModal('<?= Url::toRoute('/ppic/monitoringcorebuilder/modaloutputdetail') ?>', 'modal-output-detail', null);">
                    <i class="fa fa-plus"></i> Tambah Item
                </button>
                <table class="table table-bordered table-hover table-desktop"
                    id="table-output-core-builder-detail-desktop">
                    <thead>
                        <tr>
                ...
                <table class="table table-bordered table-hover table-mobile"
                    id="table-output-core-builder-detail-mobile" style="width: 100%;">
                    <thead>
                        <tr class="cis-mobile">
...
function init() {
    ...
    const detail = new mtrg.Detail('core-builder');
    const storage = mtrg.storage('output-core-builder-details');
    storage.clear();

    detail.renderDetail();
    $('#form-output-core-builder').on('beforeSubmit', function() {
        if (storage.get().length > 0) {
            ...
            $.post("<?= Url::toRoute('/ppic/monitoringcorebuilder/output') ?>", data)
        ...
        $.ajax({
            ...
            success: function({
                ...
                if (master['status_approval'] === '<?= TApproval::STATUS_REJECTED ?>') {
                    $('.btn-koreksi').show();
                    $('#form-output-core-builder').append(
