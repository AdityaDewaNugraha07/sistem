    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Update Detail Core Builder') ?></h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        ...
                        echo $form->field($modDetail, 'grade')->dropDownList(MDefaultValue::getOptionList('mtrg-grade-core-builder-input'));
    ...
    $('#form-input-detail').on('beforeSubmit', function () {
        $.ajax({
            ...
            success: function(res) {
                mtrg.storage('input-core-builder-details').update(res);
