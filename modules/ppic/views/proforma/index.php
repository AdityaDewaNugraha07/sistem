                ...
                <div class="row" style="margin-top: -10px; margin-bottom: 10px;">
					<span class="pull-right">
						<a class="btn blue btn-sm btn-outline" onclick="daftarAfterSave()"><i
                                    class="fa fa-list"></i> <?= Yii::t('app', 'Proforma Yang Telah Dibuat'); ?></a>
					</span>
                </div>
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <span class="input-group-btn" style="width: 25%">
														<a class="btn btn-icon-only btn-default tooltips"
                                                           onclick="masterOpex();" data-original-title="Pick OP"
                                        ...
                                        <table style="width: 100%;" id="table-op_export">
                                            <tr>
                                                <td class="col-md-4 control-label" style="padding: 2px;">Shipment Time
                                                    :
                                                </td>
                                                <td class="col-md-8" id="place-shipment_time"
                                                    style="padding: 2px 15px;">-
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="col-md-4 control-label"
                                                    style="padding: 2px;"><?= $modOpEx->attributeLabels()['shipment_to'] ?>
                                                    :
                                                </td>
                                                <td class="col-md-8" id="place-buyer" style="padding: 2px 15px;">-</td>
                                            </tr>
                                            <tr style="display: none;">
                                                <td class="col-md-4 control-label" style="padding: 2px;">Applicant :
                                                </td>
                                                <td class="col-md-8" id="place-applicant" style="padding: 2px 15px;">-
                                                </td>
                                            </tr>
                                            <tr style="display: none;">
                                                <td class="col-md-4 control-label" style="padding: 2px;">Notify Party
                                                    :
                                                </td>
                                            ...
                                            <tr>
                                                <td class="col-md-4 control-label" style="padding: 2px;">Final
                                                    Destination :
                                                </td>
                                                <td class="col-md-8" id="place-final_destination"
                                                    style="padding: 2px 15px;"></td>
                                            </tr>
                                            <tr>
                                                <td class="col-md-4 control-label" style="padding: 2px;">Goods
                                                    Description :
                                                </td>
                                                <td class="col-md-8" id="place-buyer" style="padding: 2px 15px;"></td>
                                            </tr>
                                        ...
                                        <div id="place-approval">
                                            <?php if(isset($_GET['packinglist_id'])) {
                                                foreach (Json::decode($model->reason_approval, false) as $approval): ?>
                                                    <div class="btn btn-outline <?= $approval->status === 'APPROVED' ? 'green-meadow' : (in_array($approval->status, ['ABORTED', 'REJECTED']) ? 'red-flamingo' : 'dark') ?> "
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7" style="padding-bottom: 5px; width: 40%;">
                                                ...
                                                <span class="input-group-addon"
                                                      style="padding-left: 5px; padding-right: 5px;">M<sup>3</sup> &nbsp;&nbsp;</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7" style="padding-bottom: 5px; width: 40%;">
                                                ...
                                                <span class="input-group-addon"
                                                      style="padding-left: 5px; padding-right: 5px;">Kg(s)</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <?= $form->field($model, 'diperiksa')->dropDownList(MPegawai::getOptionListPemeriksaProformaPackinglist(), ['class' => 'form-control select2', 'prompt' => '', 'data-placeholder' => 'Ketik Nama Pemeriksa']); ?>
                                        <?= $form->field($model, 'disetujui')->dropDownList(MPegawai::getOptionListAtasan(), ['class' => 'form-control select2', 'prompt' => '', 'data-placeholder' => 'Ketik Nama Pegawai']); ?>
                                        <?= $form->field($model, 'mengetahui')->dropDownList(MPegawai::getOptionListAtasan(), ['class' => 'form-control select2', 'prompt' => '', 'data-placeholder' => 'Ketik Nama Pegawai']); ?>
                        ...
                        <div class="portlet light bordered" style="margin-top: -15px;">
                            ...
                            <br>
                            <a class="addContainer btn btn-sm blue-steel" id="btn-addcontainer" disabled="disabled"><i
                                        class="fa fa-plus"></i> Add Container</a>
                        </div>
                        <div class="form-actions pull-right">
                            <div class="col-md-12 right">
                                <?php
//                                $options = ['id' => 'btn-save', 'class' => 'btn hijau btn-outline ciptana-spin-btn', 'onclick' => 'save();'];
//                                if(isset($_GET['packinglist_id']) && !isset($_GET['revisi'])) {
//                                    $options['disabled'] = 'disabled';
//                                }
                                ?>
                                <?= Html::button(Yii::t('app', 'Save'), ['id' => 'btn-save', 'class' => 'btn hijau btn-outline ciptana-spin-btn', 'onclick' => 'save();']) ?>
                                <?= Html::button(Yii::t('app', 'Print'), ['id' => 'btn-print', 'class' => 'btn blue btn-outline ciptana-spin-btn', 'disabled' => 'disabled', 'onclick' => 'printout(' . $model->packinglist_id . ',"PRINT")']) ?>
                                <?= Html::button(Yii::t('app', 'Reset'), ['id' => 'btn-reset', 'class' => 'btn grey-gallery btn-outline ciptana-spin-btn', 'onclick' => 'resetForm();']) ?>
                            </div>
                        </div>
                    </div>
                </div>
...
//			}
    ...
    function setContainer(packinglist_id, callback = null) {
        if ($("#<?= Html::getInputId($model, "bundle_partition") ?>").is(":checked")) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {packinglist_id: packinglist_id, revisi: revisi},
            success: function (data) {
...
//					});
                ...
                if (data.disabled_detail) {
                    $(".table-contrainer > tbody").each(function () {
                        ...
                        $(".sampah, .hapus, .addBundle, .addContainer").prop("onclick", null).off("click").css('opacity', '10%');
                    });
                }
                if (callback) {
                    callback();
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data) {
                    ...
                    $("#<?= yii\bootstrap\Html::getInputId($model, "final_destination") ?>").prop("disabled", true);
                    $("#<?= yii\bootstrap\Html::getInputId($model, "diperiksa") ?>").prop("disabled", true);
            ...
            success: function (data) {
                if (data) {
                    $(data).each(function () {
                        ...
                        $(".table-contrainer").each(function () {
                            var elm = this;
                            var container_no = $(elm).find("input[name='container_no']").val();
...
//				loadExcel();
    ...
    function addBundle(ele) {
        ...
        $.ajax({
            ...
            data: {
                ...
                glue: glue,
                profil_kayu: profil_kayu,
                kondisi_kayu: kondisi_kayu,
                thick: thick,
    ...
    function setMeterKubik(ele) {
        ...
        //$(ele).parents("tr").find('input[name*="[volume_display]"]').val( formatNumberForUser4Digit(formatNumberForUser(result)) );
        $(ele).parents("tr").find('input[name*="[volume_display]"]').val(formatNumberForUser4Digit(result));
        /*console.log('result = '+result);
        console.log('formatNumberForUser4Digit = '+formatNumberForUser4Digit(result));
        console.log('formatNumberForUser = '+formatNumberForUser(result));
        console.log('formatNumberForUser4Digit + formatNumberForUser = '+formatNumberForUser4Digit(formatNumberForUser(result)));*/
        total();
    }
    ...
    function total() {
        setTimeout(function () {
            ...
            $('table.table-contrainer').each(function () {
                ...
                //$(this).find('input[name*="tot_vol"]').val(tot_vol);
                //$(this).find('input[name*="tot_vol"]').val(formatNumberFixed4(tot_vol));
                $(this).find('input[name*="tot_vol"]').val(formatNumberForUser4Digit(formatNumberForUser(tot_vol)));
