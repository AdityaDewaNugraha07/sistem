			...
			<table class="table table-striped table-bordered table-advance table-hover table-contrainer" style="width: 100%; border: 1px solid #A0A5A9;">
				<thead>
					...
					if($jenis_produk == "Plywood" || $jenis_produk == "Lamineboard" || $jenis_produk == "Platform"){
						...
						$colspan_header = 9;
						$colspan_footer = 4;
					}else if(in_array($jenis_produk, ["Moulding", "FingerJointStick", "Flooring", "FingerJointLamineBoard"])){
						$column = '<th rowspan="2" style="width: 100px; background-color: #E3E7EA">Wood<br>Type</th>'
					...
					<tr style="background-color: #E3E7EA">
						<td colspan="<?= $colspan_header ?>" style="vertical-align: middle;">
							...
							<b>Container No. : <?= yii\bootstrap\Html::textInput("container_kode",(!empty($container_kode)?$container_kode:""),['class'=>'form-control','onblur'=>'setContainerDetails();','style'=>'width:150px; text-align:right; font-weight:600; display:inline; padding:2px; height: 26px; color:#3E66A6']) ?></b> &nbsp; &nbsp; &nbsp; &nbsp; 
							...
							<b>Lot Code : <?= yii\bootstrap\Html::textInput("lot_code",(!empty($lot_code)?$lot_code:""),['class'=>'form-control','onblur'=>'setContainerDetails();','style'=>'width:60px; text-align:right; font-weight:600; display:inline; padding:2px; height: 26px; color:#3E66A6']) ?></b> &nbsp; &nbsp; &nbsp; &nbsp; 
							<span class="pull-right">
								<a class="sampah btn btn-icon-only blue-steel tooltips btn-outline" onclick="hapuscontainer(this)" data-original-title="Hapus Container ini" style="width: 24px; height: 24px; padding-top: 1px; padding-bottom: 1px;"><i class="fa fa-trash-o"></i></a>
							</span>
						</td>
					</tr>
					<tr>
						...
						<th rowspan="2" style="width: 30px; background-color: #E3E7EA" class="kolom-action"></th>
					</tr>
					<tr>
				...
				<tfoot style="background-color: #E3E7EA">
					<tr>
						<td style="vertical-align: middle; padding: 2px;"><a class="addBundle btn btn-xs btn-default" onclick="addBundle(this)"><i class="fa fa-plus"> Add Bundle</i></a></td>
