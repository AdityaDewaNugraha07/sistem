...
<tr>
	<td style="padding: 2px;">
		...
		<?= \yii\bootstrap\Html::activeTextInput($model, '[ii]bundles_no',['class'=>'form-control','style'=>'text-align:center; height: 26px; padding:2px; font-size:1.2rem;']) ?>
		...
		<?= \yii\bootstrap\Html::activeHiddenInput($model, '[ii]container_size') ?>
		<?= \yii\bootstrap\Html::activeHiddenInput($model, '[ii]lot_code') ?>
	...
	<td style="padding: 2px;">
		<?= \yii\bootstrap\Html::activeHiddenInput($model, '[ii]volume') ?>
		<?= \yii\bootstrap\Html::activeTextInput($model, '[ii]volume_display',['class'=>'form-control float','disabled'=>'disabled','style'=>'text-align:right; height: 26px; padding:2px; font-size:1.2rem;']) ?>
	</td>
	<td style="text-align: right;">
		<a class="hapus btn btn-xs red-flamingo" onclick="hapusbundle(this,'<?= $table_id ?>')"><i class="fa fa-close"></i></a>
	</td>
</tr>