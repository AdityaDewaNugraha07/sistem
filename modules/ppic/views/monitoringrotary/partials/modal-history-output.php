...
/** @var string $type */
use yii\helpers\Url; ?>
<div class="modal fade" id="modal-history-output" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Riwayat Output Rotary') ?></h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <table class="table table-bordered table-hover" id="table-history-output" style="width: 100%">
                            <thead>
                            <tr>
                                <th>No</th>
...
<script>
    $(document).ready(function () {
        $('#table-history-output').DataTable({
            ajax: {
                url: '<?= Url::toRoute('/ppic/monitoringrotary/modalhistoryoutput')?>',
                type: 'POST',
            },
            responsive: true,
            columns: [
