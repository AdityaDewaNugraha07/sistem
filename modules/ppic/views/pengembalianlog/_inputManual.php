...
function kirim() {
    ...
    $('#loader').show();
    $.ajax({
        url: '<?= Url::toRoute(['/ppic/pengembalianlog/inputManuals']); ?>',
        type: 'POST',
        data: {
            clause: $('#clause').val(),
            keyword: $('#keyword').val(),
...
function showDetail(datas, no_barcode) {
    ...
    $.ajax({
        url: '<?= Url::toRoute(['/ppic/pengembalianlog/showDetail']); ?>',
        type: 'POST',
        data: {
            datas: datas, no_barcode: no_barcode, id:id, edit:edit
        },
        success: function(data) {
            if (data) {
                if (data['msg'] == "Data ok") {
                    var url = "<?= yii\helpers\Url::toRoute("/ppic/pengembalianlog/review") ?>?no_barcode="+no_barcode;
