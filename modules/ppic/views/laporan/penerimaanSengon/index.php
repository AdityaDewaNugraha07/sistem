        ...
        <div class="portlet light bordered">
            <div class="portlet-body">
                <?php /*<ul class="nav nav-tabs">
					<li class="active">
						<a href="<?= \yii\helpers\Url::toRoute("/ppic/laporan/penerimaanSengon/index") ?>"> <?= Yii::t('app', $this->title); ?> </a>
					</li>
				</ul> */?>
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered table-hover" id="table-laporan">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th style="line-height: 1; width: 90px;"><?= Yii::t('app', 'Kode Input'); ?></th>
                                    <th><?= Yii::t('app', 'Suplier'); ?></th>
                                    <th style="line-height: 1; width: 70px;"><?= Yii::t('app', 'Tanggal<br>Terima') ?></th>
                                    <th style="line-height: 1; width: 70px;"><?= Yii::t('app', 'Nopol<br>Kendaraan') ?></th>
                                    ...
                                    <th style="line-height: 1; width: 80px;"><?= Yii::t('app', 'Kode<br>Jenis') ?></th>
                                    <th style="line-height: 1; width: 60px;"><?= Yii::t('app', 'D') ?></th>
                                    <th style="line-height: 1; width: 60px;"><?= Yii::t('app', 'P') ?></th>
                                    <th style="line-height: 1; width: 60px;"><?= Yii::t('app', 'Pcs') ?></th>
...
function dtLaporan(){
    ...
    var dt_table =  $('#table-laporan').dataTable({
		pageLength: 100,
        ajax: { 
			url: '<?= \yii\helpers\Url::toRoute('/ppic/laporan/penerimaanSengon') ?>',
			data:{
				dt: 'table-laporan',
