...
?>
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"> Hasil Repacking<small>( Pengiriman Hasil Repacking Ke Gudang )</small></h1>
<!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
                    ...
                    <div class="col-md-12">
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    <span class="caption-subject bold"><h4>Rekap Belum Diterima Gudang</h4></span>
                                </div>
                            </div>
                            <div class="portlet-body">
                                <div class="row">
...
function dtAfterSave(){
    var dt_table =  $('#table-informasi').dataTable({
        ajax: { url: '<?= \yii\helpers\Url::toRoute('/ppic/laporan/RekapHasilRepackingblmTerimaGudang') ?>',
