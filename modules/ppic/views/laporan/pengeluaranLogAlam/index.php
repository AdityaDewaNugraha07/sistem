                            ...
                            <div class="portlet-body">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <?= $form->field($model, 'cara_keluar')->dropDownList([
                                                                                                    '' => 'All',
                                                                                                    'Industri' => 'Industri',
                                                                                                    'Trading' => 'Trading'
                                                                                                ], ['class' => 'form-control'])?>
...
<script>
    function dtLaporan() {
        var dt_table = $('#table-laporan').dataTable({
            pageLength: 100,
            ajax: {
                url: '<?= Url::toRoute('/ppic/laporan/pengeluaranLogAlam') ?>',
                data: {
                    dt: 'table-laporan',
    ...
    function printout(caraPrint) {
        window.open("<?= Url::toRoute('/ppic/laporan/pengeluaranLogAlamPrint') ?>?" + $('#form-search-laporan').serialize() + "&caraprint=" + caraPrint, "", 'location=_new, width=1200px, scrollbars=yes');
    }
