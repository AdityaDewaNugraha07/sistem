...
$this->title = 'Laporan Output Bandsaw';
		...
		<div class="portlet light bordered">
			...
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject hijau bold"><?= Yii::t('app', 'Laporan Output Bandsaw '); ?><span id="periode-label" class="font-blue-soft"></span></span>
				</div>
				<div class="tools">
			...
			<div class="portlet-body">
				<table class="table table-striped table-bordered table-hover" id="table-laporan">
					<thead>
						<tr>
							<th></th>
                            <th><?= Yii::t('app', 'Kode<br>Bandsaw') ?></th>
...
function dtLaporan(){
    var dt_table =  $('#table-laporan').dataTable({
		pageLength: 100,
        ajax: { 
			url: '<?= \yii\helpers\Url::toRoute('/ppic/laporan/bandsaw') ?>',
			data:{
				dt: 'table-laporan',
        ...
        columnDefs: [
			...
			{	targets: 10, class: 'text-align-right td-kecil',
				render: function ( data, type, full, meta ) {
					var kubikasi = full[7] * full[8] * full[9] * full[10] / 1000000; //cm3 convert to m3
...
function printout(caraPrint){
	window.open("<?= yii\helpers\Url::toRoute('/ppic/laporan/bandsawPrint') ?>?"+$('#form-search-laporan').serialize()+"&caraprint="+caraPrint,"",'location=_new, width=1200px, scrollbars=yes');
}
</script>