...
$this->title = 'Pengeluaran Log Sengon';
        ...
        <div class="portlet light bordered">
            <div class="portlet-body">
                <?php /*<ul class="nav nav-tabs">
					<li class="active">
						<a href="<?= \yii\helpers\Url::toRoute("/ppic/laporan/pengeluaranSengon/index") ?>"> <?= Yii::t('app', $this->title); ?> </a>
					</li>
				</ul> */?>
                <div class="row">
                    <div class="col-md-12">
...
function dtLaporan(){
    ...
    var dt_table =  $('#table-laporan').dataTable({
		pageLength: 100,
        ajax: { 
			url: '<?= \yii\helpers\Url::toRoute('/ppic/laporan/pengeluaranSengon') ?>',
			data:{
				dt: 'table-laporan',
