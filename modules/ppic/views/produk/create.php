    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        <?= $form->field($model, 'produk_group')->dropDownList(\app\models\MDefaultValue::getOptionListProduk('jenis-produk'),['class'=>'form-control','onchange'=>'setJenisProduk();']) ?>
                        <div class="place-jenis-kayu" style="display: none;">
                            <?= $form->field($model, 'jenis_kayu')->dropDownList([],['class'=>'form-control','onchange'=>'setKodeNamaProduk();']) ?>
                                ...
                                <div class="place-warna-kayu" style="display: none;">
                                        <?= $form->field($model, 'warna_kayu')->dropDownList([],['class'=>'form-control','onchange'=>'setKodeNamaProduk();']) ?>
                                </div>
                            ...
                            setDropdownKondisiKayu(function(){
                                setKodeNamaProduk(function(){
                                    ...
                                    if(jenis_produk == 'Sawntimber'){
                                        $('#<?= \yii\bootstrap\Html::getInputId($model, 'produk_p_satuan') ?>').val("cm");
                                        $('#<?= \yii\bootstrap\Html::getInputId($model, 'produk_l_satuan') ?>').val("cm");
                                        $('#<?= \yii\bootstrap\Html::getInputId($model, 'produk_t_satuan') ?>').val("cm");
                                    }else if(jenis_produk == 'Moulding'){
                                        $('#<?= \yii\bootstrap\Html::getInputId($model, 'produk_p_satuan') ?>').val("feet");
                                        $('#<?= \yii\bootstrap\Html::getInputId($model, 'produk_l_satuan') ?>').val("mm");
                                        $('#<?= \yii\bootstrap\Html::getInputId($model, 'produk_t_satuan') ?>').val("mm");
                                    }else{
                                        $('#<?= \yii\bootstrap\Html::getInputId($model, 'produk_p_satuan') ?>').val("mm");
                                        $('#<?= \yii\bootstrap\Html::getInputId($model, 'produk_l_satuan') ?>').val("mm");
                                        $('#<?= \yii\bootstrap\Html::getInputId($model, 'produk_t_satuan') ?>').val("mm");
                                    }
                                    setDimensi();
...
function setDropdownWarnaKayu(callback=null){
	var jenis_produk = $("#<?= yii\bootstrap\Html::getInputId($model, "produk_group") ?>").val();
	$("#<?= \yii\bootstrap\Html::getInputId($model, 'warna_kayu') ?>").html("");
	$.ajax({
		...
		success: function (data) {
			if(data.html){
				$("#<?= \yii\bootstrap\Html::getInputId($model, 'warna_kayu') ?>").html(data.html);
...
function setKodeNamaProduk(callback=null){
    ...
    var warna_kayu = $('#<?= \yii\bootstrap\Html::getInputId($model, 'warna_kayu') ?>').val();
