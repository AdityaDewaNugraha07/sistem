    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Update Detail Repair') ?></h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <?php
                        $grades = MDefaultValue::getOptionList('mtrg-grade-repair-output');
                        unset($grades['Output']);
    ...
    $('#form-input-detail').on('beforeSubmit', function () {
        $.ajax({
            ...
            success: function(res) {
                mtrg.storage('input-repair-details').update(res);
