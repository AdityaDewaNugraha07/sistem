...
?>
<h1 class="page-title"> <?php echo Yii::t('app', 'Repair'); ?></h1>
<div class="row">
    <div class="col-md-12">
                ...
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="javascript:void(0)"
                           data-url="<?= Url::toRoute("/ppic/monitoringrepair/input") ?>"> <?= Yii::t('app', 'Input') ?> </a>
                    </li>
                    <li class="">
                        <a href="javascript:void(0)"
                           data-url="<?= Url::toRoute("/ppic/monitoringrepair/output") ?>"> <?= Yii::t('app', 'Output') ?> </a>
                    </li>
                </ul>
                <div class="row">
                    <div class="col-md-12">
...
<script>
    function main() {
        $(document).ready(function () {
            let url = '<?= Url::toRoute("/ppic/monitoringrepair/input") ?>';
            $('.loader').hide();
