				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							...
							<?= $form->field($model, 'dokumen_penjualan_id')->dropDownList(\app\models\TDokumenPenjualan::getOptionListJasaKD(),['prompt'=>'All'])->label(Yii::t('app', 'No. Dokumen')); ?>
						</div>
						<div class="col-md-5">
							...
							<?php 
								echo \yii\helpers\Html::button( Yii::t('app', 'Search'),[
