...
$this->title = 'Laporan Penerbitan FA-KO';
		...
		<div class="portlet light bordered">
			...
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject hijau bold"><?= Yii::t('app', 'Laporan Penerbitan FA-KO '); ?><span id="periode-label" class="font-blue-soft"></span></span>
				</div>
				<div class="tools">
...
<?php $this->registerJs("
	...
	setMenuActive('".json_encode(app\models\MMenu::getMenuByCurrentURL('Penerbitan Dokumen'))."');
...
function dtLaporan(){
    var dt_table =  $('#table-laporan').dataTable({
		pageLength: 100,
        ajax: { 
			url: '<?= \yii\helpers\Url::toRoute('/tuk/laporan/penerbitanDokumen') ?>',
			data:{
				dt: 'table-laporan',
...
function printout(caraPrint){
	window.open("<?= yii\helpers\Url::toRoute('/tuk/laporan/penerbitanDokumenPrint') ?>?"+$('#form-search-laporan').serialize()+"&caraprint="+caraPrint,"",'location=_new, width=1200px, scrollbars=yes');
}
