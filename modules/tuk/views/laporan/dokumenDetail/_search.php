					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<?= \yii\bootstrap\Html::activeDropDownList($model, "jenis_produk", \app\models\MDefaultValue::getOptionList("jenis-produk"), ['prompt'=>'All','class'=>'form-control']) ?>
								</div>
							</div>
						</div>
						<div class="col-md-5">
							...
							<?= $form->field($model, 'dokumen_penjualan_id')->dropDownList(\app\models\TDokumenPenjualan::getOptionList(),['prompt'=>'All'])->label(Yii::t('app', 'No. Dokumen')); ?>
						</div>
					</div>
