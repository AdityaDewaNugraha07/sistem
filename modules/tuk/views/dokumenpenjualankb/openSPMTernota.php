    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Nota Penjualan Kayu Bulat'); ?></h4>
            </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="table-spm">
							<thead>
								<tr>
									...
									<th style="width:350px"><?= Yii::t('app', 'Alamat Bongkar'); ?></th>
								</tr>
							</thead>
						</table>
						</div>
...
function dtMaster(){
    var dt_table =  $('#table-spm').dataTable({
        ajax: { url: '<?= \yii\helpers\Url::toRoute('/tuk/dokumenpenjualankb/openSPMTernota') ?>',data:{dt: 'table-spm'} },
        order: [
            [0, 'desc']
        ],
        columnDefs: [
