...
$this->title = 'Dokumen Penjualan Kayu Bulat';
            ...
            <div class="portlet-body">
				<div class="row" style="margin-top: -10px; margin-bottom: 10px;">
					<span class="pull-right">
						<a class="btn blue btn-sm btn-outline" onclick="daftarAfterSave()"><i class="fa fa-list"></i> <?= Yii::t('app', 'Dokumen KB Yang Telah Dibuat'); ?></a> 
					</span>
				</div>
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="portlet-body">
                                <div class="row">
                                    <div class="col-md-6">
											...
											<div class="form-group" style="margin-bottom: 5px;">
												...
												<div class="col-md-7">
													<span class="input-group-btn" style="width: 100%">
														<?= \yii\bootstrap\Html::activeDropDownList($model, 'spm_ko_id', app\models\TNotaPenjualan::getOptionListNotaDokumenKB(),['class'=>'form-control select2','prompt'=>'','onchange'=>'setNota()','style'=>'width:100%;']); ?>
													</span>
										...
										<?php //echo $form->field($model, 'terima_logalam_id')->textInput(['disabled'=>'disabled'])->label('Asal Log'); ?>
									</div>
									<div class="col-md-5">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h5 style="font-weight: 600" id="place-detaildokumen"><?= Yii::t('app', 'Detail Log'); ?></h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
											...
											<table class="table table-striped table-bordered table-advance table-hover" style="width: 90%" id="table-detail">
												<thead>
													<tr>
														...
														<th rowspan="2" style="width: 250px; font-size: 1.3rem; line-height: 0.9; padding: 5px;"><?= Yii::t('app', 'Jenis Kayu'); ?></th>
														<!-- <th rowspan="2" style="width: 220px; font-size: 1.3rem; line-height: 0.9; padding: 5px;"><?= Yii::t('app', 'Range Diameter'); ?></th> -->
														<th colspan="4" style="line-height: 0.9; font-size: 1.3rem; padding: 3px;"><?= Yii::t('app', 'Nomor'); ?></th>
														<th colspan="4" style="line-height: 0.9; font-size: 1.3rem; padding: 3px;"><?= Yii::t('app', 'Diameter'); ?></th>
														<th colspan="3" style="line-height: 0.9; font-size: 1.3rem; padding: 3px;"><?= Yii::t('app', 'Cacat'); ?></th>
														<th colspan="3" style="line-height: 0.9; font-size: 1.3rem; padding: 3px;"><?= Yii::t('app', 'Ukuran'); ?></th>
														<th rowspan="2" style="line-height: 0.9; font-size: 1.3rem; padding: 3px;"><?= Yii::t('app', 'Keterangan'); ?></th>
													</tr>
													<tr>
														<th style="font-size: 1.2rem; line-height: 0.9; width: 130px; padding: 5px;"><?= Yii::t('app', 'QR Code'); ?></th>
														<th style="font-size: 1.2rem; line-height: 0.9; width: 130px; padding: 5px;"><?= Yii::t('app', 'Lapangan'); ?></th>
														<th style="font-size: 1.2rem; line-height: 0.9; width: 130px; padding: 5px;"><?= Yii::t('app', 'Grade'); ?></th>
														<th style="font-size: 1.2rem; line-height: 0.9; width: 130px; padding: 5px;"><?= Yii::t('app', 'Batang'); ?></th>
														<th style="font-size: 1.2rem; line-height: 0.9; width: 130px; padding: 5px;"><?= Yii::t('app', 'Ujung 1'); ?></th>
														<th style="font-size: 1.2rem; line-height: 0.9; width: 130px; padding: 5px;"><?= Yii::t('app', 'Ujung 2'); ?></th>
														<th style="font-size: 1.2rem; line-height: 0.9; width: 130px; padding: 5px;"><?= Yii::t('app', 'Pangkal 1'); ?></th>
														<th style="font-size: 1.2rem; line-height: 0.9; width: 130px; padding: 5px;"><?= Yii::t('app', 'Pangkal 2'); ?></th>
														<th style="font-size: 1.2rem; line-height: 0.9; width: 130px; padding: 5px;"><?= Yii::t('app', 'Panjang'); ?></th>
														<th style="font-size: 1.2rem; line-height: 0.9; width: 130px; padding: 5px;"><?= Yii::t('app', 'Gubal'); ?></th>
														<th style="font-size: 1.2rem; line-height: 0.9; width: 130px; padding: 5px;"><?= Yii::t('app', 'Growong'); ?></th>
														<th style="font-size: 1.2rem; line-height: 0.9; width: 130px; padding: 5px;"><?= Yii::t('app', 'Panjang'); ?></th>
														<th style="font-size: 1.2rem; line-height: 0.9; width: 130px; padding: 5px;"><?= Yii::t('app', 'Diameter Rata'); ?></th>
														<th style="font-size: 1.2rem; line-height: 0.9; width: 130px; padding: 5px;"><?= Yii::t('app', 'Volume'); ?></th>
													</tr>
												</thead>
												<tbody>
												</tbody>
												<tfoot>
													<tr style="background-color: #F1F4F7;">
														<td colspan="15" class="text-align-right"><b>
															Total &nbsp;
														</b></td>
...
<?php $this->registerJs(" 
    $pagemode;
	formconfig();
    setMenuActive('".json_encode(app\models\MMenu::getMenuByCurrentURL('Dokumen Penjualan KB'))."');
	$('select[name*=\"[spm_ko_id]\"]').select2({
		allowClear: !0,
		placeholder: 'Tarik Kode Nota',
//		ajax: {
//			url: '".\yii\helpers\Url::toRoute('/tuk/dokumenpenjualankb/findNota')."',
//			dataType: 'json',
//			delay: 250,
...
function setNota(){
	...
	$.ajax({
        url    : '<?= \yii\helpers\Url::toRoute(['/tuk/dokumenpenjualankb/setNota']); ?>',
        type   : 'POST',
        ...
        success: function (data) {
			...
			if(data.spm_ko_id){
				...
				// if(data.op.terima_logalam_id){
				// 	$("#<?php //echo yii\bootstrap\Html::getInputId($model, "terima_logalam_id") ?>").val("Pelabuhan");
				// }else {
				// 	$("#<?php //echo yii\bootstrap\Html::getInputId($model, "terima_logalam_id") ?>").val("Pabrik");
				// }
...
function openNota(){
	var url = '<?= \yii\helpers\Url::toRoute(['/tuk/dokumenpenjualankb/OpenSPMTernota']); ?>';
...
function getItems(nota_penjualan_id){
    $.ajax({
		url    : '<?= \yii\helpers\Url::toRoute(['/tuk/dokumenpenjualankb/getItems']); ?>',
		type   : 'POST',
...
function setDropdownPetugas(callback=null){
	...
	$.ajax({
		url    : '<?= \yii\helpers\Url::toRoute(['/tuk/dokumenpenjualankb/setDropdownPetugas']); ?>',
		type   : 'POST',
...
function setPetugas(){
	...
	$.ajax({
		url    : '<?= \yii\helpers\Url::toRoute(['/tuk/dokumenpenjualankb/setPetugas']); ?>',
		type   : 'POST',
...
function getItemsById(id){
    $.ajax({
		url    : '<?= \yii\helpers\Url::toRoute(['/tuk/dokumenpenjualankb/getItemsById']); ?>',
		type   : 'POST',
		data   : {id:id},
		success: function (data) {
			if(data.html){
...
function daftarAfterSave(){
    openModal('<?= \yii\helpers\Url::toRoute(['/tuk/dokumenpenjualankb/daftarAfterSave']) ?>','modal-aftersave','95%');
}

function printDokumen(id){
	window.open("<?= yii\helpers\Url::toRoute('/tuk/dokumenpenjualankb/printDokumen') ?>?id="+id+"&caraprint=PRINT","",'location=_new, width=1200px, scrollbars=yes');
}
</script>