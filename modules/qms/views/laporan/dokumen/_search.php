				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							...
							<?= $form->field($model, 'kategori_dokumen')->dropDownList(\app\models\MDokumen::getOptionListJenis(),['prompt'=>'All']); ?>
						</div>
						<div class="col-md-5">
							<?= $form->field($model, 'jenis_dokumen')->dropDownList(\app\models\MDefaultValue::getOptionList('jenis-dokumen'),['prompt'=>'All']); ?>
						</div>
					</div>
