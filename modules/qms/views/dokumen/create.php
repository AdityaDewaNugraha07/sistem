    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Tambahkan Dokumen Baru'); ?></h4>
            </div>
...
<?php $this->registerJs(
    // $this->theme->baseUrl."/global/plugins/jquery-ui/jquery-ui.min.js",['depends'=>[yii\web\YiiAsset::className()]],
    "formconfig();", yii\web\View::POS_READY); 
?>
<script>
    function setKode(){
