		...
		<div class="portlet light bordered form-search">
			...
			<div class="portlet-body">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<?php echo $this->render('@views/apps/form/periodeTanggal', ['label'=>'Periode Pengeluaran','model' => $model,'form'=>$form]) ?>
							<?= $form->field($model, 'bpb_kode')->textInput()->label(Yii::t('app', 'Kode BPB')); ?>							
                                                        <?= $form->field($model, 'departement_id')->dropDownList(\app\models\MDepartement::getOptionListOne(),['prompt'=>'All'])->label(Yii::t('app', 'Departement')); ?>
						</div>
						<div class="col-md-5">
