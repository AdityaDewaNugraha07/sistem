			...
			<table border="1" style="width: 100%; border-left: solid 1px transparent; border-right: solid 1px transparent;">
				...
				?>
					<tr style="font-size: 1.2rem;">
						...
						<td style="text-align: right;padding-right: 5px"><?= $modDetail[$i]->spld_qty.' '.$modDetail[$i]->bhp->bhp_satuan; ?></td>
		...
		<td colspan="2" style="vertical-align: bottom; border-top: solid 1px transparent;">
			<table style="width: 100%; font-size: 1.1rem; height: 2cm; border-bottom: solid 1px transparent; border-left: solid 1px transparent; border-right: solid 1px transparent;" border="1">
				<tr style=" text-align: center;">
                                    <td rowspan="2" style="width: 8cm;">
                                        <?php 
                                        $modCancel = \app\models\TCancelTransaksi::find()->where(['cancel_transaksi_id'=>$model->cancel_transaksi_id])->one();
                                        
                                        ?>
                                        <?= !empty($model->cancel_transaksi_id) ? "<center><span class='label label-sm label-danger'>ABORTED</span><br>$modCancel->cancel_reason</center>":"";?>
                                    </td>
