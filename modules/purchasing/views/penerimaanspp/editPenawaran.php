...
?>
<div class="modal fade" id="modal-edit-penawaran" role="basic" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn btn-icon-only btn-default fa fa-close" data-dismiss="modal" aria-hidden="true" style="float: right; padding-top: 2px; padding-bottom: 2px;"></button>
                <h4 class="modal-title"><?= Yii::t('app', 'Edit Penawaran Barang : <b>').$model->bhp->bhp_nm."</b>"; ?></h4>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        if(!empty($model->attachment)){
                            $gambarPenawaran = '<img src="'.\yii\helpers\Url::base().'/uploads/pur/penawaran/'.$model->attachment .'" alt="produk-pict" style="height: 100%; width: 100%; display: block;"> ';
                        }else{
                            $gambarPenawaran = '<img src="'.Yii::$app->view->theme->baseUrl .'/cis/img/no-image.png" alt="produk-pict" style="height: 150px; width: 100%; display: block;"> ';
                        }
                            ...
                            'template'=>'{label}
                                <div class="col-md-8">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <img src="'.(!empty($model->attachment) ? \yii\helpers\Url::base().'/uploads/pur/penawaran/'.$model->attachment : Yii::$app->view->theme->baseUrl .'/cis/img/no-image.png').'" alt="produk-pict" /> 
                                        </div>
            ...
            <div class="modal-footer">
                <?php echo \yii\helpers\Html::button( Yii::t('app', 'Save'),['class'=>'btn hijau btn-outline ciptana-spin-btn',
                    'onclick'=>'submitformajax(this,"$(\'#modal-edit-penawaran\').modal(\'hide\'); $(\'#table-penawaran\').dataTable().fnClearTable();")'
                    ]);
                        ?>
            </div>
