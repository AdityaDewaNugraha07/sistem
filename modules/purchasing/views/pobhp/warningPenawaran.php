    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Warning!! Kebijakan Penawaran</h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
						<h5>
							...
							<b>Perhatian..!!! </b><br>Kebijakan mewajibkan anda untuk melampirkan Penawaran dan berkas penawaran pada masing-masing item barang, silahkan periksa kembali daftar barang Bahan Pembantu Yang akan anda terbitkan PO
						</h5>
					</div>
				</div>
			</div>
            <div class="modal-footer text-align-center">				
                <?php // yii\helpers\Html::button(Yii::t('app', 'Yes'),['class'=>'btn hijau btn-outline ciptana-spin-btn','onclick'=>"yes()"]); ?>
                <?php // yii\helpers\Html::button(Yii::t('app', 'No'),['class'=>'btn red btn-outline ciptana-spin-btn','data-dismiss'=>'modal']); ?>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
