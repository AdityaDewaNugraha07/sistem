<div class="modal fade" id="modal-info-spl" tabindex="-1" role="basic" aria-hidden="true">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-6"><strong><?= $model->spl_kode; ?></strong></div>
                        </div>
                        <div class="form-group col-md-12">
                            <label class="col-md-6 control-label"><?= Yii::t('app', 'Tanggal'); ?></label>
                            <div class="col-md-6"><strong><?= app\components\DeltaFormatter::formatDateTimeForUser2($model->spl_tanggal) ?></strong></div>
                        </div>
                    </div>
                    <div class="col-md-6">
						<div class="form-group col-md-12">
                            <label class="col-md-6 control-label"><?= Yii::t('app', 'Created By'); ?></label>
                            <div class="col-md-6"><strong><?= (!empty($model->created_by)?$model->splCreatedBy->pegawai->pegawai_nama:""); ?></strong></div>
                        </div>
						<div class="form-group col-md-12">
                            <label class="col-md-6 control-label"><?= Yii::t('app', 'Penerimaan'); ?></label>
                            <div class="col-md-6"><strong>
								<?php
								if(!empty($model->terima_bhp_id)){
									foreach($model->tTerimaBhps as $i => $detail){
										echo $detail->terimabhp_kode;
										if(($i+1)!=count($model->tTerimaBhps)){
											echo ", ";
										}
									}
								}
