        ...
        <div class="modal-content">
            <div class="modal-header">
				...
				if ($status_approval == "Not Confirmed") {
					$status_approval_text = "<font style='font-size: 12px; color: #000; background-color: #ddd; font-weight: bold;'>(".$status_approval.")</font>";
				} else if ($status_approval == "APPROVED" || $status_approval == "ALLOWED") {
					$status_approval_text = "<font style='font-size: 12px; color: #186e02; background-color: #ddd; font-weight: bold;'>(".$status_approval.")</font>";
				} else {
					$status_approval_text = "<font style='font-size: 12px; color: #f50018; background-color: #ddd; font-weight: bold;'>(".$status_approval.")</font>";
				}
				?>
                <h4 class="modal-title"><?= Yii::t('app', 'Detail Informasi TBP / LPB'); ?> <?php echo $status_approval_text;?></h4>
            </div>
							...
							<table class="table table-striped table-bordered table-hover" id="table-laporan">
								<thead>
									<tr style="background-color: #F1F4F7; ">
										...
										<th style="text-align: center;display:<?php echo $hide ;?>"><?= Yii::t('app', 'Harga'); ?></th>
										<th style="text-align: center;display:<?php echo $hide ;?>"><?= Yii::t('app', 'Subtotal'); ?></th>
								...
								<tbody>
									...
									<tr style="<?= $mark; ?>">
										...
										<td style="text-align: right;display:<?php echo $hide ;?>"><?= app\components\DeltaFormatter::formatNumberForUserFloat($detail->terimabhpd_harga) ?></td>
										<td style="text-align: right;display:<?php echo $hide ;?>"><?= app\components\DeltaFormatter::formatNumberForUserFloat($detail->terimabhpd_harga * $detail->terimabhpd_qty) ?></td>
									...
									<tr style="font-weight: bold; text-align: right; display:<?php echo $hide ;?>">
									...
									<tr style="text-align: right;display:<?php echo $hide ;?>">
