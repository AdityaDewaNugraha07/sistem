...
?>
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"> <?php echo Yii::t('app', 'Tracking Data Pembelian Bahan Pembantu'); ?></h1>
<!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
<div class="row">
    <div class="col-md-12">
...
<?php $this->registerJs(" 
setMenuActive('".json_encode(app\models\MMenu::getMenuByCurrentURL('Tracking Pembelian'))."');
