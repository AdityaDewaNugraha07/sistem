        ...
        <div class="portlet light bordered">
            <div class="portlet-body">
                <ul class="nav nav-tabs pull-right">
                    <li class="">
                        <a href="<?= yii\helpers\Url::toRoute("/sysadmin/catatan/index"); ?>"> <?= Yii::t('app', 'Catatan'); ?> </a>
                    </li>
                    <li class="active">
                        <a href="<?= yii\helpers\Url::toRoute("/sysadmin/catatan/create"); ?>"> <?= Yii::t('app', 'Tambah Catatan'); ?> </a>
                    </li>
                    <li class="">
                    ...
                    <div class="col-md-12 portlet light bordered">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div>
                                    <?= $form->field($model, 'keterangan')->label(false)->textarea(['width' => '120px', 'rows' => '5', 'placeholder' => 'keterangan', 'value' => $model->keterangan]); ?>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail">
                                                        <img src="'.$src.'" class="img-responsive pic-bordered" alt="">
                                                    </div>
