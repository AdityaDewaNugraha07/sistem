					...
					<div class="col-md-12">
						<div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                <span class="caption-subject hijau bold"><?= Yii::t('app', 'Real Time Monitoring Server : 10.10.10.3'); ?></span>
                                </div>
                                <div class="tools">
                            ...
                            <div class="portlet-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <iframe src="http://10.10.10.3:19999/slave.html" title="Netdata" style="width: 1000px; height: 950px;" frameBorder="0"></iframe>
                                    </div>
                                </div>
