        ...
        <div class="portlet light bordered">
            <div class="portlet-body">
                <ul class="nav nav-tabs pull-right">
                    <li class="">
                        <a href="<?= yii\helpers\Url::toRoute("/sysadmin/catatan2/index"); ?>"> <?= Yii::t('app', 'Catatan'); ?> </a>
                    </li>
                    <li class="active">
                        <a href="<?= yii\helpers\Url::toRoute("/sysadmin/catatan2/edit?id=$model->catatan_id"); ?>"> <?= Yii::t('app', 'Edit Catatan'); ?> </a>
                    </li>
                    <li class="">
