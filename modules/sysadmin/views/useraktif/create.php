...
<div class="modal fade" id="modal-user-create" tabindex="-1" role="basic" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= $form->field($model, 'password')->textInput(['readonly'=>'readonly']); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <?= $form->field($model, 'pegawai_id')->dropDownList(\app\models\MPegawai::getOptionListWithDeptName(),['class'=>'form-control select2','prompt'=>'']); ?>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <?php echo \yii\helpers\Html::button( Yii::t('app', 'Save'),['class'=>'btn hijau btn-outline ciptana-spin-btn',
                    'onclick'=>'submitformajax(this,"$(\'#modal-user-create\').modal(\'hide\'); $(\'#table-user\').dataTable().fnClearTable();")'])?>
            </div>
