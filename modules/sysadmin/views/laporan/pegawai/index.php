...
$this->title = 'Laporan Data Pegawai';
...
?>
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"> <?php echo Yii::t('app', 'Laporan Data Pegawai'); ?></h1>
<!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject hijau bold"><?= Yii::t('app', 'Laporan Data Pegawai'); ?></span>
                                </div>
                                <div class="tools">
...
<!--                            <div class="portlet-body">-->
                                <div class="row">
                                    <div class="col-md-9" style="margin-left: -30px; margin-bottom: 20px;">
                                        <form name="filter" id="filter" method="get" action="pegawai">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-3">
                                                <select name="departement_id" id="departement_id" class="form-control">
                                                    ...
                                                    <?php
                                                    $sql = "select departement_id, departement_nama from m_departement where active='t' order by departement_nama asc";
                                ...
                                <div class="row" style="padding-right: 25px;">
                                    <table class="table table-striped table-bordered table-hover table-responsive" id="table-master">
                                        <thead>
                                            <tr>
                                                <th style="text-align: left;"><?= Yii::t('app', 'ID Pegawai') ?></th>
                                                <th style="text-align: left;"><?= Yii::t('app', 'Nama Pegawai') ?></th>
                                                <th style="text-align: left;"><?= Yii::t('app', 'Jenis Kalamin') ?></th>
                                                <th style="text-align: left;"><?= Yii::t('app', 'Departement') ?></th>
                                                <th style="text-align: left;"><?= Yii::t('app', 'Jabatan') ?></th>
                                                <th style="text-align: left;"><?= Yii::t('app', 'Status') ?></th>
