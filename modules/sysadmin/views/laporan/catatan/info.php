    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <?php
                if ($model->user_id == $_SESSION['__id']) {
                ?>
...
<script>
function edit(id){
    window.location = '<?= \yii\helpers\Url::toRoute('/sysadmin/laporan/catatanEdit?id=') ?>'+id;
}

function image(id){
	var url = '<?= \yii\helpers\Url::toRoute(['/sysadmin/laporan/catatanImage','id'=>'']) ?>'+id;
