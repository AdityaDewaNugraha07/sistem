    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Change Departement Data'); ?></h4>
            </div>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?= $form->field($model, 'departement_nama')->textInput(['onkeyup'=>'duplicateType(this,"'.\yii\bootstrap\Html::getInputId($model, 'departement_other').'")']); ?>
                        <?= $form->field($model, 'departement_other')->textInput(); ?>
