    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Departement Details'); ?></h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7"><strong><?= $model->departement_id ?></strong></div>
                        </div>
                        <div class="form-group col-md-12">
                            <label class="col-md-5 control-label"><?= $model->attributeLabels()['departement_nama'] ?></label>
                            <div class="col-md-7"><strong><?= $model->departement_nama ?></strong></div>
                        </div>
                        <div class="form-group col-md-12">
                            <label class="col-md-5 control-label"><?= $model->attributeLabels()['departement_other'] ?></label>
                            <div class="col-md-7"><strong><?= $model->departement_other ?></strong></div>
                        </div>
                        <div class="form-group col-md-12">
            ...
            <div class="modal-footer">
                <?= yii\helpers\Html::button(Yii::t('app', 'Edit'),['class'=>'btn blue btn-outline','onclick'=>"openModal('".\yii\helpers\Url::toRoute(['/sysadmin/departement/edit','id'=>$model->departement_id])."','modal-master-edit')"]); ?>
                <?= yii\helpers\Html::button(Yii::t('app', 'Delete'),['class'=>'btn red btn-outline','onclick'=>"openModal('".\yii\helpers\Url::toRoute(['/sysadmin/departement/delete','id'=>$model->departement_id,'tableid'=>'table-master'])."','modal-delete-record')"]); ?>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
