...
class PengumumanController extends DeltaBaseController
{
	...
	public function actionIndex(){
        if(\Yii::$app->request->get('dt')=='table-master'){
			$param['table']= \app\models\MPengumuman::tableName();
			$param['pk']= \app\models\MPengumuman::primaryKey()[0];
			$param['column'] = ['pengumuman_id','tipe','judul','seq','judul_pulsate',$param['table'].'.active'];
	...
	public function actionCreate(){
		if(\Yii::$app->request->isAjax){
			$model = new \app\models\MPengumuman();
			$model->active = true;
			if( Yii::$app->request->post('MPengumuman')){
    ...
    public function actionInfo($id){
		if(\Yii::$app->request->isAjax){
			$model = \app\models\MPengumuman::findOne($id);
