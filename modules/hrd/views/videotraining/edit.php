        ...
        <div class="portlet light bordered">
            <div class="portlet-body">
                <ul class="nav nav-tabs pull-right">
                    ...
                    <li class="active">
                        <a href="<?= yii\helpers\Url::toRoute("/hrd/videotraining/create"); ?>"> <?= Yii::t('app', 'Edit '.$this->title); ?> </a>
                    </li>
                </ul>
                <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="form-group field-TVideoTraining-video">
                                    ...
                                    <div class="col-md-9 input-video-container">
                                        <?php if(isset($model->video)): ?>
                                            <?php $no=1; foreach (Json::decode($model->video, true) as $video): ?>
                                                <?php if($no === 1):?>
                                                    <div class="input-group margin-bottom-5">
                                                        <input type="text" class="form-control" name="video[]" id="TVideoTraining-video" placeholder="Link Video di Google Drive" value="<?= $video['url']?>"/>
                                                ...
                                                <?php else:?>
                                                    <input type="text" class="form-control margin-bottom-5" name="video[]" placeholder="Tambah Link" value="<?= $video['url']?>"/>
                                                <?php endif?>
                                            <?php $no++; endforeach; ?>
                                        <?php else:?>
                                            <div class="input-group margin-bottom-5">
                                ...
                                <div class="form-group field-TVideoTraining-evaluasi_peserta">
                                    ...
                                    <div class="col-md-9 input-evaluasi-peserta-container">
                                        <?php if(isset($model->evaluasi_peserta)): ?>
                                            <?php $no=1; foreach (Json::decode($model->evaluasi_peserta, true) as $peserta): ?>
                                                <?php if($no === 1):?>
                                                    <div class="input-group margin-bottom-5">
                                                        <input type="text"
                                                               class="form-control"
                                                               name="evaluasi_peserta[]"
                                                               id="TVideoTraining-evaluasi_peserta"
                                                               placeholder="Link untuk evaluasi peserta training"
                                                               value="<?= $peserta['url'] ?>"/>
                                                ...
                                                <?php else:?>
                                                    <input type="text" class="form-control margin-bottom-5" name="evaluasi_peserta[]" placeholder="Tambah Link" value="<?= $peserta['url']?>"/>
                                                <?php endif?>
                                                <?php $no++; endforeach; ?>
                                        <?php else:?>
                                            <div class="input-group margin-bottom-5">
                                ...
                                <div class="form-group field-TVideoTraining-evaluasi_atasan">
                                    ...
                                    <div class="col-md-9 input-evaluasi-atasan-container">
                                        <?php if(isset($model->evaluasi_atasan)): ?>
                                            <?php $no=1; foreach (Json::decode($model->evaluasi_atasan, true) as $atasan): ?>
                                                <?php if($no === 1):?>
                                                    <div class="input-group margin-bottom-5">
                                                        <input type="text" class="form-control" name="evaluasi_atasan[]" id="TVideoTraining-evaluasi_atasan" placeholder="Link untuk evaluasi dari atasan" value="<?= $atasan['url']?>"/>
                                                ...
                                                <?php else:?>
                                                    <input type="text" class="form-control margin-bottom-5" name="evaluasi_atasan[]" placeholder="Tambah Link" value="<?= $atasan['url']?>"/>
                                                <?php endif?>
                                                <?php $no++; endforeach; ?>
                                        <?php else:?>
                                            <div class="input-group margin-bottom-5">
