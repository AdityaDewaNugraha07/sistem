...
?>
<div class="modal fade" id="modal-jobdesc-create" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog modal-full">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn btn-icon-only btn-default fa fa-close" data-dismiss="modal" aria-hidden="true" style="float: right; padding-top: 2px; padding-bottom: 2px;"></button>
                <h4 class="modal-title"><?= Yii::t('app', 'Tambahkan Jobdesc Pegawai'); ?></h4>
            </div>
...
function save(){
    ...
    if(formrequiredvalidate($form)){
        if($('#tjobdesc-file').val()){
            submitformajax($form,"$(\'#modal-jobdesc-create\').modal(\'hide\'); $(\'#table-jobdesc\').dataTable().fnClearTable();");
        } else {
