    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
				...
				<h4 class="modal-title" style="font-weight: bold;"><?= Yii::t('app', 'Approval Harga Produk ').'<b>'.\app\components\DeltaGlobalClass::getBerkasNamaByBerkasKode($model->reff_no).'</b>'; ?> <?php echo $produk_group;?></h4>
			</div>
