            ...
            <div class="portlet-body">
                <ul class="nav nav-tabs">
                    <li class="<?php echo $status1;?>">
						<a href="<?= yii\helpers\Url::toRoute("/topmanagement/approvalrejectpenerimaankayuolahan/index"); ?>"> <?= Yii::t('app', 'Not Confirmed'); ?> </a>
                    </li>
					<li class="<?php echo $status2;?>">
						<a href="<?= \yii\helpers\Url::toRoute("/topmanagement/approvalrejectpenerimaankayuolahan/indexConfirmed") ?>"> <?= Yii::t('app', 'Confirmed'); ?> </a>
					</li>
                </ul>
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="table-master">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="line-height: 1;"><?= Yii::t('app', 'Nomor Produksi') ?></th>
...
setMenuActive('".json_encode(app\models\MMenu::getMenuByCurrentURL('Approve Reject Penerimaan Kayu Olahan'))."');
", yii\web\View::POS_READY);
?>
<?php $url = \yii\helpers\Url::toRoute('/topmanagement/approvalrejectpenerimaankayuolahan/'.$this->context->action->id); ?>
<script>
function dtMaster(){
...
function info(id){
	openModal('<?= \yii\helpers\Url::toRoute(['/topmanagement/approvalrejectpenerimaankayuolahan/info','id'=>'']) ?>'+id,'modal-master-info','50%'," $('#table-master').dataTable().fnClearTable(); ");
}
