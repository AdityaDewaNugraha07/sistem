...
$this->title = 'Approval Dinas Grader';
            ...
            <div class="portlet-body">
                <ul class="nav nav-tabs">
                    <li class="<?php echo $status1;?>">
						<a href="<?= yii\helpers\Url::toRoute("/topmanagement/approvaldinasgrader/index"); ?>"> <?= Yii::t('app', 'Approval Dinas Grader Not Confirmed'); ?> </a>
                    </li>
					<li class="<?php echo $status2;?>">
						<a href="<?= \yii\helpers\Url::toRoute("/topmanagement/approvaldinasgrader/indexConfirmed") ?>"> <?= Yii::t('app', 'Approval Dinas Grader Confirmed'); ?> </a>
					</li>
                </ul>
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="table-master">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="line-height: 1;">Tipe</th>
                                            <th style="line-height: 1;">Jenis Log</th>
...
setMenuActive('".json_encode(app\models\MMenu::getMenuByCurrentURL('Approval Dinas Grader'))."');"
, yii\web\View::POS_READY);
?>
<?php $url = \yii\helpers\Url::toRoute('/topmanagement/approvaldinasgrader/'.$this->context->action->id); ?>
<script>
function dtMaster(){
...
function info(id){
	openModal('<?= \yii\helpers\Url::toRoute(['/topmanagement/approvaldinasgrader/info','id'=>'']) ?>'+id,'modal-master-info','95%'," $('#table-master').dataTable().fnClearTable(); ");
}
