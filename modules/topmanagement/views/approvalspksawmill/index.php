...
$this->title = 'Approval SPK Sawmill';
            ...
            <div class="portlet-body">
                <ul class="nav nav-tabs">
                    <li class="<?php echo $status1;?>">
						<a href="<?= yii\helpers\Url::toRoute("/topmanagement/approvalspksawmill/index"); ?>"> <?= Yii::t('app', 'Not Confirmed'); ?> </a>
                    </li>
					<li class="<?php echo $status2;?>">
						<a href="<?= \yii\helpers\Url::toRoute("/topmanagement/approvalspksawmill/indexConfirmed") ?>"> <?= Yii::t('app', 'Confirmed'); ?> </a>
					</li>
                </ul>                
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
									<?= Yii::t('app', 'Daftar Approval SPK Sawmill'); ?>
                                </div>
                                <div class="tools">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="table-master">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="line-height: 1;"><?= Yii::t('app', 'Tanggal Berkas') ?></th>
                                            <th style="line-height: 1;"><?= Yii::t('app', 'Tanggal Mulai') ?></th>
                                            <th style="line-height: 1;"><?= Yii::t('app', 'Tanggal Selesai') ?></th>
...
<?php $this->registerJs(" formconfig(); dtMaster(); setMenuActive('".json_encode(app\models\MMenu::getMenuByCurrentURL('Approval SPK Sawmill'))."');", yii\web\View::POS_READY); ?>
<?php $url = \yii\helpers\Url::toRoute('/topmanagement/approvalspksawmill/'.$this->context->action->id); ?>
<script>
function dtMaster(){
...
function info(id){
	openModal('<?= \yii\helpers\Url::toRoute(['/topmanagement/approvalspksawmill/info','id'=>'']) ?>'+id,'modal-master-info','95%'," $('#table-master').dataTable().fnClearTable(); ");
}
</script>