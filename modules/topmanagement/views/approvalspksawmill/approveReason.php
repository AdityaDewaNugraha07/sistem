    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Setuju SPK Sawmill'); ?></h4>
            </div>
            <div class="modal-body">
				<div class="row">
                    <div class="col-md-12">
                        <p style="font-weight: 300"><?= Yii::t('app', 'Inputkan alasan anda menyetujui SPK Sawmill <b>'.$modelReff->kode.'</b>'); ?></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
