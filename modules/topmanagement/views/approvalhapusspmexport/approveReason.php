<div class="modal fade" id="modal-transaksi" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <?php use app\models\TPengajuanManipulasi;
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Persetujuan Hapus SPM Export') ?></h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php /** @var TPengajuanManipulasi $modelReff */
                        echo $form->field($modelReff, 'reason_approval')->textarea(['placeholder' => 'Ketik Keterangan', 'value' => ''])->label(Yii::t('app', 'Keterangan ')); ?>
                    </div>
                </div>
            </div>
