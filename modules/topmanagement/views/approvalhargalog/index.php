            ...
            <div class="portlet-body">
                <ul class="nav nav-tabs">
                    <li class="<?php echo $status1;?>">
						<a href="<?= yii\helpers\Url::toRoute("/topmanagement/approvalhargalog/index"); ?>"> <?= Yii::t('app', 'Not Confirmed'); ?> </a>
                    </li>
					<li class="<?php echo $status2;?>">
						<a href="<?= \yii\helpers\Url::toRoute("/topmanagement/approvalhargalog/indexConfirmed") ?>"> <?= Yii::t('app', 'Confirmed'); ?> </a>
					</li>
                </ul>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
									<?= Yii::t('app', 'Daftar Pengajuan Update Data Harga Log'); ?>
                                </div>
                                <div class="tools">
...
setMenuActive('".json_encode(app\models\MMenu::getMenuByCurrentURL('Approval Harga Log'))."');
", yii\web\View::POS_READY); 
?>

<?php $url = \yii\helpers\Url::toRoute('/topmanagement/approvalhargalog/'.$this->context->action->id); ?>
...
function info(id){
	openModal('<?= \yii\helpers\Url::toRoute(['/topmanagement/approvalhargalog/info','id'=>'']) ?>'+id,'modal-master-info','80%'," $('#table-master').dataTable().fnClearTable(); ");
}
</script>