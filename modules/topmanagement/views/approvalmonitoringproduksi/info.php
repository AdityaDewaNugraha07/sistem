    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Approval Monitoring Produksi') ?></h4>
            </div>
...
<script>
    function approve(id) {
        $(".modals-place-2").load('<?= Url::toRoute(['/topmanagement/approvalmonitoringproduksi/approveReason', 'id' => '']) ?>' + id, function () {
    ...
    function reject(id) {
        $(".modals-place-2").load('<?= Url::toRoute(['/topmanagement/approvalmonitoringproduksi/rejectReason', 'id' => '']) ?>' + id, function () {
            const modTarns = $("#modal-transaksi");
            modTarns.modal('show');
            modTarns.on('hidden.bs.modal', function () {
                modTarns.hide();
