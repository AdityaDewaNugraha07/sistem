...
<?php
// 2020-09-09 tambahan approval kadiv purchasing log : TATANG 
$today = date("Y-m-d");
$tanggal_tatang = "2020-09-09";

if ($today >= $tanggal_tatang) {
	$periode_tatang = 1;
} else {
	$periode_tatang = 0;
}
...
if($modReff->jenis_log == "LA"){
    $jnsLog = 'Log Alam';
}else if($modReff->jenis_log == "LS"){
    $jnsLog = 'Log Sengon';
}else if($modReff->jenis_log == "LJ"){
    $jnsLog = 'Log Jabon';
}else{
    $jnsLog = '-';
}
	...
	<div class="row" style="margin-bottom: 10px;">
		<div class="col-md-6">
			...
			<div class="form-group col-md-12">
                ...
                <div class="col-md-7"><strong><?= $jnsLog ?></strong></div>
			</div>
			<div class="form-group col-md-12">
		...
		<div class="col-md-12">
			<div class="portlet box blue-hoki bordered">
				<div class="portlet-title">
					...
					<div class="caption"> <?= Yii::t('app', 'Show Detail Permintaan'); ?> <?= $jnsLog ?> </div>
				</div>
						...
						<div class="col-md-4">
							<table style="width: 100%; font-size: 1.1rem;">
								...
								<tr>
									...
									if ($periode_tatang == 1) {
									?>
									<td style="width: 30%; vertical-align: top; padding: 3px;"><?= ($modReff->tujuan == "INDUSTRI")?"GM Opr":"Kadiv Purchasing Log" ?></td>
									<?php
									} else {
									?>
                        ...
                        <div class="col-md-4">
							...
							<table style="width: 100%; font-size: 1.1rem;">
								<tr>
									...
									if ($periode_tatang == 1) {
									?>
									<td style="width: 30%; vertical-align: top; padding: 3px;"><?= ($modReff->tujuan == "INDUSTRI")?"Dirut":"Dirut" ?></td>
									<?php
									} else {
									?>
