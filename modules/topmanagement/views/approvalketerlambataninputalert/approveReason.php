    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Persetujuan Keterlambatan Input Alert Piutang'); ?></h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <p style="font-weight: 300"><?= Yii::t('app', 'Nomor Penjualan <b>'.$modelReff->piutang_nomor_nota.'</b>'); ?></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <?php echo $form->field($modelReff, 'approve_reason')->textarea(['placeholder'=>'Ketik Keterangan','value'=>''])->label(Yii::t('app', 'Keterangan ')); ?>
                    </div>
                </div>
            </div>
