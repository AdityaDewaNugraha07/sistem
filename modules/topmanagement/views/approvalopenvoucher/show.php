		...
		<div class="col-md-6">
			...
			<div class="form-group col-md-12">
                ...
                if($modReff->tipe == "REGULER"){
					if($modReff->penerima_voucher_id !== null){
						...
						$modPegawai = \app\models\MPegawai::findOne($modReff->pegawai_id);
						$modDept = \app\models\MDepartement::findOne($modPegawai->departement_id);
						echo $modPegawai->pegawai_nama." (".$modDept->departement_nama.")";
					}
                }else if($modReff->tipe == "PEMBAYARAN LOG ALAM"){
					if($modReff->penerima_reff_id !== null){
					...
					echo "<br>";
                    echo '<a id="btn-reff-1" class="btn btn-outline btn-xs purple" onclick="detailKeputusan(\''.$modReff->reff_no.'\')"><i class="icon-tag"></i> Lihat PO</a>';
                ...
                }else if($modReff->tipe == "PEMBAYARAN ASURANSI LOG SHIPPING"){
					if($modReff->penerima_reff_table == "t_asuransi"){
						$modAsuransi = \app\models\TAsuransi::findOne(['kode'=>$modReff->reff_no]);
						echo $modAsuransi->kepada;
					}else{
						$modPegawai = \app\models\MPegawai::findOne($modReff->pegawai_id);
						$modDept = \app\models\MDepartement::findOne($modPegawai->departement_id);
						echo $modPegawai->pegawai_nama." (".$modDept->departement_nama.")";
					...
					echo "<br>";
                    echo '<a id="btn-reff-1" class="btn btn-outline btn-xs purple" onclick="detailAsuransi(\''.$modReff->reff_no.'\')"><i class="icon-tag"></i> Lihat Detail</a>';
				}
                ?></strong></div>
			</div>
			<div class="form-group col-md-12">
				<label class="col-md-5 control-label"><?= Yii::t('app', 'Penerima QQ'); ?></label>
                <div class="col-md-7"><strong><?php echo nl2br($modReff->penerima_voucher_qq); ?></strong></div>
			</div>
		</div>
		<div class="col-md-6">
            <div class="form-group col-md-12">
				<label class="col-md-5 control-label text-danger text-bold"><?= Yii::t('app', 'Total Pembayaran'); ?></label>
                <div class="col-md-7 text-danger text-bold"><strong><?= ($modReff->mata_uang == "IDR")?number_format($modReff->total_pembayaran):app\components\DeltaFormatter::formatNumberForUserFloat($modReff->total_pembayaran, 2); ?></strong></div>
			</div>
            <div class="form-group col-md-12">
			...
			<div class="form-group col-md-12">
                ...
                <div class="col-md-7"><strong><?= $modReff->preparedBy->pegawai_nama; ?></strong></div>
			</div>
			<div class="form-group col-md-12">
								...
								<table class="table table-striped table-bordered table-advance table-hover" style="width: 100%" id="table-detail">
                                    ...
                                    <tbody>
										...
										?>
                                            <tr>
                                                ...
                                                <td style="text-align: right;"><?= ($modReff->mata_uang == "IDR")?number_format($detail->nominal):app\components\DeltaFormatter::formatNumberForUserFloat($detail->nominal, 2); ?></td>
                                                <td style="text-align: right;"><?= ($modReff->mata_uang == "IDR")?number_format($detail->ppn):app\components\DeltaFormatter::formatNumberForUserFloat($detail->ppn, 2); ?></td>
                                                <td style="text-align: right;"><?= ($modReff->mata_uang == "IDR")?number_format($detail->pph):app\components\DeltaFormatter::formatNumberForUserFloat($detail->pph, 2); ?></td>
                                                <td style="text-align: right;"><?= ($modReff->mata_uang == "IDR")?number_format($detail->subtotal):app\components\DeltaFormatter::formatNumberForUserFloat($detail->subtotal, 2); ?></td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle; text-align: right;"><?= ($modReff->mata_uang == "IDR")?number_format($modReff->total_dpp):app\components\DeltaFormatter::formatNumberForUserFloat($modReff->total_dpp, 2) ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" style="vertical-align: middle; text-align: right;">Total PPN </td>
                                            <td style="vertical-align: middle; text-align: right;"><?= ($modReff->mata_uang == "IDR")?number_format($modReff->total_ppn):app\components\DeltaFormatter::formatNumberForUserFloat($modReff->total_ppn, 2) ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" style="vertical-align: middle; text-align: right;">Total PPh </td>
                                            <td style="vertical-align: middle; text-align: right;"><?= ($modReff->mata_uang == "IDR")?number_format($modReff->total_pph):app\components\DeltaFormatter::formatNumberForUserFloat($modReff->total_pph, 2) ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" style="vertical-align: middle; text-align: right;">Potongan </td>
                                            <td style="vertical-align: middle; text-align: right;"><?= ($modReff->mata_uang == "IDR")?number_format($modReff->total_potongan):app\components\DeltaFormatter::formatNumberForUserFloat($modReff->total_potongan, 2) ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" style="vertical-align: middle; text-align: right;">Biaya Tambahan </td>
                                            <td style="vertical-align: middle; text-align: right;"><?= ($modReff->mata_uang == "IDR")?number_format($modReff->biaya_tambahan):app\components\DeltaFormatter::formatNumberForUserFloat($modReff->biaya_tambahan, 2) ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" style="vertical-align: middle; text-align: right;" class="font-red-flamingo">TOTAL PEMBAYARAN</td>
                                            <td style="vertical-align: middle; text-align: right;" class="font-red-flamingo"><?= ($modReff->mata_uang == "IDR")?number_format($modReff->total_pembayaran):app\components\DeltaFormatter::formatNumberForUserFloat($modReff->total_pembayaran, 2) ?></td>
                                        </tr>
                                    </tfoot>
                                </table>
							</div>
