...
$this->title = 'Approval PO Log Sengon/Jabon';
            ...
            <div class="portlet-body">
                <ul class="nav nav-tabs">
                    <li class="<?php echo $status1;?>">
						<a href="<?= yii\helpers\Url::toRoute("/topmanagement/approvalposengon/index"); ?>"> <?= Yii::t('app', 'Not Confirmed'); ?> </a>
                    </li>
					<li class="<?php echo $status2;?>">
						<a href="<?= \yii\helpers\Url::toRoute("/topmanagement/approvalposengon/indexConfirmed") ?>"> <?= Yii::t('app', 'Confirmed'); ?> </a>
					</li>
                </ul>                
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="table-master">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="line-height: 1;"><?= Yii::t('app', 'Tanggal<br>Rencana') ?></th>
                                            <th style="line-height: 1;"><?= Yii::t('app', 'Periode Kebutuhan') ?></th>
                                            <th style="line-height: 1;"><?= Yii::t('app', 'Periode Pengiriman') ?></th>
...
<?php $this->registerJs("setMenuActive('".json_encode(app\models\MMenu::getMenuByCurrentURL('Approval PO Log Sengon'))."',15); formconfig(); dtMaster(); ", yii\web\View::POS_READY); ?>
<?php $url = \yii\helpers\Url::toRoute('/topmanagement/approvalposengon/'.$this->context->action->id); ?>
<script>
function dtMaster(){
...
function info(id){
	openModal('<?= \yii\helpers\Url::toRoute(['/topmanagement/approvalposengon/info','id'=>'']) ?>'+id,'modal-master-info','95%'," $('#table-master').dataTable().fnClearTable(); ");
}
</script>