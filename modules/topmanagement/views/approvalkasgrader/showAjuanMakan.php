	...
	<div class="row" style="margin-bottom: 10px;">
		<div class="col-md-6">
			<div class="form-group col-md-12">
				...
				<div class="col-md-7">
                    ...
                    <a class="btn btn-xs btn-outline blue-hoki" id="btn-info" onclick="infoFormPengajuanMakan(<?= $modReff->ajuanmakan_grader_id ?>);"><i class="fa fa-info-circle"></i></a>
                    </strong>
                </div>
			</div>
			<div class="form-group col-md-12">
		...
		<div class="col-md-6">
			...
			<div class="form-group col-md-12">
				...
				<div class="col-md-7"><strong><?= $modReff->wilayahDinas->wilayah_dinas_nama ?></strong></div>
			</div>
			<div class="form-group col-md-12">
				<label class="col-md-5 control-label"><?= Yii::t('app', 'Uang Makan'); ?></label>
				<div class="col-md-7"><strong><?= \app\components\DeltaFormatter::formatNumberForUserFloat($modReff->wilayah_dinas_makan)." x ".\app\components\DeltaFormatter::formatNumberForUserFloat($modReff->qty_hari)." Hari" ?></strong></div>
			</div>
			<div class="form-group col-md-12">
				<label class="col-md-5 control-label"><?= Yii::t('app', 'Uang Pulsa'); ?></label>
				<div class="col-md-7"><strong><?= \app\components\DeltaFormatter::formatNumberForUserFloat($modReff->wilayah_dinas_pulsa) ?></strong></div>
			</div>
			<div class="form-group col-md-12">
		...
		<div class="col-md-12">
			<div class="portlet box blue-hoki bordered">
				<div class="portlet-title">
					...
					<div class="caption"> <?= Yii::t('app', 'Show Realisasi Uang Makan Grader'); ?> </div>
				</div>
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td>
													<a class="btn btn-xs btn-outline blue-hoki" id="btn-info" onclick="detailRealisasiMakan(<?= $detail->realisasimakan_grader_id ?>);"><i class="fa fa-info-circle"></i></a>
												</td>
											</tr>
										<?php
											}
...
<script>
function infoFormPengajuanMakan(id){
