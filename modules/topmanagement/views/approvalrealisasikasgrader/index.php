...
$status == 'UMConfirmed' ? $status3 = 'active' : $status3 = '';
$status == 'UMNotConfirmed' ? $status4 = 'active' : $status4 = '';
            ...
            <div class="portlet-body">
                <ul class="nav nav-tabs">
					...
					<li class="<?php echo $status3;?>">
						<a href="<?= \yii\helpers\Url::toRoute("/topmanagement/approvalrealisasimakangrader/index") ?>"> <?= Yii::t('app', 'Uang Makan Confirmed'); ?> </a>
					</li>
...
?>
<?php $url = \yii\helpers\Url::toRoute('/topmanagement/approvalrealisasikasgrader/'.$this->context->action->id); ?>
<script>
function dtMaster(){
...
function info(id){
	openModal('<?= \yii\helpers\Url::toRoute(['/topmanagement/approvalrealisasikasgrader/info','id'=>'']) ?>'+id,'modal-master-info','70%'," $('#table-master').dataTable().fnClearTable(); ");
}
