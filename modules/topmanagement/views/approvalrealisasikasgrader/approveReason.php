    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title text-bold text-success"><?= Yii::t('app', 'Approve'); ?></h4>
            </div>
            <div class="modal-body">
				<div class="row">
                    <div class="col-md-12">
                        <p style="font-weight: 300"><?= Yii::t('app', 'Inputkan alasan anda menyetujui hasil orientasi <b>'.$modRDG->kode.'</b>'); ?></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <?php echo $form->field($modRDG, 'approve_reason')->textarea(['placeholder'=>'Ketik alasan','value'=>''])->label(Yii::t('app', 'Alasan')); ?>
                    </div>
                </div>
            </div>
