    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
				<div class="row">
                    <div class="col-md-12">
                        <p style="font-weight: 300"><?= /** @var MCustomer $modelMCustomer */
                            Yii::t('app', 'Inputkan alasan anda menyetujui customer ini <b>'.$modelMCustomer->kode_customer.'</b>'); ?></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <?= $form->field($modelMCustomer, 'approve_reason')->textarea(['placeholder'=>'Ketik alasan','value'=>''])->label(Yii::t('app', 'Alasan')); ?>
                    </div>
                </div>
            </div>
