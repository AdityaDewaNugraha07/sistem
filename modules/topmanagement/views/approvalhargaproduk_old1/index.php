...
$this->title = 'Approval Harga Produk';
            ...
            <div class="portlet-body">
                <ul class="nav nav-tabs">
                    <li class="<?php echo $status1;?>">
						<a href="<?= yii\helpers\Url::toRoute("/topmanagement/approvalhargaproduk/index"); ?>"> <?= Yii::t('app', 'Not Confirmed'); ?> </a>
                    </li>
					<li class="<?php echo $status2;?>">
						<a href="<?= \yii\helpers\Url::toRoute("/topmanagement/approvalhargaproduk/indexConfirmed") ?>"> <?= Yii::t('app', 'Confirmed'); ?> </a>
					</li>
                </ul>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
									<?= Yii::t('app', 'Daftar Pengajuan Update Data Harga Produk'); ?>
                                </div>
                                <div class="tools">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="table-master">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="line-height: 1;"><?= Yii::t('app', 'Jenis Produk') ?></th>
...
setMenuActive('".json_encode(app\models\MMenu::getMenuByCurrentURL('Approval Harga Produk'))."');
", yii\web\View::POS_READY); 
?>

<?php $url = \yii\helpers\Url::toRoute('/topmanagement/approvalhargaproduk/'.$this->context->action->id); ?>
...
function info(id){
	openModal('<?= \yii\helpers\Url::toRoute(['/topmanagement/approvalhargaproduk/info','id'=>'']) ?>'+id,'modal-master-info','80%'," $('#table-master').dataTable().fnClearTable(); ");
}
</script>