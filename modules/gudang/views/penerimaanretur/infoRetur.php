    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group col-md-12">
                            <label class="col-md-5 control-label"><?= Yii::t('app', 'Gudang Penerimaan'); ?></label>
                            <div class="col-md-7" style="margin-top: 5px;"><strong>
								<?php 
								if($modDetails[0]['gudang_id']){
									$modGudang = app\models\MGudang::findOne($modDetails[0]['gudang_id']); 
									echo $modGudang->gudang_nm;
								} else {
									echo '-';
								}
								?>
								...
								<tbody>
									...
									if(!empty($modDetails)){
										foreach($modDetails as $i => $detail){
											...
											echo 	"<td>
														<a href='javascript:void(0);' onclick='cetakLabel(".$detail->retur_produk_detail_id.");' class='label label-info' style='font-size: 1.0rem;'>
															<i class='fa fa-download'></i> CETAK LABEL
														</a>
													 </td>";
											echo "</tr>";
            ...
            <div class="modal-footer text-align-center">
				<?php 
					// echo \yii\helpers\Html::button( Yii::t('app', 'Terima'),['class'=>'btn hijau btn-outline ciptana-spin-btn',
...
function cetakLabel(detail_id){
	window.open("<?= yii\helpers\Url::toRoute('/gudang/penerimaanretur/cetakLabel') ?>?id="+detail_id+"&caraprint=PRINT","",'location=_new, width=1200px, scrollbars=yes');
}
</script>