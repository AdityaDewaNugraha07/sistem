...
// $this->title = 'Laporan Persediaan Barang Retur Yang Belum Diterima';
$this->title = 'Laporan Permintaan Penanganan Retur Barang Belum Dikirim Oleh Gudang';
...
function dtLaporan(){
    var dt_table =  $('#table-laporan').dataTable({
		pageLength: 100,
        ajax: { 
			url: '<?= \yii\helpers\Url::toRoute('/gudang/laporan/returblmdikirimgudang') ?>',
			data:{
				dt: 'table-laporan',
...
function printout(caraPrint){
	window.open("<?= yii\helpers\Url::toRoute('/gudang/laporan/returblmdikirimgudangPrint') ?>?"+$('#form-search-laporan').serialize()+"&caraprint="+caraPrint,"",'location=_new, width=1200px, scrollbars=yes');
}
