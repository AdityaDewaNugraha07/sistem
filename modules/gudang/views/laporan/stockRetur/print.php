                        ...
                        <div class="portlet">
                            <div class="portlet-body">
                                <table class="table table-striped table-bordered table-hover" id="table-laporan">
									...
									<tbody>
										<?php
										$sql = $model->searchLaporanStock()->createCommand()->rawSql;
										...
										if(count($contents)>0){ 
											...
											<tr>
												...
												<td class="text-align-center"><?= $data['produk_dimensi'] ?></td>
												<td class="text-align-center"><?= $data['palet'] ?></td>
												<td class="text-align-right"><?= $data['qty_kecil'] ?></td>
												<td class="text-align-right"><?php echo number_format($data['kubikasi'],4); ?></td>
											</tr>
										<?php }
										}else{?>
											<tr>
												<td colspan="7" class="text-align-center"><?= Yii::t('app', 'Data tidak ditemukan'); ?></td>
											</tr>
										<?php } ?>
									</tbody>
                                </table>
