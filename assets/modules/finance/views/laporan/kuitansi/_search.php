				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							...
							<?= $form->field($model, 'cara_bayar')->dropDownList(\app\models\MDefaultValue::getOptionList('cara-bayar-voucher-penerimaan'),['prompt'=>'All'])->label(Yii::t('app', 'Cara Bayar')); ?>
						</div>
						<div class="col-md-5">
							<?= $form->field($model, 'terima_dari')->textInput()->label(Yii::t('app', 'Terima Dari')); ?>
							<?= $form->field($model, 'untuk_pembayaran')->textInput()->label(Yii::t('app', 'Untuk Pembayaran')); ?>
						</div>
					</div>
