...
function openCustomerPiutang(type){
	if(type == 'export'){
		var url = "<?= \yii\helpers\Url::toRoute(['/finance/piutangpenjualan/openCustomerPiutangExport']); ?>";
	}else if(type == 'lokal'){
		var url = "<?= \yii\helpers\Url::toRoute(['/finance/piutangpenjualan/openCustomerPiutang']); ?>";
	}
