...
function updateStatus(ele,status,pengajuan_tagihan_id=null,alasantolak=null){
    ...
    $.ajax({
		...
		type   : 'POST',
		data   : { pengajuan_tagihan_id: pengajuan_tagihan_id, status:status, alasantolak:alasantolak},
		success: function (data) {
