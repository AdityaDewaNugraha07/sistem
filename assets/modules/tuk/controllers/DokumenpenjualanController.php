	...
	public function actionOpenSPMTernota(){
		if(\Yii::$app->request->isAjax){
			if(\Yii::$app->request->get('dt')=='table-spm'){
				...
				$param['where']=$param['table'].".cancel_transaksi_id IS NULL AND t_nota_penjualan.spm_ko_id NOT IN( SELECT spm_ko_id FROM t_dokumen_penjualan ) AND ".$param['table'].".jenis_produk NOT IN('Limbah') AND op_ko_id != 999999 ";
