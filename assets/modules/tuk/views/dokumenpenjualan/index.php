                            ...
                            <div class="portlet-body">
                                <div class="row">
                                    <div class="col-md-6">
										...
										<?= $form->field($model, 'cust_an_alamat')->textarea(['disabled'=>'disabled'])->label("Alamat Perusahaan") ?>
	...
	$.ajax({
        ...
        success: function (data) {
			...
			if(data.spm_ko_id){
				...
				if(data.jenis_produk == "Plywood" || data.jenis_produk == "Moulding" || data.jenis_produk == "Lamineboard" || data.jenis_produk == "Platform" ||  data.jenis_produk == "JasaMoulding"){
