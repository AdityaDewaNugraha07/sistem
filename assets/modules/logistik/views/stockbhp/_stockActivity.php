...
<div class="table-scrollable">
	<table class="table table-striped table-bordered table-advance table-hover">
		...
		<?php if($i == 0){ ?>
		<tr>
			<td class="td-kecil text-align-right" colspan="5"><b>SALDO AWAL </b> &nbsp; </td>
			<td class="td-kecil text-align-right"><b><?= app\components\DeltaFormatter::formatNumberForUserFloat($saldoawal) ?></b></td>
		</tr>
		<?php } ?>
		<tr>
