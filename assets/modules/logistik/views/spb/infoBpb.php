<div class="modal fade" id="modal-terima-bpb" tabindex="-1" role="basic" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
				<?php if($model->bpb_status == "BELUM DITERIMA"){ ?>
					<?= yii\helpers\Html::button(Yii::t('app', '<i class="fa fa-download"></i> Terima BPB'),['class'=>'btn hijau btn-outline ciptana-spin-btn','onclick'=>"terimaBarang()"]); ?>
				<?php } ?>
            </div>
        </div>
        <!-- /.modal-content -->
...
//	var bpb_id = <?= $model->bpb_id ?>;
//	$.ajax({
//        url    : '<?= \yii\helpers\Url::toRoute(['/logistik/spb/infoBpb']); ?>',
//        type   : 'GET',
...
function abortItem(id,bpb_id){
	var url = '<?= \yii\helpers\Url::toRoute(['/logistik/bpb/abortItem','id'=>'']); ?>'+id+"&bpb_id="+bpb_id;
