...
class ApprovaldiskonController extends DeltaBaseController
{
	public function actionIndex(){
        if(\Yii::$app->request->get('dt')=='table-master'){
			...
			$param['where'] = "(reff_no ILIKE '%PNP%') OR (reff_no ILIKE '%VNP%') OR (reff_no ILIKE '%SNP%') OR (reff_no ILIKE '%MNP%') OR (reff_no ILIKE '%LNP%') OR (reff_no ILIKE '%BNP%') OR (reff_no ILIKE '%FNP%') OR (reff_no ILIKE '%HNP%') OR (reff_no ILIKE '%KNP%') OR (reff_no ILIKE '%GNP%') OR (reff_no ILIKE '%DNP%')";
