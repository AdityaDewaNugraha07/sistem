...
$this->title = 'Approval Permintaan Barang Jadi';
...
<?php $this->registerJs(" dtMaster(); setMenuActive('".json_encode(app\models\MMenu::getMenuByCurrentURL('Approve Permintaan Barang Jadi'))."');", yii\web\View::POS_READY); ?>
