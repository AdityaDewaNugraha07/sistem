...
<?php $this->registerJs(" dtMaster(); setMenuActive('".json_encode(app\models\MMenu::getMenuByCurrentURL('Approve PO Bahan Pembantu'))."');", yii\web\View::POS_READY); ?>
...
function infoPenawaran(id){
	var url = '<?= \yii\helpers\Url::toRoute(['/purchasing/penerimaanspp/infoPenawaran','id'=>'']) ?>'+id+'&disableAction=1';
