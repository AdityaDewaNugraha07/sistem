...
//													echo "<td class='text-align-center'>".$modQty['qty_btg']."</td>";
													echo "<td class='text-align-right'>".\app\components\DeltaFormatter::formatNumberForUserFloat($modQty['qty_m3'],4)."</td>";
...
//												echo "<td class='text-align-center'>".$subtotal_btg."</td>";
												echo "<td class='text-align-right'>".\app\components\DeltaFormatter::formatNumberForUserFloat($subtotal_m3,4)."</td>";
									...
									<tfoot>
										<tr>
											...
											<td  class="text-align-right">
												<?= \app\components\DeltaFormatter::formatNumberForUserFloat($total_ver_m3[$range],4); ?>
											</td>
											<td  class="text-align-right">
											...
											<td class="text-align-right"> <?= \app\components\DeltaFormatter::formatNumberForUserFloat($total_m3,4) ?> </td>
...
//												echo "<td class='text-align-center'>".$subtotal_btg."</td>";
									...
									<tfoot>
										<tr>
											...
											<!--<td  class="text-align-center"><?php // echo $total_ver_btg[$range]; ?></td>-->
											<td  class="text-align-right">
												<?php echo \app\components\DeltaFormatter::formatNumberForUserFloat($total_ver_m3[$range],4); ?>
											</td>
											<td  class="text-align-right">
