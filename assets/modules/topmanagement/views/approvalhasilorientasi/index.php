                            ...
                            <div class="portlet-body">
                                <table class="table table-striped table-bordered table-hover" id="table-master">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th style="line-height: 1;text-align: left;"><?= Yii::t('app', 'Kode<br>Orientasi') ?></th>
                                            <th style="line-height: 1;"><?= Yii::t('app', 'Tanggal<br>Berkas') ?></th>
                                            <th style="line-height: 1;text-align: left;"><?= Yii::t('app', 'Nama IUPHHK') ?></th>
                                            <th style="line-height: 1;text-align: left;"><?= Yii::t('app', 'Nama IPK') ?></th>
                                            <th style="line-height: 1;text-align: left;"><?= Yii::t('app', 'Lokasi Muat') ?></th>
                                            <th style="line-height: 1;"><?= Yii::t('app', 'RKT/Thn') ?></th>
                                            <th style="line-height: 1;text-align: left;"><?= Yii::t('app', 'Assign To') ?></th>
                                            <th style="line-height: 1;text-align: left;"><?= Yii::t('app', 'Approved By') ?></th>
