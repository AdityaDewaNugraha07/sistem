	...
	<div class="row" style="margin-bottom: 10px;">
		<div class="col-md-6">
            ...
            <div class="form-group col-md-12">
				...
				<div class="col-md-7"><strong><?= \app\models\MPegawai::findOne($modReff->penanggungjawab)->pegawai_nama ?></strong></div>
			</div>
            <div class="form-group col-md-12">
				<label class="col-md-5 control-label"><?= Yii::t('app', 'Menyetujui Kadiv FAT'); ?></label>
				<div class="col-md-7"><strong><?= \app\models\MPegawai::findOne($modReff->by_kadivacc)->pegawai_nama ?></strong></div>
			</div>
            <div class="form-group col-md-12">
				<label class="col-md-5 control-label"><?= Yii::t('app', 'Mengetahui Kanit Gudang'); ?></label>
				<div class="col-md-7"><strong><?= \app\models\MPegawai::findOne($modReff->by_kanitgud)->pegawai_nama ?></strong></div>
			</div>
            <div class="form-group col-md-12">
				<label class="col-md-5 control-label"><?= Yii::t('app', 'Mengetahui Kadiv MKT'); ?></label>
				<div class="col-md-7"><strong><?= \app\models\MPegawai::findOne($modReff->by_kadivmkt)->pegawai_nama ?></strong></div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group col-md-12">
