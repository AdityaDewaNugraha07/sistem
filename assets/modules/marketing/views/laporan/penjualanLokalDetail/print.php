									...
									<tbody>
										...
										if(!empty($contents)){ 
											...
											<tr>
												...
												<td style="font-size: 1.2rem; vertical-align: top;"><?= ($data->jenis_produk == "Limbah")? $data->limbah_kode." - (".$data->limbah_produk_jenis.") ".$data->limbah_nama : $data->produk_nama ?></td>
												<td style="font-size: 1.2rem; vertical-align: top;"><?= ($data->jenis_produk == "Limbah")? "<center>-</center>":$data->produk_dimensi ?></td>
												<td style="text-align: right; font-size: 1.2rem; vertical-align: top;"><?= $data->qty_kecil ?></td>
												<td style="text-align: right; font-size: 1.2rem; vertical-align: top;">
                                                    ...
                                                    if($data->jenis_produk == "Limbah"){
                                                        ...
                                                        if(app\components\Params::USER_GROUP_ID_STAFF_FINNACC == Yii::$app->user->identity->user_group_id){
                                                            echo number_format($data->kubikasi,4);
                                                        }else{
												...
												<td style="text-align: right; font-size: 1.2rem; vertical-align: top;"><?= $data->harga_jual ?></td>
												<td style="text-align: right; font-size: 1.2rem; vertical-align: top;">
													<?php
													$subtotal = 0;
													if($data->jenis_produk == "Plywood" || $data->jenis_produk == "Lamineboard" || $data->jenis_produk == "Platform" || $data->jenis_produk == "Limbah"){
