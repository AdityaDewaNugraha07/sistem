                                            ...
                                            <div id="table-grade_filter" class="dataTables_filter visible-lg visible-md form-horizontal" style="width: 100%; margin-top: -7px; margin-bottom: 15px;">
                                                <div class="form-group" id="filter-dropdown">
                                                    <div class="col-md-6" id="date-filter">
                                                        <?= yii\bootstrap\Html::dropDownList('harga_tanggal_penetapan','',\app\models\MHargaLimbah::getOptionListTanggal(),['class'=>'form-control bs-select','data-style'=>'blue-hoki btn-outline','id'=>'harga_tanggal_penetapan','onchange'=>"getContent('view')"]); ?>
                                                    </div>
