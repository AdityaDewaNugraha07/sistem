                                ...
                                <div class="col-md-8">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail">
                                            ...
                                            \yii\helpers\Url::base().'/uploads/mkt/customer/'.$model->cust_file_ktp :
                                            Yii::$app->view->theme->baseUrl .'/cis/img/no-image.png').'" alt="" /> 
                                        </div>
                                        <div class="fileinput-preview fileinput-epxists thumbnail" style="max-width: 130px; max-height: 100px;"> </div>
                                        <div>
                                ...
                                <div class="col-md-8">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail">
                                            ...
                                            \yii\helpers\Url::base().'/uploads/mkt/customer/'.$model->cust_file_npwp :
                                            Yii::$app->view->theme->baseUrl .'/cis/img/no-image.png').'" alt="" /> 
                                        </div>
                                ...
                                <div class="col-md-8">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail">
                                            ...
                                            \yii\helpers\Url::base().'/uploads/mkt/customer/'.$model->cust_file_photo :
                                            Yii::$app->view->theme->baseUrl .'/cis/img/no-image.png').'" alt="" /> 
                                        </div>
                                        <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 130px; max-height: 100px;"> </div>
                                        <div>
