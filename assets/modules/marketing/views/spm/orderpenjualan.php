			...
			{	targets: 9, 
				render: function ( data, type, full, meta ) {
					if(data=="Not Confirmed"){
						return '<span class="label label-sm label-default">Belum Diverifikasi</span>';
					}else if(data=="APPROVED"){
						return '<span class="label label-sm label-success">Terverifikasi</span>';
					}else{
						return '<span class="label label-sm label-success">Allowed</span>';
					}
                }
			},
        ],
