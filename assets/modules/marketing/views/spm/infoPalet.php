                ...
                <div class="row">
                    <div class="col-md-6">
						...
						<div class="form-group col-md-12">
							...
							<div class="col-md-7"><strong><?= $modTerima->qty_kecil ?> <?= $modTerima->qty_kecil_satuan ?></strong></div>
						</div>
						<div class="form-group col-md-12">
							<label class="col-md-5 control-label">Kubikasi</label>
							<div class="col-md-7"><strong><?= $modTerima->qty_m3 ?> M<sup>3</sup></strong></div>
						</div>
						<div class="form-group col-md-12">
							<label class="col-md-5 control-label">Jenis Palet</label>
							<div class="col-md-7"><strong><?= ($modTerima->jenis_penerimaan=="Khusus")?"<span class='font-blue-steel'>Random</span>":$modTerima->jenis_penerimaan; ?></strong></div>
						</div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group col-md-12">
