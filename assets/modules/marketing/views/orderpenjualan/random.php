    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Random Produk'); ?> <b><?= $modProduk->produk_kode ?> - <?= $modProduk->produk_nama ?></b></h4>
            </div>
...
function check(){
	...
	$.ajax({
		url    : '<?= \yii\helpers\Url::toRoute(['/marketing/orderpenjualan/getRandom']); ?>',
		type   : 'POST',
