                        ...
                        <table class="table table-striped table-bordered table-hover table-laporan" id="table-produk">
							<thead>
								<tr>
									...
									<th style="width: 15%;"><?= Yii::t('app', 'Kode Produk') ?></th>
...
function dtProduk(){
    var dt_table =  $('#table-produk').dataTable({
        ajax: { url: '<?= \yii\helpers\Url::toRoute(['/marketing/orderpenjualan/produkInStock','jenis_produk'=>'']) ?><?= $jenis_produk ?>',data:{dt: 'table-produk'} },
        order: [
            [0, 'desc']
        ],
        columnDefs: [
