    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Laporan Kas Besar Tanggal ').app\components\DeltaFormatter::formatDateTimeForUser(substr($models[0]->tanggal, 0,10) ); ?></h4>
            </div>
							...
							<table class="table table-striped table-bordered table-hover" id="table-list" style="width: 100%;">
								...
								<tbody>
									...
									<tr style="background-color: #e2e3e5;">
										...
										<td class="td-kecil" > &nbsp; </td>
										<td class="td-kecil" > &nbsp; </td>
										<td class="td-kecil text-align-right" style="font-weight: bold; "><?= app\components\DeltaFormatter::formatNumberForUserFloat( \app\models\HSaldoKasbesar::getSaldoAkhir($models[0]->tanggal) ); ?></td>
									</tr>
								</tbody>
							</table>
						</div>
