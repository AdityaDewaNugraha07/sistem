    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
			...
			<div class="modal-footer text-align-center" style="padding-top: 10px;">
				<?= yii\helpers\Html::button(Yii::t('app', 'Print'),['class'=>'btn blue-steel ciptana-spin-btn btn-outline','onclick'=>'printbonsementara("PRINT","'.$models[0]->tanggal.'")']); ?>
                <?= yii\helpers\Html::button(Yii::t('app', 'Excel'),['class'=>'btn green-seagreen ciptana-spin-btn btn-outline','onclick'=>'printbonsementara("EXCEL","'.$models[0]->tanggal.'")']); ?>
                <?= yii\helpers\Html::button(Yii::t('app', 'PDF'),['class'=>'btn red-flamingo ciptana-spin-btn btn-outline','onclick'=>'printbonsementara("PDF","'.$models[0]->tanggal.'")']); ?>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
