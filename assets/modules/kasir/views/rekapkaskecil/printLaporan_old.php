...
?>
<?php
$header = Yii::$app->controller->render('@views/apps/print/defaultHeaderSOP',['paramprint'=>$paramprint]);
									...
									<tbody>
										...
										if(count($model)>0){ 
											...
											<tr>
												...
												<td class="text-align-center"><?= $data['reff_no'] ?></td>
										...
										<tr>
											...
											<td class="" > &nbsp; </td>
											<td class="" > &nbsp; </td>
											<td class=" text-align-right" style="font-weight: bold; "><?= ($_GET['caraprint'] != "EXCEL")?app\components\DeltaFormatter::formatNumberForUserFloat( \app\components\Params::DANA_TETAP_KAS_KECIL ):\app\components\Params::DANA_TETAP_KAS_KECIL; ?></td>
										</tr>
										<tr>
											<td class="" colspan="3" style="font-size: 1.2rem; font-weight: bold; text-align: right;">TOTAL TOP-UP</td>
											<td class="" > &nbsp; </td>
											<td class="" > &nbsp; </td>
											<td class=" text-align-right" style="font-weight: bold; "><?= ($_GET['caraprint'] != "EXCEL")?app\components\DeltaFormatter::formatNumberForUserFloat( (\app\components\Params::DANA_TETAP_KAS_KECIL)-(\app\models\HSaldoKaskecil::getSaldoAkhir($model[0]['tanggal'])) ):(\app\components\Params::DANA_TETAP_KAS_KECIL)-(\app\models\HSaldoKaskecil::getSaldoAkhir($model[0]['tanggal'])); ?></td>
										</tr>
									</tbody>
                                </table>
                            </div>
