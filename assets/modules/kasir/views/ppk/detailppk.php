...
<div class="modal fade" id="modal-ppk" tabindex="-1" role="basic" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
						...
						<div class="form-group col-md-12">
							<label class="col-md-5 control-label bold">Tanggal PPK</label>
							<div class="col-md-7"> :
								<?= app\components\DeltaFormatter::formatDateTimeForUser2($model->tanggal); ?>
							</div>
						</div>
						<div class="form-group col-md-12">
							<label class="col-md-5 control-label bold">Tipe</label>
							<div class="col-md-7"> :
								<?= $model->tipe; ?>
							</div>
						</div>
						<div class="form-group col-md-12">
							<label class="col-md-5 control-label bold">Tanggal Diperlukan</label>
							<div class="col-md-7"> :
								<?= app\components\DeltaFormatter::formatDateTimeForUser2($model->tanggal_diperlukan); ?>
							</div>
						</div>
                    </div>
					<div class="col-md-6">
						<div class="form-group col-md-12">
							<label class="col-md-5 control-label bold">Nominal</label>
							<div class="col-md-7"> :
								<?= app\components\DeltaFormatter::formatNumberForUserFloat($model->nominal); ?>
							</div>
						</div>
						<div class="form-group col-md-12">
							<label class="col-md-5 control-label bold">Keperluan</label>
							<div class="col-md-7"> :
								<?= $model->keperluan; ?>
							</div>
						</div>
