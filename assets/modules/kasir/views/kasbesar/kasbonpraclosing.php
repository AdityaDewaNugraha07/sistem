    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
								...
								<tbody>
									...
									foreach($models as $i => $model){
										...
										<tr style="">
											...
											<td class="td-kecil text-align-center"><?= app\components\DeltaFormatter::formatDateTimeForUser2($model->tanggal) ?></td>
			...
			<div class="modal-footer text-align-center" style="padding-top: 10px;">
				<?php // echo yii\helpers\Html::button(Yii::t('app', 'Print'),['class'=>'btn blue-steel ciptana-spin-btn btn-outline','onclick'=>'printbonsementara("PRINT","'.$models[0]->tanggal.'")']); ?>
                <?php // echo yii\helpers\Html::button(Yii::t('app', 'Excel'),['class'=>'btn green-seagreen ciptana-spin-btn btn-outline','onclick'=>'printbonsementara("EXCEL","'.$models[0]->tanggal.'")']); ?>
                <?php // echo yii\helpers\Html::button(Yii::t('app', 'PDF'),['class'=>'btn red-flamingo ciptana-spin-btn btn-outline','onclick'=>'printbonsementara("PDF","'.$models[0]->tanggal.'")']); ?>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
