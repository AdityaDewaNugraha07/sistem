                    ...
                    <div class="col-md-12">
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    <span class="caption-subject bold"><h4><?= Yii::t('app', 'Transaksi Rekap Realisasi Pengeluaran Kas Kecil'); ?></h4></span>
                                </div>
                                <div class="tools">
												...
												<tfoot>
													...
													<tr class="nodrag">
														...
														<td colspan="5" style="text-align: left;">
															<div class="row"><div class="col-md-12 " id="btn-urutan-place"> </div></div>
														</td>
													</tr>
												</tfoot>
											</table>
	...
	$.ajax({
		...
		success: function (data) {
			if(data.status == 1){
				...
				$('#form-pengeluaran-kas').find('input').each(function(){ $(this).attr("readonly","readonly"); });
				$('#form-pengeluaran-kas').find('textarea').each(function(){ $(this).attr("readonly","readonly"); });
...
function urutkankode(){
	...
	$.ajax({
        ...
        type   : 'POST',
        data   : {tgl:tgl,formData: formData},
        success: function (data){
			if(data){
				getItems();
			}
