    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer text-align-center" style="padding-top: 10px;">
                ...
                <?= yii\helpers\Html::button(Yii::t('app', '<i class="fa fa-plus"></i> Add'),['class'=>'btn blue ciptana-spin-btn','id'=>'pick-btn','onclick'=>'pickingTBP()']); ?>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
function dtTable(){
    var dt_table =  $('#table-dt').dataTable({
        ajax: { url: '<?= \yii\helpers\Url::toRoute('/kasir/pengeluarankaskecil/pickPanelTBP') ?>',data:{dt: 'table-dt'} },
		'columnDefs': [
			{
				'targets': 0,
				orderable: false,
