    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header" style="text-align: center;">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Rincian Uang Tunai Kas Kecil Tanggal ').\app\components\DeltaFormatter::formatDateTimeForUser2($tgl); ?></h4>
            </div>
...
function saveUangTunai(){
    ...
    if(formrequiredvalidate($form)){
		...
		$.ajax({
			url    : '<?php echo \yii\helpers\Url::toRoute(['/kasir/pengeluarankaskecil/uangtunai']); ?>',
			type   : 'POST',
