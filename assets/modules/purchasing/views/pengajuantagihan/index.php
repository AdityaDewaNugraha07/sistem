...
function getItems(){
	...
	$.ajax({
		...
		type   : 'POST',
		data   : {tgl:tgl,mode:mode,tgl_awal:tgl_awal,tgl_akhir:tgl_akhir,suplier:suplier,kode_tbp:kode_tbp,kode_spo:kode_spo,nomor_nota:nomor_nota,nomor_kuitansi:nomor_kuitansi},
		success: function (data) {
            ...
            $('#table-detail > tbody > tr').each(function(){
                $(this).find("input[name*='[no_fakturpajak]']").inputmask({'mask': '999.999-99.99999999'});
            });
