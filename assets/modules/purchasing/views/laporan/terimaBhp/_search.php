		...
		<div class="portlet light bordered form-search">
			...
			<div class="portlet-body">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							<?php echo $this->render('@views/apps/form/periodeTanggal', ['label'=>'Periode Penerimaan','model' => $model,'form'=>$form]) ?>
							<?php echo $form->field($model, 'terimabhp_kode')->textInput()->label(Yii::t('app', 'Kode Terima')); ?>
						...
						<div class="col-md-5">
							...
							<?php echo $form->field($model, 'terimabhpd_keterangan')->textarea()->label(Yii::t('app', 'Keterangan')); ?>
						</div>
					</div>
