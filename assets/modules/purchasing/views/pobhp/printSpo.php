		...
		<tr>
			<td colspan="2" style="vertical-align: top; font-size: 1.4rem;">
				<table border="1" style="width: 100%;">
					...
					<tr>
						<td style="font-weight: bold; font-size: 1.3rem; padding-right: 20px;" colspan="4" class="text-right">Total </td>
						<td style="font-weight: bold; font-size: 1.3rem;" class="text-right"><?= \app\components\DeltaFormatter::formatNumberForUser($total_duid); ?></td>
						<td style="font-weight: bold; font-size: 1.3rem;">&nbsp;</td>
					</tr>
					<tr>
						<td style="font-weight: bold; font-size: 1.3rem; padding-right: 20px;" colspan="4" class="text-right">PPh </td>
						<td style="font-weight: bold; font-size: 1.3rem;" class="text-right"><?= \app\components\DeltaFormatter::formatNumberForAllUser($pph); ?></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td style="font-weight: bold; font-size: 1.3rem; padding-right: 20px;" colspan="4" class="text-right">PPn </td>
						<td style="font-weight: bold; font-size: 1.3rem;" class="text-right"><?= \app\components\DeltaFormatter::formatNumberForUser($ppn); ?></td>
						<td>&nbsp;</td>
					</tr>
					<tr>
						<td style="font-weight: bold; font-size: 1.3rem; padding-right: 20px;" colspan="4" class="text-right">Grand Total </td>
						<td style="font-weight: bold; font-size: 1.3rem;" class="text-right"><?= \app\components\DeltaFormatter::formatNumberForUser($grand_total); ?></td>
						<td>&nbsp;</td>
					</tr>
				</table>
			</td>
