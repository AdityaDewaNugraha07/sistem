                    ...
                    <div class="col-md-12">
                        <div class="portlet light bordered">
                            <div class="portlet-body">
								<div class="row">
                                    <div class="col-md-12">
										<?= \yii\bootstrap\Html::activeDropDownList($model, 'gudang_tujuan', \app\models\MGudang::getOptionList(), ['class'=>'form-control select2','prompt'=>'','style'=>'width:100%']) ?>
                                    </div>
                                </div>
								<div class="row" style="text-align: center;">
									<div class="col-md-12">
										<div class="well" style="position: relative;display: inline-block;">
											<canvas width="280" height="260" id="webcodecam-canvas"></canvas>
...
<?php $this->registerJs(" 
	formconfig();
	$('select[name*=\"[gudang_tujuan]\"]').select2({
		allowClear: !0,
