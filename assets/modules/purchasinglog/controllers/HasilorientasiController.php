...
class HasilorientasiController extends DeltaBaseController
{
	...
	public function actionIndex(){
		...
		$model->by_gmpurch = \app\components\Params::DEFAULT_PEGAWAI_ID_AGUS_WIBOWO;
		...
		$model->by_gmpurch_name = \app\models\MPegawai::findOne(\app\components\Params::DEFAULT_PEGAWAI_ID_AGUS_WIBOWO)->pegawai_nama;
