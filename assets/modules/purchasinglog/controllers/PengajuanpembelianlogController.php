...
class PengajuanpembelianlogController extends DeltaBaseController
{
	...
	public function actionIndex(){
		...
		$model->by_gmopr = \app\components\Params::DEFAULT_PEGAWAI_ID_ASENG;//di ganti p as
		$model->by_gmpurch = \app\components\Params::DEFAULT_PEGAWAI_ID_AGUS_WIBOWO;//di ganati p aseng
		...
		$model->by_gmpurch_name = \app\models\MPegawai::findOne(\app\components\Params::DEFAULT_PEGAWAI_ID_AGUS_WIBOWO)->pegawai_nama;//di ganti p aseng
		$model->by_kadiv_name = \app\models\MPegawai::findOne(\app\components\Params::DEFAULT_PEGAWAI_ID_IWAN_SULISTYO)->pegawai_nama;
		$model->by_gmopr_name = \app\models\MPegawai::findOne(\app\components\Params::DEFAULT_PEGAWAI_ID_ASENG)->pegawai_nama;//diganti p as
