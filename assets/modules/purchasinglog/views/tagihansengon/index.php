                    ...
                    <div class="col-md-12">
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
									<span class="caption-subject"><h4><?= Yii::t('app', 'Tagihan Log Sengon'); ?></h4></span>
                                </div>
                                <div class="tools">
                            ...
                            <div class="portlet-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <?= $form->field($model, 'total_pcs')->textInput(['class'=>'form-control float','disabled'=>true])->label("Total Batang"); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4><?= Yii::t('app', 'Detail Perhitungan Sengon '); ?><span id="place-judultable"></span></h4>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
...
function setTotal(){
    ...
    $("input[name*='total_harga']").val( formatNumberForUser( Math.round(total_harga) ) );
    $("input[name*='total_pph']").val( formatNumberForUser( Math.round(total_pph) ) );
    ...
    $("#<?= yii\helpers\Html::getInputId($model, "total_bayar") ?>").val( formatNumberForUser( Math.round(total_bayar) ) );
}
