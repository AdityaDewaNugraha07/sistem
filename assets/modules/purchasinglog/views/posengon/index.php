                    ...
                    <div class="col-md-12">
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
									<span class="caption-subject"><h4><?= Yii::t('app', 'Rencana Purchase Order Log Sengon'); ?></h4></span>
                                </div>
                                <div class="tools">
                            ...
                            <div class="portlet-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8" style="padding-bottom: 5px;">
                                                <span class="input-group-btn" style="width: 95%">
                                                    <?= \yii\bootstrap\Html::activeTextInput($model, 'kode_permintaan', ['class'=>'form-control','style'=>'width:100%','disabled'=>true,'placeholder'=>'Cari Permintaan Pembelian Log Sengon']) ?>
                                                </span>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4><?= Yii::t('app', 'Tabel Perencanaan Pembelian Log Sengon (Breakdown By Supplier) Pada Periode : '); ?><span id="place-periode"></span></h4>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
