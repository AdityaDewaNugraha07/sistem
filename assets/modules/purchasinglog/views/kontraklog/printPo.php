		...
		<td colspan="3" style="padding: 0px;">
			<table style="width: 100%" id="table-detail">
                <tr style="height: 0.5cm; border-bottom: solid 1px #000;">
                    <td rowspan="2" style="width: 0.5cm; padding: 7px 5px; border-right: solid 1px #000; vertical-align: middle; padding:5px;"><b><center>No.</center></b></td>
                    <td rowspan="2" style="padding: 7px 5px; border-right: solid 1px #000; vertical-align: middle; padding:5px;"><b><center>Jenis Kayu</center></b></td>
                    <?php foreach($ukuranganrange as $i => $range){ ?>
                    <th colspan="2" style="border-right: solid 1px #000; padding:5px;"><center>Diameter <?= $range ?></center></th>
                    <?php } ?>
                    <th colspan="2"><center>Subtotal</center></th>
                </tr>
                <tr style="border-bottom: solid 1px #000;">
                    <?php foreach($ukuranganrange as $i => $range){ ?>
                    <th style="width: 50px; border-right: solid 1px #000; padding:5px;"><center>M<sup>3</sup></center></th>
                    <th style="width: 70px; border-right: solid 1px #000; padding:5px;"><center>Harga/m<sup>3</sup></center></th>
                    <?php } ?>
                    <th style="width: 60px; border-right: solid 1px #000; padding:5px; line-height: 1">Subtotal<br><center>M<sup>3</sup></center></th>
                    <th style="width: 80px; padding:5px; line-height: 1"><center>Subtotal<br>Harga</center></th>
                </tr>
                <?php
                $total_ver_m3 = []; $total_ver_harga = []; $total_m3 = 0; $total_harga=0;
                foreach($ukuranganrange as $i => $range){
                    $total_ver_m3[$range] = 0; $total_ver_harga[$range] = 0;
                }
                if(count($modDetail)>0){
                    foreach($modDetail as $i => $detail){
                        ...
                        echo    "<td style='padding:5px; border-right: solid 1px #000; text-align: left;'>".$detail->kayu->kayu_nama."</td>";
                            $subtotal_m3 = 0; $subtotal_harga = 0; 
                            foreach($ukuranganrange as $i => $range){
                                ...
                                $subtotal_m3 += $mod['qty_m3']; $subtotal_harga += $mod['qty_m3']*$mod['harga'];
...
//                                    }
				...
				<tr>
					<td style="width: 100%; height: auto; vertical-align: top; padding-left: 5px;">
						<table style="width: 100%;">
							...
							<tr>
                                <td style="padding: 5px; vertical-align: top; "><b>Diameter </b>/<b> Komposisi</b></td>
								<td style="padding: 5px; vertical-align: top;  text-align: center;"><b>:</b></td>
    ...
    <tr>
		<td colspan="3" style="padding: 10px; background-color: #F1F4F7; border-top: solid 1px transparent; padding-bottom: 4cm; ">
			<table style="width: 100%;">
                <tr>
                    <td style="width: 100%; height: auto; vertical-align: top; padding-left: 5px;">
