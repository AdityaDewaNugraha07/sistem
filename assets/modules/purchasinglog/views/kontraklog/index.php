...
?>
<!-- BEGIN PAGE TITLE-->
<h1 class="page-title"> <?php echo Yii::t('app', 'PO Log Alam'); ?></h1>
<!-- END PAGE TITLE-->
<!-- END PAGE HEADER-->
    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            <div class="portlet-body">
				...
				<div class="col-md-12">
					<a class="btn blue btn-sm btn-outline pull-right" onclick="daftarAfterSave()"><i class="fa fa-list"></i> <?= Yii::t('app', 'Daftar PO Log Alam'); ?></a>
				</div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    <span class="caption-subject bold"><h4><?= Yii::t('app', 'Data PO & Kontrak'); ?></h4></span>
                                </div>
                                <div class="tools">
