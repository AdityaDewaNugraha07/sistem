...
<tr style="">
	...
	<td class="td-kecil" style="vertical-align: middle; padding-top: 20px; ">
		<?php echo yii\helpers\Html::activeDropDownList($model, '[ii]kayu_id',app\models\MKayu::getOptionList(),['class'=>'form-control select2','prompt'=>'','style'=>'width:100%; padding: 1px; height:25px;','value'=>$kayu_id,"disabled"=>$disabled]); ?>
	</td>
	<?php 
