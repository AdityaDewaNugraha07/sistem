                        ...
                        <table class="table table-striped table-bordered table-hover table-laporan" id="table-aftersave">
							<thead>
								<tr>
									...
									<th style="line-height: 1"><?= Yii::t('app', 'Reviewed By<br>Kadiv'); ?></th>
        ...
        columnDefs: [
			...
			{	targets: 13, 
				render: function ( data, type, full, meta ) {
					var display = "";
                    <?php if(empty($pick)){ ?>
                        if((full[13]=="<?= app\models\TApproval::STATUS_APPROVED ?>") || (full[14]=="<?= app\models\TApproval::STATUS_APPROVED ?>") || (full[15]=="<?= app\models\TApproval::STATUS_APPROVED ?>") || (full[16]=="<?= app\models\TApproval::STATUS_APPROVED ?>") || (full[17]=="<?= app\models\TApproval::STATUS_APPROVED ?>")){
                        ...
                        if((full[17]=="<?= app\models\TApproval::STATUS_APPROVED ?>")){
