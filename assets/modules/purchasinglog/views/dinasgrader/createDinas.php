    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', "Buat Dinas Kerja Grader Baru"); ?></h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
						...
						<?= $form->field($model, 'graderlog_id')->dropDownList(\app\models\MGraderlog::getOptionList2($grader_aktif),['class'=>'form-control select2','prompt'=>'All']); ?>
                    </div>
					<div class="col-md-6">
