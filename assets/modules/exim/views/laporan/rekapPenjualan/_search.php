			...
			<div class="portlet-body">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-5">
							<?= $form->field($model, 'payment_method')->dropDownList(\app\models\TInvoice::getOptionListPaymentMethod(),['prompt'=>'All']); ?>
							<?= $form->field($model, 'term_of_price')->dropDownList(\app\models\TInvoice::getOptionListTermOfPrice(),['prompt'=>'All']); ?>
						</div>
					</div>
