...
//							$xcvxcv = floor( ($modInvoiceDetail->harga_jual * $modInvoiceDetail->kubikasi_display) * 1000) / 1000;
				...
				<tfoot>
					...
					$totals = $total - $total_potongan;
					if ($total_potongan > 0) {
					?>
					<tr style="border-top: solid 1px #000;">
						<td colspan="6" class="text-align-right" style="padding: 3px; text-align: right; border-right: solid 1px #000; font-weight: bold;"><?php echo $keterangan_potongan;?></td>
						<td colspan="4" class="text-align-right" style="padding: 3px; text-align: right; font-weight: bold;"><span class="pull-left"><?php echo $model->mata_uang;?></span><?php echo number_format($total_potongan,2);?></td>
					</tr>
					<?php
					}
					?>
					<tr style="border-top: solid 1px #000;">
						...
						<td style="padding: 3px; text-align: right;">
							...
							<b class="pull-right"><?= number_format($total - $total_potongan,2) ?></b>
						</td>
					</tr>
					<tr style="border-top: solid 1px #000;">
