<div class="modal fade" id="modal-menu-info" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="btn btn-icon-only btn-default fa fa-close" data-dismiss="modal" aria-hidden="true" style="float: right; padding-top: 2px; padding-bottom: 2px;"></button>
                <h4 class="modal-title"><?= Yii::t('app', 'Menu Details'); ?></h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7"><strong><?= $model->othername ?></strong></div>
                        </div>
                        <div class="form-group col-md-12">
                            <label class="col-md-5 control-label"><?= $model->attributeLabels()['menu_group_id'] ?></label>
                            <div class="col-md-7"><strong><?= $model->menuGroup->name ?></strong></div>
                        </div>
                        <div class="form-group col-md-12">
                            <label class="col-md-5 control-label"><?= $model->attributeLabels()['module_id'] ?></label>
                            <div class="col-md-7"><strong><?= $model->module->name ?></strong></div>
                        </div>
                        <div class="form-group col-md-12">
                            <label class="col-md-5 control-label"><?= $model->attributeLabels()['url'] ?></label>
                            <div class="col-md-7"><strong><?= $model->url ?></strong></div>
                        </div>
                        <div class="form-group col-md-12">
                            <label class="col-md-5 control-label"><?= $model->attributeLabels()['sequence'] ?></label>
                            <div class="col-md-7"><strong><?= $model->sequence ?></strong></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group col-md-12">
            ...
            <div class="modal-footer">
                <?= yii\helpers\Html::button(Yii::t('app', 'Edit'),['class'=>'btn blue btn-outline','onclick'=>"openModal('".\yii\helpers\Url::toRoute(['/sysadmin/menu/edit','id'=>$model->menu_id])."','modal-menu-edit')"]); ?>
                <?= yii\helpers\Html::button(Yii::t('app', 'Delete'),['class'=>'btn red btn-outline','onclick'=>"openModal('".\yii\helpers\Url::toRoute(['/sysadmin/menu/delete','id'=>$model->menu_id,'tableid'=>'table-menu'])."','modal-delete-record')"]); ?>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
