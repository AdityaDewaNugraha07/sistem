...
class DepartementController extends DeltaBaseController
{
	
	public $defaultAction = 'index';
	public function actionIndex(){
        if(\Yii::$app->request->get('dt')=='table-master'){
			$param['table']= \app\models\MDepartement::tableName();
			$param['pk']= \app\models\MDepartement::primaryKey()[0];
			$param['column'] = ['departement_id','departement_nama','departement_other',$param['table'].'.active'];
	...
	public function actionCreate(){
		if(\Yii::$app->request->isAjax){
			$model = new \app\models\MDepartement();
			$model->active = true;
			if( Yii::$app->request->post('MDepartement')){
    ...
    public function actionInfo($id){
		if(\Yii::$app->request->isAjax){
			$model = \app\models\MDepartement::findOne($id);
	...
	public function actionPrintout(){
		...
		$model = \app\models\MDepartement::find()->where('jabatan_id IN('.$jabatan_id.')')->select("*")->all();
