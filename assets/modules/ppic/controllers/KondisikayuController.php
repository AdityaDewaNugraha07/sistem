...
class KondisikayuController extends DeltaBaseController
{
	...
	public function actionIndex(){
        if(\Yii::$app->request->get('dt')=='table-master'){
			$param['table']= \app\models\MKondisiKayu::tableName();
			$param['pk']= \app\models\MKondisiKayu::primaryKey()[0];
			$param['column'] = ['kondisi_kayu_id','jenis_produk','kode','nama','othername',$param['table'].'.active'];
	...
	public function actionCreate(){
		if(\Yii::$app->request->isAjax){
			$model = new \app\models\MKondisiKayu();
			$model->active = true;
			if( Yii::$app->request->post('MKondisiKayu')){
    ...
    public function actionInfo($id){
		if(\Yii::$app->request->isAjax){
			$model = \app\models\MKondisiKayu::findOne($id);
