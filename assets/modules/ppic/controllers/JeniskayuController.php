...
class JeniskayuController extends DeltaBaseController
{
	...
	public function actionIndex(){
        if(\Yii::$app->request->get('dt')=='table-master'){
			$param['table']= \app\models\MJenisKayu::tableName();
			$param['pk']= \app\models\MJenisKayu::primaryKey()[0];
			$param['column'] = ['jenis_kayu_id','jenis_produk','kode','nama','othername',$param['table'].'.active'];
	...
	public function actionCreate(){
		if(\Yii::$app->request->isAjax){
			$model = new \app\models\MJenisKayu();
			$model->active = true;
			if( Yii::$app->request->post('MJenisKayu')){
    ...
    public function actionInfo($id){
		if(\Yii::$app->request->isAjax){
			$model = \app\models\MJenisKayu::findOne($id);
