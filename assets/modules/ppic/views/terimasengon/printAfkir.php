									...
									<tbody>
                                        ...
                                        ?>
											<tr>
                                                ...
                                                <td  style="text-align: right;"><?= app\components\DeltaFormatter::formatNumberForUser($data->qty_m3) ?></td>
                                                <td  style="text-align: right;"><?= app\components\DeltaFormatter::formatNumberForUser($data->selisih_pcs) ?></td>
                                                <td  style="text-align: right;"><?= app\components\DeltaFormatter::formatNumberForUser($data->selisih_m3) ?></td>
