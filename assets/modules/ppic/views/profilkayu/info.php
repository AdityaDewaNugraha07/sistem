    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= Yii::t('app', 'Detail Profil Kayu'); ?></h4>
            </div>
            ...
            <div class="modal-footer" style='text-align:center'>
                ...
                if($model->active==true){
                    echo yii\helpers\Html::button(Yii::t('app', 'Non-Active kan Data ini!'),['class'=>'btn red-flamingo btn-outline','onclick'=>"updateStatus(".$model->profil_kayu_id.")"]);
                }else{
                    echo yii\helpers\Html::button(Yii::t('app', 'Active kan Data ini!'),['class'=>'btn green-seagreen btn-outline','onclick'=>"updateStatus(".$model->profil_kayu_id.")"]);
                }
				if(empty($disableAction)){
                    echo yii\helpers\Html::button(Yii::t('app', 'Delete'),['class'=>'btn red btn-outline pull-right','onclick'=>"openModal('".\yii\helpers\Url::toRoute(['/ppic/profilkayu/delete','id'=>$model->profil_kayu_id,'tableid'=>'table-master'])."','modal-delete-record')"]);
                    echo yii\helpers\Html::button(Yii::t('app', 'Edit'),['class'=>'btn blue btn-outline pull-right','onclick'=>"openModal('".\yii\helpers\Url::toRoute(['/ppic/profilkayu/edit','id'=>$model->profil_kayu_id])."','modal-master-edit')"]);
				}
				?>
            </div>
        </div>
