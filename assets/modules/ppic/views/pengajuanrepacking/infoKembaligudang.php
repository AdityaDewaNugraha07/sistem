                                ...
                                <tbody>
                                    ...
                                    if(count($modMaps)>0){
                                        foreach($modMaps as $i => $map){
                                            ...
                                            echo "  <td class='td-kecil text-align-right'>". number_format($modTerima->qty_m3,4)."</td>";
                ...
                <div class="row" style="margin-bottom: 15px;">
                    ...
                    <div class="col-md-6">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-7"><strong><?= \app\components\DeltaFormatter::formatDateTimeForUser2($modProduksi->tanggal_produksi) ?></strong></div>
                        </div>
                        <div class="form-group col-md-12">
                            <label class="col-md-5 control-label">No. Urut Produksi</label>
                            <div class="col-md-7"><strong><?= $modProduksi->nomor_urut_produksi ?></strong></div>
                        </div>
                        <div class="form-group col-md-12">
