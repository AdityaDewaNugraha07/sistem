                                ...
                                <div class="row">
                                    <div class="col-md-5">
										...
										<?= $form->field($model, 'tanggal',[
																	...
																	{error}</div>'])->textInput(['readonly'=>'readonly'])->label("Tanggal Permintaan"); ?>
                                        <?= $form->field($model, 'keperluan')->dropDownList(["Repacking"=>"Repacking","Regrade"=>"Regrade","Restamp"=>"Restamp","Restamp"=>"Restamp","Proses Produksi"=>"Proses Produksi"],['class'=>'form-control','prompt'=>'']); ?>
...
function masterProduk(ele){
	...
	var url = '<?= \yii\helpers\Url::toRoute(['/marketing/orderpenjualan/produkInStock','disableAction'=>'']); ?>1';
...
function daftarAfterSave(){
    openModal('<?= \yii\helpers\Url::toRoute(['/ppic/pengajuanrepacking/daftarAfterSave']) ?>','modal-aftersave','70%');
}
