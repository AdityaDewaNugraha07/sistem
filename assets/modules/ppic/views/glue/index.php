                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject hijau bold"><?= Yii::t('app', 'Glue'); ?></span>
                                </div>
                                <div class="tools">
...
function dtGrade(){
    var dt_table =  $('#table-master').dataTable({
        ajax: { url: '<?= \yii\helpers\Url::toRoute('/ppic/glue/index') ?>',data:{dt: 'table-master'} },
        order: [
            [0, 'desc']
        ],
        columnDefs: [
...
function create(){
	openModal('<?= \yii\helpers\Url::toRoute('/ppic/glue/create') ?>','modal-master-create');
}
function info(id){
	openModal('<?= \yii\helpers\Url::toRoute(['/ppic/glue/info','id'=>'']) ?>'+id,'modal-master-info');
}
...
function updateStatus(id){
    $.ajax({
        url    : '<?= \yii\helpers\Url::toRoute(['/ppic/glue/updateStatus','id'=>'']); ?>'+id,
        type   : 'POST',
        data   : {},
