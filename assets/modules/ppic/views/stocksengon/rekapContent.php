<table class="table table-striped table-bordered table-hover" id="table-laporan" style="width:100%">
    <thead>
        <tr>
            <th colspan="14" style="line-height: 1; padding: 10px; background-color: #ddf5e4" class="font-green-seagreen"><i><b>STOCK LOG SENGON KONDISI BAGUS - (GUDANG LOG UTUH)</b></i></th>
        </tr>
        <tr>
    ...
    <tbody>
        ...
        $sql = "SELECT  fisik_panjang, 
                    ( (SELECT SUM(fisik_pcs) FROM h_persediaan_log AS a 
                      ...
                      (SELECT SUM(fisik_pcs) FROM h_persediaan_log AS b 
                ...
                FROM h_persediaan_log GROUP BY 1";
