                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject hijau bold"><?= Yii::t('app', 'Jenis Kayu'); ?></span>
                                </div>
                                <div class="tools">
...
function dtGrade(){
    var dt_table =  $('#table-master').dataTable({
        ajax: { url: '<?= \yii\helpers\Url::toRoute('/ppic/jeniskayu/index') ?>',data:{dt: 'table-master'} },
        order: [
            [0, 'desc']
        ],
        columnDefs: [
...
function create(){
	openModal('<?= \yii\helpers\Url::toRoute('/ppic/jeniskayu/create') ?>','modal-master-create');
}
function info(id){
	openModal('<?= \yii\helpers\Url::toRoute(['/ppic/jeniskayu/info','id'=>'']) ?>'+id,'modal-master-info');
}
...
function updateStatus(id){
    $.ajax({
        url    : '<?= \yii\helpers\Url::toRoute(['/ppic/jeniskayu/updateStatus','id'=>'']); ?>'+id,
        type   : 'POST',
        data   : {},
