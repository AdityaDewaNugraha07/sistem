    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <?= yii\helpers\Html::button(Yii::t('app', 'Yes'),['class'=>'btn hijau btn-outline ciptana-spin-btn','onclick'=>"deleteRecord()"]); ?>
                <?= yii\helpers\Html::button(Yii::t('app', 'No'),['class'=>'btn red btn-outline ciptana-spin-btn','data-dismiss'=>"modal", 'aria-hidden'=>'true']); ?>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
