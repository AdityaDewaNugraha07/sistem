	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<div class="modal-body">
				<textarea name="alasan" id="alasan" rows="3" class="form-control" placeholder="Alasan..."></textarea>
			</div>
	...
	function yes() {
		$.ajax({
			...
			"success": function(data) {
				...
				$('#modal-delete-record').find('.progress-success .bar').animate({
					'width': '0%'
				});
			},
			...
			"progress": function(e) {
				if (e.lengthComputable) {
					...
					$('#modal-global-confirm').find('.progress-success .bar').animate({
						'width': pct.toPrecision(3) + '%'
					});
				} else {
