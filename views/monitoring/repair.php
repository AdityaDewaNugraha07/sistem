...
$this->title = MMtrgSetup::KATEGORI_REPAIR;
...
<header>
    <div>
        <h3 style="text-align: left; margin-left: 20px">
            MONITORING <?= MMtrgSetup::KATEGORI_REPAIR ?>
            <br>
    ...
    <div style="display: flex;">
        <div>
            <div style="border-right: 2px solid yellow; margin-top: 40px; padding-right: 15px;">
                <p>Shift : <strong><?= MMtrgSetup::getActiveShift(MMtrgSetup::KATEGORI_REPAIR) ?></strong></p>
                <p style="margin-top: -25px;">Note :
                    <?= MMtrgSetup::getNotConfirmed(MMtrgSetup::KATEGORI_REPAIR) ? '<span class="notice" style="margin-top: -5px;">' . MMtrgSetup::getNotConfirmed(MMtrgSetup::KATEGORI_REPAIR) . ' data perlu tindakan</span>' : '-' ?>
                </p>
            </div>
        </div>
