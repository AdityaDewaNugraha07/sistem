<div id='ajax_counter_t_approval' class='text-center'>
    <style>
    .btn-success {color: #F5FCC9;background-color : #526E00;border-radius : 3px;border-color: #000;}
    .btn-success:hover {color: #526E00; background-color : #F5FCC9; border-radius : 3px; border-color: #000;}
    .btn-success:active {color: #fff;background-color : #526E00;border-radius : 3px;border-color: #000;}
    </style>
    <?php
    ...
    <button type="button" class="btn btn-<?php echo $xxx;?> btn-xs" onclick="opennotifTApproval(<?php echo $user_id;?>,<?php echo $pegawai_id;?>);">
        <b><i class="fa fa-bell-o fa-1x text-<?php echo $xxx;?>" aria-hidden="true"></i>
        <font><?php echo $jumlah_t_approval;?></font></b>
    </button>
    <?php
    /*if ($jumlah_t_approval > 0) {
        $i = 1;
